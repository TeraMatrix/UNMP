...
from defaults import site as sitename

import unmp_config
from unmp_model import engine
...
def get_mysql_credentials():
    ...
    #     # print sys.exc_info()
    #     return mysql_host, mysql_user_name, mysql_password, mysql_db_schema
    unmp_config.get_mysql_credentials()
...
def get_sqlalchemy_credentials():
    ...
    #     # print sys.exc_info()
    #     return sqlalchemy_host, sqlalchemy_user_name, sqlalchemy_password, sqlalchemy_schema, sqlalchemy_driver
    unmp_config.get_sqlalchemy_credentials()
...
def open_database_sqlalchemy_connection():
    try:
        # sqlalchemy_host, sqlalchemy_user_name, sqlalchemy_password, sqlalchemy_schema, sqlalchemy_driver
        #  = get_sqlalchemy_credentials(
        # )
        # db = create_engine(
...
def get_refresh_time():
    ...
    #
    # # config.xml file path
    # xml_config_file = "/omd/sites/%s/share/check_mk/web/htdocs/xml/config.xml"
    # % sitename
    # try:
    #     # check config.xml file exist or not
    #     if(os.path.isfile(xml_config_file)):
    ...
    #     # print sys.exc_info()
    #     return refresh_time
    unmp_config.get_default_dashboard_refresh_time()
...
class SqlalchemyConnection:
    def open_database_sqlalchemy_connection(self):
        # try:
        #     # sqlalchemy_host, sqlalchemy_user_name, sqlalchemy_password,
        # sqlalchemy_schema, sqlalchemy_driver = get_sqlalchemy_credentials(
        #     # )
        #     # db = create_engine(
        #     #     "%s://%s:%s@%s/%s" % (sqlalchemy_driver, sqlalchemy_user_name,
        #     #                           sqlalchemy_password, sqlalchemy_host, sqlalchemy_schema))
        ...
        # except:
        #     return None
        open_database_sqlalchemy_connection()
