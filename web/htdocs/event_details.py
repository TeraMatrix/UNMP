...
def start_page(h):
    ...
    html.write("<img src=\"images/lb.png\"  name=\"select_option_div\" alt=\"Informational\" title=\"Informational\" style=\"width:12px\" class=\"imgbutton\" /><span class=\"inactive-linkclass\" style=\"line-height:20px; padding:0px 12px;cursor:pointer;cursor:hand;\">Informational</span>")
    html.write("</div>")
    html.write("</td>")
