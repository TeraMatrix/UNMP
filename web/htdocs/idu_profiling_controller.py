...
def idu_listing(h):
    try:
        ...
        html.write(str(page_header_search(ip_address,mac_address,"RM18,RM,IDU",selected_device_type,"enabled","device_type")))
...
def idu_profiling(h):
    ...
    if isinstance(device_list_parameter,list):
        if device_list_parameter == [] or device_list_parameter == None:
            html.write(page_header_search("","","RM18,RM,IDU",None,"enabled","device_type"))#call the function of common_controller , it is used for listing the Devices based on IPaddress,Macaddress,DeviceTy
        else:
            html.new_header("%s %s Configuration"%("IDU",device_list_parameter[0].ip_address),"idu_listing.py","",css_list,jss_list,snapin_list)
            html.write(page_header_search(device_list_parameter[0][0],device_list_parameter[0][1],"RM18,RM,IDU",device_type,device_list_state,"device_type"))
