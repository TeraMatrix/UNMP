...
def idu_listing(h):
    try:
        ...
        html.new_header("IDU Listing","idu_listing.py","",css_list,javascript_list)
        ...
        html.write(str(page_header_search(ip_address,mac_address,"UBR,UBRe,IDU",selected_device_type,"enabled","device_type")))
...
def idu_profiling(h):
    ...
    if isinstance(device_list_parameter,list):
        if device_list_parameter == [] or device_list_parameter == None:
            html.write(page_header_search("","","UBR,UBRe,IDU",None,"enabled","device_type"))#call the function of common_controller , it is used for listing the Devices based on IPaddress,Macaddress,DeviceTy
        else:
            html.new_header("%s %s Configuration"%("IDU",device_list_parameter[0].ip_address),"idu_listing.py","",css_list,jss_list)
            html.write(page_header_search(device_list_parameter[0][0],device_list_parameter[0][1],"UBR,UBRe,IDU",device_type,device_list_state,"device_type"))
        ...
        if html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMin")!=None:
            if Validation.is_required(html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMin")):
                if Validation.is_number(html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMin")):
                    if Validation.is_integer(html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMin")):
                        ...
                        flag = 1
                        dic_result["success"] = 1
                        dic_result["result"] = "Lower Threshhold must be Integer"
                else:
                    flag = 1
                    dic_result["success"] = 1
        ...
        if html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMax")!=None:
            if Validation.is_required(html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMax")):
                if Validation.is_number(html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMax")):
                    if Validation.is_integer(html.var("iduConfiguration.temperatureSensorConfigurationTable.tempMax")):
                        ...
                        flag = 1
                        dic_result["success"] = 1
                        dic_result["result"] = "Upper Threshhold must be Integer"
                else:
                    flag = 1
                    dic_result["success"] = 1
