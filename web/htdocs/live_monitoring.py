...
class LiveMonitoring(object):
    @staticmethod
    def header_buttons():
        add_btn = "<div class=\"header-icon\"><img onclick=\"liveSettings();\" class=\"n-tip-image\" src=\"images/new_icons/wrench.png\" id=\"add_host\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Settings\"></div>"
        header_btn = add_btn
        return header_btn
    ...
    def page_tip_live_monitoring():
        ...
        "<div><strong>Live Monitoring</strong> is to instant monitoring of the host.</div>"\
        "<br/>"\
        "<div><strong>Actions</strong></div>"\
        "<div class=\"action-tip\"><div class=\"img-div img-div2\"><img style=\"width:16px;height:16px;\" src=\"images/new/play.png\"/></div><div class=\"txt-div\">To run Live Monitoring</div></div>"\
        "<div class=\"action-tip\"><div class=\"img-div img-div2\"><img style=\"width:16px;height:16px;\" src=\"images/new/stop.png\"/></div><div class=\"txt-div\">To stop Live Monitoring</div></div>"\
        "<br/>"\
        "</div>"
        return html_view
