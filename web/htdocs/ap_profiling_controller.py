...
def ap_listing(h):
    try:
        ...
        html.write(str(page_header_search(ip_address,mac_address,"RM18,RM,IDU,Access Point",selected_device_type,"enabled","device_type")))
...
def ap_profiling(h):
    ...
    if isinstance(device_list_parameter,list):
        ...
        if device_list_parameter == [] or device_list_parameter == None:
            html.write(page_header_search("","","RM18,RM,IDU,Access Point",None,"enabled","device_type"))#call the function of common_controller , it is used for listing the Devices based on IPaddress,Macaddress,DeviceTy
        else:
            html.write(page_header_search(device_list_parameter[0][0],device_list_parameter[0][1],"RM18,RM,IDU,Access Point",device_type,device_list_state,"device_type"))
...
def edit_ap_client(h):
    ...
    if result["success"] == 0 and type(result["result"]) == dict:
        html.write(APForms().edit_client_form(result["result"]))
    else:
...
def ap_vap_form_action(h):
    ...
    if html.var("host_id") == "" or html.var("host_id") == None:
        ...
        if html.var("basicVAPconfigTable.vapHiddenESSIDstate")!=None:
            dic_result["basicVAPconfigTable.vapHiddenESSIDstate"] = html.var("basicVAPconfigTable.vapHiddenESSIDstate")
        ...
        if html.var("basicVAPconfigTable.vapBeaconInterval")!=None:
            if Validation.is_required(html.var("basicVAPconfigTable.vapBeaconInterval")):
                if Validation.is_number(html.var("basicVAPconfigTable.vapBeaconInterval")):
                    if int(html.var("basicVAPconfigTable.vapBeaconInterval"))>=100 and int(html.var("basicVAPconfigTable.vapBeaconInterval"))<=1000:
        ...
        if html.var("basicVAPconfigTable.vapSecurityMode")!=None:
            if int(html.var("basicVAPconfigTable.vapSecurityMode"))==0:
                ...
                if html.var("vapWEPsecurityConfigTable.vapWEPprimaryKey")!=None:
                    ...
                    if len(html.var("vapWEPsecurityConfigTable.vapWEPkey1"))==0:
                        ...
                        if (len(html.var("vapWEPsecurityConfigTable.vapWEPkey1"))==5 or len(html.var("vapWEPsecurityConfigTable.vapWEPkey1"))==13 or len(html.var("vapWEPsecurityConfigTable.vapWEPkey1"))==16):
                            ...
                            dic_result["success"]=1
                            dic_result["result"] = "WEP key1 must be the length of 5,13 or 16"
                    if len(html.var("vapWEPsecurityConfigTable.vapWEPkey2"))==0:
                    ...
                    if len(html.var("vapWEPsecurityConfigTable.vapWEPkey3"))==0:
                    ...
                    if len(html.var("vapWEPsecurityConfigTable.vapWEPkey4"))==0:
                ...
                if html.var("vapWPAsecurityConfigTable.vapWPAkeyMode")!=None:
                    ...
                    if html.var("vapWPAsecurityConfigTable.vapWPAserverIP")!=None:
                        if Validation.is_required(html.var("vapWPAsecurityConfigTable.vapWPAserverIP")):
                            if Validation.is_valid_ip(html.var("vapWPAsecurityConfigTable.vapWPAserverIP")):
