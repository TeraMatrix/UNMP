...
def odu100_common_dashboard_report_generating(h):
    ...
    try:
        ...
        odu100_common_report.append(Spacer(31, 31))
        signal_interface = ['(peer0)', '(peer1)', '(peer2)', '(peer3)', '(peer4)', '(peer5)', '(peer6)', '(peer7)', '(peer8)', '(peer9)', '(peer10)',
                ...
                if temp_date.month > main_date.month or temp_date.day > main_date.day:
                    ...
                    if day_diff > 1:
                        for i in range(1, day_diff + 1):
                            ...
                            if prev_value == '50002':
                                main_list.append(
                                    [leftout_date, main_ip, timedelta(0, 86399), None])
                            elif prev_value == '50001':
                                main_list.append(
                                    [leftout_date, main_ip, None, timedelta(0, 86399)])
