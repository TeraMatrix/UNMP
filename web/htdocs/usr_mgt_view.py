...
def user_view(h):
    ...
    add_btn = "<div class=\"header-icon\"><img onclick=\"addUser();\" class=\"n-tip-image\" src=\"images/new_icons/round_plus.png\" id=\"add_user\" name=\"add_user\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Add User\"></div>"
    edit_btn = "<div class=\"header-icon\"><img onclick=\"editUser();\" class=\"n-tip-image\" src=\"images/new_icons/doc_edit.png\" id=\"edit_user\" name=\"edit_user\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Edit User\"></div>"
    del_btn = "<div class=\"header-icon\"><img onclick=\"delUser();\" class=\"n-tip-image\" src=\"images/new_icons/round_minus.png\" id=\"del_user\" name=\"del_user_tip\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Delete User\"></div>"
...
def group_user_view(h):
    global html
    html = h
    css_list = ["css/demo_page.css","css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/divya.css"]
    javascript_list = ["js/pages/group_mgt.js"]
    add_btn = "<div class=\"header-icon\"><img onclick=\"addGroup();\" class=\"n-tip-image\" src=\"images/new_icons/round_plus.png\" id=\"add_group\" name=\"add_group\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Add Group\"></div>"
    edit_btn = "<div class=\"header-icon\"><img onclick=\"editGroup();\" class=\"n-tip-image\" src=\"images/new_icons/doc_edit.png\" id=\"edit_group\" name=\"edit_group\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Edit Group\"></div>"
    del_btn = "<div class=\"header-icon\"><img onclick=\"delGroup();\" class=\"n-tip-image\" src=\"images/new_icons/round_minus.png\" id=\"del_group\" name=\"del_group\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Delete Group\"></div>"
    #all_btn = del_btn + edit_btn + add_btn
    all_btn = edit_btn
...
def hostgroup_group_view(h):
    ...
    add_btn = "<div class=\"header-icon\"><img onclick=\"addHostGroup();\" class=\"n-tip-image\" src=\"images/new_icons/round_plus.png\" id=\"add_hostgroup\" name=\"add_hostgroup\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Add HostGroup\"></div>"
    edit_btn = "<div class=\"header-icon\"><img onclick=\"editHostGroup();\" class=\"n-tip-image\" src=\"images/new_icons/doc_edit.png\" id=\"edit_hostgroup\" name=\"edit_hostgroup\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Edit HostGroup\"></div>"
    del_btn = "<div class=\"header-icon\"><img onclick=\"delHostGroup();\" class=\"n-tip-image\" src=\"images/new_icons/round_minus.png\" id=\"del_hostgroup\" name=\"del_hostgroup\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Delete HostGroup\"></div>"
    #all_btn = del_btn + edit_btn + add_btn
    all_btn = ""
...
def page_tip_user_main(h):
	...
	"<div class=\"action-tip\"><div class=\"img-div\"><img style=\"width:16px;height:16px;\" src=\"images/new_icons/round_plus.png\"/></div><div class=\"txt-div\">Add New User </div></div>"\
	"<div class=\"action-tip\"><div class=\"img-div\"><img style=\"width:16px;height:16px;\" src=\"images/new_icons/doc_edit.png\"/></div><div class=\"txt-div\">Edit User</div></div>"\
	"<div class=\"action-tip\"><div class=\"img-div\"><img style=\"width:16px;height:16px;\" src=\"images/new_icons/round_minus.png\"/></div><div class=\"txt-div\">Delete User</div></div>"\
	"<br/>"\
	"</div>"
...
def page_tip_group_user(h):
	...
	"<br/>"\
	"<div><strong>Actions</strong></div>"\
	"<div class=\"action-tip\"><div class=\"img-div\"><img style=\"width:16px;height:16px;\" src=\"images/new_icons/doc_edit.png\"/></div><div class=\"txt-div\">Edit Group</div></div>"\
