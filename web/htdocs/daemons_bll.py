...
dict_id={1:"unmp-alarm",2:"unmp-ds",3:"unmp-local"}
dict_name={1:"Alarm Parser",2:"Auto Discovery server",3:"UNMP System Monitor"}
dict_pid={1:"/omd/daemon/tmp/unmp-trap.pid",2:"/omd/daemon/tmp/unmp-ds.pid",3:"/omd/daemon/tmp/unmp-local.pid"}
dict_details={1:"UNMP core process to capture and log Traps, Alarms and Alerts.",2:"UNMP device discovery server.",3:"UNMP core process for UNMP System Monitor"}
