...
class User(object):
    ...
    def create_user_settings_form(first_name,last_name,designation,company,mobile,address,email_id):
        try:
    	    s="<form action=\"save_user_settings_personal.py\" method=\"get\" id=\"edit_user_form\" name=\"edit_user_form\" >\
                                <div class=\"form-div\" style=\"margin-top:25px\">\
                                    <div class=\"form-body\" style=\"overflow:hidden;\">\
                                        ...
                                        <div class=\"row-elem\">\
                                            ...
                                            <textarea id=\"address\" name=\"address\" title=\"Please Enter your own Address.\">%s</textarea>\
                                        </div>\
                                        <div class=\"row-elem\">\
    		...
    		"</div>"\
    		"</div>" %(first_name,last_name,company,designation,address,mobile,email_id)
            return s
        except Exception,e:
            return str(e)
    ...
    @staticmethod
    def create_user_settings_password_form(password):
        try:
    	    s="<form action=\"save_user_settings_password.py\" method=\"get\" id=\"edit_password_form\" name=\"edit_password_form\" >\
                                <div class=\"form-div\" style=\"margin-top:25px\">\
                                    <div class=\"form-body\">\
                                        <div class=\"row-elem\">\
        					                ...
        					                <input type=\"hidden\" id=\"true_password\" name=\"true_password\" value=\"%s\" />\
                                        </div>\
                                        <div class=\"row-elem\">\
