    ...
    def firmware_get_data(host_id,device_type,device_list_parameter):
        ...
        if host_id == "" or host_id == "None":
            ...
            if device_type == UNMPDeviceType.ap25:
                tab_str += FirmwareUpdateView.firmware_master_slave_data(host_id,device_type,device_list_parameter)# function call , it is used to make a form of selected profiling  
        return tab_str
