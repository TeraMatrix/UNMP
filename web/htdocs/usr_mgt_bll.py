...
def ap_add_default_data_new_user(user_id):
    try:
        ...
        default_temp_list=[['apNWBandwidth','Network Bandwidth Statistics',0,'ap25',1,1,0,0,0,5,180,250,1,1,1,1,1,'Network Bandwidth Statistics',\
                            'Statistics',600,0],\
                           ['ap25outage','Device Reachability Statistics',0,'ap25',2,1,0,0,0,5,180,250,1,1,1,1,0,'Reachability Statistics','',600,0],\
                           ['vapConnectedClient','Connected Client',0,'ap25',1,1,0,0,0,5,180,250,1,1,1,1,1,'Connected Client','',600,0],\
        ...
        for  default_temp in default_temp_list:
            ...
            "%(default_temp[0],default_temp[1],user_id,default_temp[2],default_temp[3],default_temp[4],default_temp[5],default_temp[6],\
               default_temp[7],default_temp[8],default_temp[9],default_temp[10],default_temp[11],default_temp[12],default_temp[13],\
...
#        cursor=global_db.cursor()
        ...
        default_temp_list=[['odu16rssi','RSL Statistics',0,'odu16',2,1,0,0,0,5,180,250,1,1,1,1,0,'RSL Statistics','',600,0],\
                           ['odu16outage','Device Reachability Statistics',0,'odu16',2,1,0,0,0,5,180,250,1,1,1,1,0,'Reachability Statistics','',600,0],\
                           ...
                           ['odu16synclost','Sync Lost',1,'odu16',0,1,0,0,0,5,180,250,1,1,1,1,0,'Sync Lost','',600,0],\
        ...
        for  default_temp in default_temp_list:
            ...
            "%(default_temp[0],default_temp[1],user_id,default_temp[2],default_temp[3],default_temp[4],\
               default_temp[5],default_temp[6],default_temp[7],default_temp[8],default_temp[9],default_temp[10],\
               default_temp[11],default_temp[12],default_temp[13],default_temp[14],default_temp[15],\
...
#        cursor=global_db.cursor()
        ...
        default_temp_list=[['odu100link','Link Quality Statistics',0,'odu100',2,1,0,0,0,5,180,250,1,1,1,1,0,\
                           ...
                           ['odu100NWBandwidth','Network Bandwidth Statistics',0,'odu100',1,1,0,0,0,5,180,250,1,1,1,1,1,\
                            'Network Bandwidth Statistics','Statistics',600,0],\
                           ['odu100synclost','Sync Lost',1,'odu100',1,1,0,0,0,5,180,250,1,1,1,1,0,'Sync Lost','',600,0],\
        ...
        for  default_temp in default_temp_list:
            ...
            "%(default_temp[0],default_temp[1],user_id,default_temp[2],default_temp[3],default_temp[4],default_temp[5],\
               default_temp[6],default_temp[7],default_temp[8],default_temp[9],default_temp[10],default_temp[11],\
               default_temp[12],default_temp[13],default_temp[14],default_temp[15],default_temp[16],default_temp[17],\
        ...
        peer_intereface_name=["Link1","Link2","Link3","Link4","Link5","Link6","Link7","Link8",\
...
#        table_field_dict=dict((field[0],field[1]) for field in coloum_result)
        ...
        ajax_data={'odu100NWBandwidth':['odu100NWBandwidth','sp_common_graph_creation.py','post',\
                   ...
                   timestamp,synchStatsIndex,odu100synclost'],\
...
#	global_db=MySQLdb.connect('localhost','root','root','midnms')
#        cursor=global_db.cursor()
        default_temp_list=[['idu4NWBandwidth','Network Bandwidth Statistics',1,'idu4',1,1,0,0,0,5,180,250,1,1,1,1,1,\
                            'Network Bandwidth Statistics','Statistics',600,0],\
...
#['idu4linkstatustable','Link Status',0,'idu4',1,1,1,0,0,5,180,-1,1,1,1,1,1,'E1 Port Status','Status',300,0,1]
        default_temp_list=[['idu4e1portstatus','E1 Port Status',0,'idu4',1,1,1,0,0,5,180,-1,1,1,1,1,1,\
...
def odu100_add_status_info__for_new_user(user_id):
    try:
        ...
        default_temp_list=[['odu100NWstatus','Network Bandwidth Status',0,'odu100',1,1,1,0,0,5,180,-1,1,1,1,1,1,\
                            'Network Bandwidth Status','Status',300,0,1],\
                           ['odu100syncstatus','Sync Status',0,'odu100',1,1,1,0,0,5,180,-1,1,1,1,1,1,'Sync Status','Status',300,0,1],\
        ...
        for  default_temp in default_temp_list:
            ...
            %s, %s,'%s','%s' ,'%s',%s,%s,%s)\
            "%(default_temp[0],default_temp[1],user_id,default_temp[2],default_temp[3],default_temp[4],\
               default_temp[5],default_temp[6],default_temp[7],default_temp[8],default_temp[9],\
               default_temp[10],default_temp[11],default_temp[12],default_temp[13],default_temp[14],\
        ...
        ajax_data={'odu100NWstatus':['odu100NWstatus','sp_common_status_table_creation.py','post',\
                   ...
                   'odu100syncstatus':['odu100syncstatus','sp_common_status_table_creation.py','post',\
                                       'odu100_synchStatusTable,timestamp,synchStatsIndex,odu100syncstatus'],\
...
def ap_client_data_new_user(user_id):
    try:
        ...
        default_temp_list=[['apClientBandwidth','Client Bandwidth Statistics',0,'ap25',1,1,0,0,0,5,180,250,1,1,1,1,1,\
    ...
    '%s',%s,%s,%s)"%(default_temp[0],default_temp[1],user_id,default_temp[2],\
                     default_temp[3],default_temp[4],default_temp[5],default_temp[6],\
                     default_temp[7],default_temp[8],default_temp[9],default_temp[10],\
                     default_temp[11],default_temp[12],default_temp[13],default_temp[14],\
                     default_temp[15],default_temp[16],default_temp[17],default_temp[18],\
...
def ccu_add_graph_entry_for_new_user(user_id):
    try:
        ...
        # Template Entry
        default_temp_list=[['ccutemp','Temperature Statistics',1,'ccu',1,1,0,0,0,5,180,250,1,1,1,1,1,\
...
def add_user(u_dict,ul_dict,ug_dict):
    ...
    try:
        ...
        insQuery1 = """INSERT INTO `users` 
        (`user_id`, `first_name`, `last_name`, `designation`, `company_name`, `mobile_no`, 
        `address`, `city_id`, `state_id`, `country_id`, `email_id`) 
        VALUES (\"%(user_id)s\", \"%(first_name)s\", \"%(last_name)s\", \"%(designation)s\", 
        \"%(company)s\", \"%(mobile)s\", \"%(address)s\", NULL, NULL, NULL, \"%(email_id)s\")"""%u_dict
        
        insQuery2 = """INSERT INTO `user_login` (`user_login_id`, `user_id`, `user_name`, 
        `password`, `timestamp`, `created_by`, `creation_time`, `is_deleted`, `updated_by`, 
        `nms_id`) 
        VALUES (UUID(), \"%(user_id)s\", \"%(user_name)s\", \"%(password)s\", 
        '0000-00-00 00:00:00', 'SuperAdmin', CURRENT_TIMESTAMP, '0', NULL, NULL)"""%ul_dict
        
        insQuery3 = """INSERT INTO `users_groups` 
        (`user_group_id`, `user_id`, `group_id`) 
        VALUES (UUID(), \"%(user_id)s\", \"%(groups)s\")"""%ug_dict
        cursor = global_db.cursor()
