...
##                        'sync_admin':1 if sync_data[0][0]==None else int(sync_data[0][0]) if len(sync_data)>0 else 1}
            ...
            monitoring_status = "<a target=\"main\" href=\"%s?host_id=%s&device_type=%s&device_list_state=%s\"><img src=\"images/%s/info.png\" style=\"width:16px;height:16px;\" title=\"Current Device Status\" class=\"imgbutton n-reconcile w-reconcile\"/></a>"%('sp_status_profiling.py',\

                                                                                                                                                                                                                                                                      device_tuple[i][0],device_tuple[i][6],device_list_state,theme) if device_tuple[i][6]=="odu100" else "<img src=\"images/new/info1.png\" style=\"width:16px;height:16px;\" title=\"Current Device Status\" class=\"imgbutton n-reconcile\"/>"
