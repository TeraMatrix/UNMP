...
def odu100_get_raconfigtable(host_id):
    ...
    try:
        ...
        if odu100_profile_id == None or odu100_profile_id == []:
            ...
            Odu100RaConfTable.link_distance).filter(Odu100RaConfTable.config_profile_id == odu100_profile_id[0]).all()
        sqlalche_obj.sql_alchemy_db_connection_close()
                                                        ...
                                                        if len(sqlalche_table_result)>0:
                                                            ...
                                                            for row in result['result']:
                                                                ...
                                                                for val in range(0,len(result['result'][row])): 
                                                                    print sqlalche_table_result[row-1],"\n\n"
...
#print obj.update_reconcilation_controller(41,'odu100','odu100_',datetime.now(),"anuj")
...
#print obj.global_admin_request('32,28,29')
