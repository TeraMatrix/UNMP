...
def role_view1(h):
    ...
    add_btn = "<div class=\"header-icon\"><img onclick=\"addRole();\" class=\"n-tip-image\" src=\"images/new_icons/round_plus.png\" id=\"add_role\" name=\"add_role\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" title=\"Add Role\"></div>"
    edit_btn = "<div class=\"header-icon\"><img onclick=\"editRole();\" class=\"n-tip-image\" src=\"images/new_icons/doc_edit.png\" id=\"edit_role\" name=\"edit_role\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" title=\"Edit Role\"></div>"
    del_btn = "<div class=\"header-icon\"><img onclick=\"delRole();\" class=\"n-tip-image\" src=\"images/new_icons/round_minus.png\" id=\"del_role\" name=\"del_role\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" title=\"Delete Role\"></div>"
