...
def show_host_details(h):
        ...
        try:
                ...
                sql = "SELECT  hosts.host_name,hosts.ip_address,hosts.mac_address,host_states.state_name,hosts.timestamp,hosts.host_id,hosts.device_type_id,hosts.host_alias FROM hosts INNER JOIN host_states ON hosts.host_state_id=host_states.host_state_id WHERE hosts.ip_address='%s' and hosts.is_deleted=0" %  host_ip
