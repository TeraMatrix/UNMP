...
def pysnmp_get_table_ap(oid,ip_address,port,community):
    ...
    try:
        ...
        return result_dict
#print pysnmp_get_table_ap('1.3.6.1.4.1.26149.2.1.2.2', '172.22.0.104', 8001, 'public')
        ...
        if ip_address == None and port == None and community == None:
            ...
            if prev_str != '':
                ...
                try:
                    ...
                    response_dict = {}
                    success = 1
                    response_dict[99] = 'pysnmp exception in recursive : '+str(e)
            ...
            if ip_address != None and port != None and community != None:
                response_dict = {}
                temp_dict = {}
                prev_str = "errorIndication, errorStatus, errorIndex, varBinds = cmdgen.CommandGenerator().setCmd(cmdgen.CommunityData('unmp_set_agent', '%s'),cmdgen.UdpTransportTarget(('%s', %s), 15, 3)"%(community,ip_address,port)
                state_present = 0
                set_str = prev_str
...
#print pysnmp_set({'iduConfiguration.e1PortConfigurationTable.lineType': ['1.3.6.1.4.1.26149.2.1.2.3.1.4.2', 'Integer32', 1], 'iduConfiguration.e1PortConfigurationTable.lineCode': ['1.3.6.1.4.1.26149.2.1.2.3.1.5.2', 'Integer32', 1], 'iduConfiguration.e1PortConfigurationTable.clockSource': ['1.3.6.1.4.1.26149.2.1.2.3.1.3.2', 'Integer32', 1]}, '172.22.0.104', '8001', 'private', {'adminState': ['1.3.6.1.4.1.26149.2.1.2.3.1.2.2', 'Integer32', 0]})
