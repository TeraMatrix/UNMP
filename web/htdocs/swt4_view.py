...
##        </style>")
    ...
    if connect_chk == 0 or connect_chk == "0":
        html.write(str(page_header_search(ip_address,mac_address,"Switch4",selected_device_type,"enabled","device_type")))
        html.write("<br/><br/>")
        html.write("<div id=\"swt4_form_div\" style=\"margin-left:10px\"></div>")
    else:
...
##    connect_chk = check_connection()
    ...
    swt4_bandwidth_str = swt4_obj.swt4_bandwidth_control_settings(host_id,selected_device)
    swt4_storm_str = swt4_obj.swt4_storm_control(host_id,selected_device)
    swt4_port_priority_str = swt4_obj.swt4_port_priority(host_id,selected_device) 
    swt4_dscp_priority_str = swt4_obj.swt4_dscp_priority(host_id,selected_device)
    swt4_802_priority_str = swt4_obj.swt4_802_priority(host_id,selected_device)
    swt4_ip_priority_str = swt4_obj.swt4_ip_base_priority(host_id,selected_device)
    swt4_queue_priority_str = swt4_obj.swt4_queue_priority(host_id,selected_device)
    swt4_queue_weight_str = swt4_obj.swt4_queue_weight(host_id,selected_device)
    swt4_qos_abstraction_str = swt4_obj.swt4_qos_abstraction(host_id,selected_device)
...
##        html.write(msg_str)            
    ...
    html.write(form_box("Configuration",["tab-active"],["#viewDiv"],["viewButton"],["Configuration"],"IP","id-1"))
    html.write(str(ip_form))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    html.write(form_box("Configuration",["tab-active","tab-button"],["#swt4_port_form_container","#swt_port_get_div"],["viewPortButton","viewPortButton2"],["Configuration","Port Details"],"Port Settings","id-1"))
    html.write(str(ip_port_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
                
    html.write(form_box("Configuration",["tab-active","tab-button"],["#swt4_vlan_form_container","#swt_vlan_get_div"],["viewVlanButton","viewVlanButton2"],["Configuration","VLAN Settings"],"VLAN Settings","id-1"))
    html.write(str(swt4_vlan_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    
    html.write(form_box("Configuration",["tab-active","tab-button"],["#swt_bandwidth_form_container","#swt_bandwidth_get_div"],["viewBandwidthButton","viewBandwidthButton2"],["Configuration","Bandwidth Details"],"Bandwidth Settings","id-1"))
    html.write(str(swt4_bandwidth_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    ################################################################################################################################################################################################################################################################
    html.write(form_box("QoS",["tab-active","tab-button"],["#swt4_port_priority_form_container","#swt4_port_priority_get_div"],["viewPortPriorityButton","viewPortPriorityButton2"],["Configuration","Port Priority"],"Port Priority","id-1"))
    html.write(str(swt4_port_priority_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    
    html.write(form_box("QoS",["tab-active","tab-button"],["#swt4_dscp_priority_form_container","#swt4_dscp_priority_get_div"],["viewDscpButton","viewDscpButton2"],["Configuration","DSCP Priority"],"DSCP Priority","id-1"))
    html.write(str(swt4_dscp_priority_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    
    html.write(form_box("QoS",["tab-active","tab-button"],["#swt4_802_priority_form_container","#swt4_802_priority_get_div"],["view802Button","view802Button2"],["Configuration","802p Priority"],"802p Priority","id-1"))
    html.write(str(swt4_802_priority_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    
    html.write(form_box("QoS",["tab-active","tab-button"],["#swt4_ip_base_priority_form_container","#swt4_ip_base_priority_get_div"],["viewIpPriorityButton","viewIpPriorityButton2"],["Configuration","Ip Priority"],"Ip Priority","id-1"))
    html.write(str(swt4_ip_priority_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    
    html.write(form_box("QoS",["tab-active","tab-button"],["#swt4_queue_priority_form_container","#swt4_queue_priority_get_div"],["viewQueuePriorityButton","viewQueuePriorityButton2"],["Configuration","Queue Priority"],"Queue Priority","id-1"))
    html.write(str(swt4_queue_priority_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    
    html.write(form_box("QoS",["tab-active","tab-button"],["#swt4_queue_weight_form_container","#swt4_queue_weight_get_div"],["viewQueueWeightButton","viewQueueWeightButton2"],["Configuration","Queue Weight"],"Queue Weight","id-1"))
    html.write(str(swt4_queue_weight_str))
    html.write("<div class=\"box-loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>\
                </div></li>")
    
    html.write(form_box("QoS",["tab-active","tab-button"],["#swt4_qos_abstraction_form_container","#swt4_qos_abstraction_get_div"],["viewQosAbstractionButton","viewQosAbstractionButton2"],["Configuration","Qos Abstraction"],"Qos Abstraction","id-1"))
...
##                </div></li>")
    ...
    html.write(form_box("Storm Control",["tab-active","tab-button"],["#swt_storm_form_container","#swt_storm_get_div"],["viewStormButton","viewStormButton2"],["Configuration","Storm Details"],"Storm Control","id-1"))
    ...
    html.write("</ul>")
    html.write("</div>")
    html.write("<div class=\"loading\" id=\"main_loading\"><img alt=\"\" src=\"images/loading.gif\"/></div>")#this is the main div of loading which is shown on commit to flash
...
class SwtFormProfiling(object):
    ...
    def swt4_port_settings(self,host_id,selected_device):
        ...
        swt4_port_str = "<div id=\"swt4_port_setting\" name=\"swt4_port_setting\">\
                        ...
                        self.swt_select_list_obj.port_select_list(str("" if swt4_port_data[0][1]==None or swt4_port_data[0][1]=="" else swt4_port_data[0][1]),'enabled','port_select_list_id','false','Port'),\
                        self.swt_select_list_obj.state_select_list(str("" if swt4_port_data[0][2]==None or swt4_port_data[0][2]=="" else swt4_port_data[0][2]),'enabled','state_select_list_id','false','State'),\
                        self.swt_select_list_obj.speed_duplex_select_list(str("" if swt4_port_data[0][3]==None or swt4_port_data[0][3]=="" else swt4_port_data[0][3]),'enabled','speed_duplex_list_id','false','Speed Duplex'),\
    ...
    def swt4_vlan_settings(self,host_id,selected_device):
        ...
        swt_vlan_str += "<div id=\"swt4_vlan_setting\" name=\"swt4_vlan_setting\">\
                       ...
                       \
                        ...
                        self.swt_select_list_obj.vlan_pass_all_select_list(str("" if swt_vlan_list[0][1]==None else swt_vlan_list[0][1]),'enabled','vlan_pass_all_id','false','VLAN Pass All'),\
                        self.swt_select_list_obj.vlan_port_select_list(str("" if swt_vlan_list[0][2]==None else swt_vlan_list[0][2]),'enabled','vlan_port_id','false','VLAN Port'),\
                        str("" if swt_vlan_list[0][3]==None else swt_vlan_list[0][3]),\
    ...
    def swt4_bandwidth_control_settings(self,host_id,selected_device):
        ...
        if len(swt4_bandwidth) > 0:
            swt_bandwidth_str += "<div id=\"swt_bandwidth\" name=\"swt_bandwidth\">\
                            ...
                            self.swt_select_list_obj.bandwidth_port_select_list(str("" if swt4_bandwidth[0][1]==None or swt4_bandwidth[0][1]=="" else swt4_bandwidth[0][1]),'enabled','bandwidth_port_select_list_id','false','Port'),\
                            self.swt_select_list_obj.bandwidth_type_select_list(str("" if swt4_bandwidth[0][2]==None or swt4_bandwidth[0][2]=="" else swt4_bandwidth[0][2]),'enabled','bandwidth_type_select_list_id','false','Type'),\
                            self.swt_select_list_obj.bandwidth_state_select_list(str("" if swt4_bandwidth[0][3]==None or swt4_bandwidth[0][3]=="" else swt4_bandwidth[0][3]),'enabled','bandwidth_state_select_list_id','false','State'),\
    ...
    def swt4_storm_control(self,host_id,selected_device):
        ...
        swt4_storm_str += "<div id=\"swt_storm\" name=\"swt_storm\">\
                            ...
                            self.swt_select_list_obj.storm_state_select_list(str("" if swt4_storm_data[0][1]==None else swt4_storm_data[0][1]),'enabled','storm_state_id','false','State'),\
    ...
    def swt4_port_priority(self,host_id,selected_device):
            ...
            swt4_port_priority_str += "<div id=\"swt4_port_priority_main_div\" name=\"swt4_port_priority_main_div\">\
                                               ...
                                               \
                                                "%(self.swt_select_list_obj.common_enable_disable_select_list('0','enabled','port_base_priority_id','false','Port Priority')\
                                                ,self.swt_select_list_obj.common_port_select_list(str("" if swt4_port_priority_data[0][0]==None else swt4_port_priority_data[0][0]),'enabled','port_id','false','Port')\
                                                ,self.swt_select_list_obj.common_priority_select_list(str("" if swt4_port_priority_data[0][1]==None else swt4_port_priority_data[0][1]),'enabled','priority_id','false','Priority'),host_id,selected_device) 
    ...
    def swt4_dscp_priority(self,host_id,selected_device):
            ...
            swt4_dscp_priority_str += "<div id=\"swt4_dscp_priority_main_div\" name=\"swt4_dscp_priority_main_div\">\
                                               ...
                                               \
                                                ...
                                                self.swt_select_list_obj.dscp_select_list(str("" if swt4_dscp_priority_data[0][0]== "" else swt4_dscp_priority_data[0][0]),'enabled','dscp_id','false','DSCP'),\
                                                self.swt_select_list_obj.common_priority_select_list(str("" if swt4_dscp_priority_data[0][1]==None else swt4_dscp_priority_data[0][1]),'enabled','dscp_priority_id','false','Priority'),\
    ...
    def swt4_802_priority(self,host_id,selected_device):
            ...
            swt4_802_priority_str += "<div id=\"swt4_802_priority_main_div\" name=\"swt4_802_priority_main_div\">\
                                               ...
                                               \
                                                ...
                                                self.swt_select_list_obj.select_list_802p(str('' if swt4_802_priority_data[0][0]==None else swt4_802_priority_data[0][0]),'enabled','802p_id','false','802.1p'),\
                                                self.swt_select_list_obj.common_priority_select_list(str("" if swt4_802_priority_data[0][1]==None else swt4_802_priority_data[0][1]),'enabled','802p_priority_id','false','Priority'),\
                                                host_id,selected_device) 
    ...
    def swt4_ip_base_priority(self,host_id,selected_device):
            ...
            swt4_ip_priority_str += "<div id=\"swt4_ip_base_priority_main_div\" name=\"swt4_ip_base_priority_main_div\">\
                                               ...
                                               \
                                                ...
                                                self.swt_select_list_obj.ip_type_select_list(str("" if swt4_ip_priority_data[0][1] == None else swt4_ip_priority_data[0][1]),"enabled","ip_type_id","false","IP Type"),\
                                                str(swt4_ip_priority_data[0][2]),str(swt4_ip_priority_data[0][3]),\
                                                self.swt_select_list_obj.common_priority_select_list(str("" if swt4_ip_priority_data[0][4]==None else swt4_ip_priority_data[0][4]),'enabled','ip_priority_id','false','Priority'),\
                                                host_id,selected_device) 
    ...
    def swt4_queue_priority(self,host_id,selected_device):
            ...
            swt4_queue_priority_str += "<div id=\"swt4_queue_priority_main_div\" name=\"swt4_queue_priority_main_div\">\
                                               ...
                                               \
                                                ...
                                                self.swt_select_list_obj.common_priority_select_list(str("" if swt4_queue_priority_data[0][1]==None else swt4_queue_priority_data[0][1]),'enabled','qid_map_priority_id','false','Priority'),\
                                                host_id,selected_device) 
    ...
    def swt4_queue_weight(self,host_id,selected_device):
            ...
            swt4_queue_weight_str += "<div id=\"swt4_queue_weight_main_div\" name=\"swt4_queue_weight_main_div\">\
                                               ...
                                               \
                                                ...
                                                self.swt_select_list_obj.queue_weight_select_list(str("" if swt4_queue_weight_data[0][1]==None else swt4_queue_weight_data[0][1]),'enabled','qid_weight_id','false','Weight'),\
                                                host_id,selected_device) 
    ...
    def swt4_qos_abstraction(self,host_id,selected_device):
            ...
            swt4_qos_abstraction_str += "<div id=\"swt4_qos_abstraction_main_div\" name=\"swt4_qos_abstraction_main_div\">\
                                               ...
                                               \
                                                ...
                                                self.swt_select_list_obj.qos_abstaction_level_select_list(str("" if swt4_qos_abstraction_data[0][1]==None else swt4_qos_abstraction_data[0][1]),'enabled','qos_level_id','false','Level'),\
                                                host_id,selected_device) 
    ...
    def swt4_1p_remarking(self,host_id,selected_device):
            ...
            swt4_1p_remarking_str += "<div id=\"swt4_1p_remarking_main_div\" name=\"swt4_1p_remarking_main_div\">\
                                               ...
                                               \
                                                ...
                                                self.swt_select_list_obj.select_list_802p(str('' if swt4_1p_remarking_data[0][1]==None else swt4_1p_remarking_data[0][1]),'enabled','1p_remarking_priority','false','Priority'),\
                                                host_id,selected_device) 
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("swt_ip_mode_selection")):
                    dic_result["result"]["swt_ip_mode_selection"] = html.var("swt_ip_mode_selection")
                else:
                    flag = 1
                    dic_result["result"]["swt4_ip_address"] = "Select the mode of Ip" 
                if Validation.is_required(html.var("swt4_ip_address")):
                    if Validation.is_valid_ip(html.var("swt4_ip_address")):
                        dic_result["result"]["swt4_ip_address"] = html.var("swt4_ip_address")
                    else:
                        flag = 1
                        dic_result["result"]["swt4_ip_address"] = "Ip Address is not valid"
                else:
                    flag = 1
                    dic_result["result"]["swt4_ip_address"] = "Ip Address is Required"
                
                if Validation.is_required(html.var("swt4_subnet_mask")):
                    if Validation.is_valid_ip(html.var("swt4_subnet_mask")):
                        dic_result["result"]["swt4_subnet_mask"] = html.var("swt4_subnet_mask")
                    else:
                        flag = 1
                        dic_result["result"]["swt4_subnet_mask"] = "Subnet Mask is not valid"
                else:
                    flag = 1
                    dic_result["result"]["swt4_subnet_mask"] = "Subnet Mask is Required"
                    
                if Validation.is_required(html.var("swt4_gateway")):
                    if Validation.is_valid_ip(html.var("swt4_gateway")):
                        dic_result["result"]["swt4_gateway"] = html.var("swt4_gateway")
                    else:
                        flag = 1
                        dic_result["result"]["swt4_gateway"] = "Gateway Format is not valid"
                else:
                    flag = 1
                    dic_result["result"]["swt4_gateway"] = "Gateway Address is Required"
            if flag == 1:
            ...
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["swt_ip_mode_selection",html.var("swt_ip_mode_selection")])
            dic_result["result"].append(["swt4_ip_address",html.var("swt4_ip_address")])
            dic_result["result"].append(["swt4_subnet_mask",html.var("swt4_subnet_mask")])
            dic_result["result"].append(["swt4_gateway",html.var("swt4_gateway")])
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("swt_link_fault_selection")):
                    dic_result["result"]["swt_link_fault_selection"] = html.var("swt_link_fault_selection")
                else:
                    flag = 1
                    dic_result["result"]["swt_link_fault_selection"] = "Select the Switch Link Fault Selection" 
                if Validation.is_required(html.var("port_select_list_id")):
                    dic_result["result"]["port_select_list_id"] = html.var("port_select_list_id")
                else:
                    flag = 1
                    dic_result["result"]["port_select_list_id"] = "Select the Port" 
                if Validation.is_required(html.var("state_select_list_id")):
                    dic_result["result"]["state_select_list_id"] = html.var("state_select_list_id")
                else:
                    flag = 1
                    dic_result["result"]["state_select_list_id"] = "Select the state" 
                if Validation.is_required(html.var("speed_duplex_list_id")):
                    dic_result["result"]["speed_duplex_list_id"] = html.var("speed_duplex_list_id")
                else:
                    flag = 1
                    dic_result["result"]["speed_duplex_list_id"] = "Select the Speed duplex" 
                if Validation.is_required(html.var("flow_control_select_list")):
                    dic_result["result"]["flow_control_select_list"] = html.var("flow_control_select_list")
                else:
                    flag = 1
                    dic_result["result"]["flow_control_select_list"] = "Select the Flow Control" 
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_port_setting_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["swt_link_fault_selection",html.var("swt_link_fault_selection")])
            dic_result["result"].append(["port_select_list_id",html.var("port_select_list_id")])
            dic_result["result"].append(["state_select_list_id",html.var("state_select_list_id")])
            dic_result["result"].append(["flow_control_select_list",html.var("flow_control_select_list")])                
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("vlan_ingress_filter_id")):
                    dic_result["result"]["vlan_ingress_filter_id"] = html.var("vlan_ingress_filter_id")
                else:
                    flag = 1
                    dic_result["result"]["vlan_ingress_filter_id"] = "Select the VLAN Ingress Filter" 
                if Validation.is_required(html.var("vlan_pass_all_id")):
                    dic_result["result"]["vlan_pass_all_id"] = html.var("vlan_pass_all_id")
                else:
                    flag = 1
                    dic_result["result"]["vlan_pass_all_id"] = "Select the VLAN Pass All" 
                if Validation.is_required(html.var("vlan_port_id")):
                    dic_result["result"]["vlan_port_id"] = html.var("vlan_port_id")
                else:
                    flag = 1
                    dic_result["result"]["vlan_port_id"] = "Select the VLAN Port" 
                ...
                if Validation.is_required(html.var("vlan_mode_id")):
                    dic_result["result"]["vlan_mode_id"] = html.var("vlan_mode_id")
                else:
                    flag = 1
                    dic_result["result"]["vlan_mode_id"] = "Select the VLAN Mode" 
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_vlan_setting_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["vlan_ingress_filter_id",html.var("vlan_ingress_filter_id")])
            dic_result["result"].append(["vlan_pass_all_id",html.var("vlan_pass_all_id")])
            dic_result["result"].append(["vlan_port_id",html.var("vlan_port_id")])
            dic_result["result"].append(["pvid",html.var("pvid")])
            dic_result["result"].append(["vlan_mode_id",html.var("vlan_mode_id")])
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("bandwidth_cpu_protect_id")):
                    dic_result["result"]["bandwidth_cpu_protect_id"] = html.var("bandwidth_cpu_protect_id")
                else:
                    flag = 1
                    dic_result["result"]["bandwidth_cpu_protect_id"] = "Select the Cpu Protect" 
                if Validation.is_required(html.var("bandwidth_port_select_list_id")):
                    dic_result["result"]["bandwidth_port_select_list_id"] = html.var("bandwidth_port_select_list_id")
                else:
                    flag = 1
                    dic_result["result"]["bandwidth_port_select_list_id"] = "Select the Port" 
                if Validation.is_required(html.var("bandwidth_type_select_list_id")):
                    dic_result["result"]["bandwidth_type_select_list_id"] = html.var("bandwidth_type_select_list_id")
                else:
                    flag = 1
                    dic_result["result"]["bandwidth_type_select_list_id"] = "Select the Type" 
                    
                if Validation.is_required(html.var("bandwidth_state_select_list_id")):
                    dic_result["result"]["bandwidth_state_select_list_id"] = html.var("bandwidth_state_select_list_id")
                else:
                    flag = 1
                    dic_result["result"]["bandwidth_state_select_list_id"] = "Select the State" 
                if html.var("bandwidth_rate_id") == None:
                    ...
                    if Validation.is_required(html.var("bandwidth_rate_id")):
                        if Validation.is_number(html.var("bandwidth_rate_id")):
                            dic_result["result"]["bandwidth_rate_id"] = html.var("bandwidth_rate_id")
                        else:
                            flag = 1
                            dic_result["result"]["bandwidth_rate_id"] = "Number is required"
                    else:
                        flag = 1
                        dic_result["result"]["bandwidth_rate_id"] = "Bandwidth Rate is required"     
            if flag == 1:
                dic_result["success"] = 0
                html.write(str(dic_result))
            else:
                dic_result["success"] = 0
                result = swt4_bandwidth_setting_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["bandwidth_cpu_protect_id",html.var("bandwidth_cpu_protect_id")])
            dic_result["result"].append(["bandwidth_port_select_list_id",html.var("bandwidth_port_select_list_id")])
            dic_result["result"].append(["bandwidth_type_select_list_id",html.var("bandwidth_type_select_list_id")])
            dic_result["result"].append(["bandwidth_state_select_list_id",html.var("bandwidth_state_select_list_id")])
            dic_result["result"].append(["bandwidth_rate_id",html.var("bandwidth_rate_id")])
        ...
        if html.var("swt_submit") == "Save":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("storm_type_id")):
                    dic_result["result"]["storm_type_id"] = html.var("storm_type_id")
                else:
                    flag = 1
                    dic_result["result"]["storm_type_id"] = "Select the Type" 
                if Validation.is_required(html.var("storm_state_id")):
                    dic_result["result"]["storm_state_id"] = html.var("storm_state_id")
                else:
                    flag = 1
                ...
                if html.var("storm_rate_id") != None:
                    if Validation.is_required(html.var("storm_rate_id")):
                        dic_result["result"]["storm_rate_id"] = html.var("storm_rate_id")
                    else:
                        flag = 1
                        dic_result["result"]["storm_rate_id"] = "Select The Rate"
                else:
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_storm_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["storm_type_id",html.var("storm_type_id")])
            dic_result["result"].append(["storm_state_id",html.var("storm_state_id")])
            if html.var("storm_rate_id") != None:
                dic_result["result"].append(["storm_rate_id",html.var("storm_rate_id")])
            else:
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("priority_id")):
                    dic_result["result"]["priority_id"] = html.var("priority_id")
                else:
                    flag = 1
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_port_priority_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["result"].append(["priority_id",html.var("priority_id")])
            result = swt4_port_priority_cancel(host_id,device_type_id,dic_result)
            html.write(str(result))
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("dscp_priority_id")):
                    dic_result["result"]["dscp_priority_id"] = html.var("dscp_priority_id")
                else:
                    flag = 1
                    dic_result["result"]["dscp_priority_id"] = "Select the Priority"
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_dscp_priority_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["result"].append(["dscp_priority_id",html.var("dscp_priority_id")])
            result = swt4_dscp_priority_cancel(host_id,device_type_id,dic_result)
            html.write(str(result))
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("802p_priority_id")):
                    dic_result["result"]["802p_priority_id"] = html.var("802p_priority_id")
                else:
                    flag = 1
                    dic_result["result"]["802p_priority_id"] = "Select the Priority"
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_802_priority_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["result"].append(["802p_priority_id",html.var("802p_priority_id")])
            result = swt4_802_priority_controller(host_id,device_type_id,dic_result)
            html.write(str(result))
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("ip_priority")):
                    dic_result["result"]["ip_priority"] = html.var("ip_priority")
                else:
                    flag = 1
                ...
                if Validation.is_required(html.var("ip_priority_address")):
                    if Validation.is_valid_ip(html.var("ip_priority_address")):
                        dic_result["result"]["ip_priority_address"] = html.var("ip_priority_address")
                    else:
                        flag = 1
                        dic_result["result"]["ip_priority_address"] = "Ip Address is not valid"
                else:
                    flag = 1
                    dic_result["result"]["ip_priority_address"] = "Ip Address is Required"
                
                if Validation.is_required(html.var("ip_priority_net_mask")):
                    if Validation.is_valid_ip(html.var("ip_priority_net_mask")):
                        dic_result["result"]["ip_priority_net_mask"] = html.var("ip_priority_net_mask")
                    else:
                        flag = 1
                        dic_result["result"]["ip_priority_net_mask"] = "Subnet Mask is not valid"
                else:
                    flag = 1
                    dic_result["result"]["ip_priority_net_mask"] = "Subnet Mask is Required"
                    
                if Validation.is_required(html.var("ip_priority_id")):
                    dic_result["result"]["ip_priority_id"] = html.var("ip_priority_id")
                else:
                    flag = 1
                    dic_result["result"]["ip_priority_id"] = "Select the Priority"
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_ip_priority_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
                
        elif html.var("swt_submit") == "Cancel":
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["ip_priority",str(html.var("ip_priority"))])
            dic_result["result"].append(["ip_type_id",str(html.var("ip_type_id"))])
            dic_result["result"].append(["ip_priority_address",str(html.var("ip_priority_address"))])
            dic_result["result"].append(["ip_priority_net_mask",str(html.var("ip_priority_net_mask"))])
            dic_result["result"].append(["ip_priority_id",str(html.var("ip_priority_id"))])
            result = swt4_ip_priority_cancel(host_id,device_type_id,dic_result)
            html.write(str(result))
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("qid_map_priority_id")):
                    dic_result["result"]["qid_map_priority_id"] = html.var("qid_map_priority_id")
                else:
                    flag = 1
                    dic_result["result"]["qid_map_priority_id"] = "Select the Priority"
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_queue_priority_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["result"].append(["qid_map_priority_id",html.var("qid_map_priority_id")])
            result = swt4_queue_priority_cancel(host_id,device_type_id,dic_result)
            html.write(str(result))
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("qid_weight_id")):
                    dic_result["result"]["qid_weight_id"] = html.var("qid_weight_id")
                else:
                    flag = 1
                    dic_result["result"]["qid_weight_id"] = "Select the Priority"
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_queue_weight_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
            ...
            dic_result["result"].append(["qid_weight_id",html.var("qid_weight_id")])
            result = swt4_queue_weight_cancel(host_id,device_type_id,dic_result)
            html.write(str(result))
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("qos_priority_id")):
                    dic_result["result"]["qos_priority_id"] = html.var("qos_priority_id")
                else:
                    flag = 1
                    dic_result["result"]["qos_priority_id"] = "Select the Port"
                
                if Validation.is_required(html.var("qos_level_id")):
                    dic_result["result"]["qos_level_id"] = html.var("qos_level_id")
                else:
                    flag = 1
                    dic_result["result"]["qos_level_id"] = "Select the Priority"
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_qos_abstraction_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
                
        elif html.var("swt_submit") == "Cancel":
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["qos_priority_id",html.var("qos_priority_id")])
            dic_result["result"].append(["qos_level_id",html.var("qos_level_id")])
            result = swt4_qos_abstraction_cancel(host_id,device_type_id,dic_result)
            html.write(str(result))
        ...
        if html.var("swt_submit") == "Save" or html.var("swt_submit") == "Retry":
            if html.var("host_id") == "" or html.var("host_id") == None:
                ...
                if Validation.is_required(html.var("1p_remarking_id")):
                    dic_result["result"]["1p_remarking_id"] = html.var("1p_remarking_id")
                else:
                    flag = 1
                    dic_result["result"]["1p_remarking_id"] = "Select the Port"
                
                if Validation.is_required(html.var("1p_remarking_priority")):
                    dic_result["result"]["1p_remarking_priority"] = html.var("1p_remarking_priority")
                else:
                    flag = 1
                    dic_result["result"]["1p_remarking_priority"] = "Select the Priority"
            ...
            if flag == 1:
                ...
                dic_result["success"] = 0
                result = swt4_1p_remarking_controller(host_id,device_type_id,dic_result)
                html.write(str(result))
                
        elif html.var("swt_submit") == "Cancel":
            dic_result["success"] = 0
            dic_result["result"] = []
            dic_result["result"].append(["1p_remarking_id",html.var("1p_remarking_id")])
            dic_result["result"].append(["1p_remarking_priority",html.var("1p_remarking_priority")])
            result = swt4_1p_remarking_cancel(host_id,device_type_id,dic_result)
            html.write(str(result))
...
def swt4_commit_flash(h):
    ...
    html=h
    host_id = html.var("host_id")
    result = commit_to_flash(host_id)# this funtion takes the host_id ,form names,forms parameters and return the dcitionary that the values are set or not
    html.write(str(result))
...
def get_device_list(h):
    ...
    try:
        ...
        result = get_device_list_swt_profiling(ip_address,mac_address,selected_device)
