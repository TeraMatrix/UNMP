...
#    	                session.commit()
                        ...
                        if UNMPDeviceType.odu16 == device_type_id:
                            ...
                            if len(ra_mac_table_obj) > 0:
                                ...
                                ra_status_table = Odu100RaStatusTable(host.host_id,1,None,ra_mac,None,None,None,datetime.now())
                                session.add(ra_status_table)
