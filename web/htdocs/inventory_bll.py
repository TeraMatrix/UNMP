...
class HostBll(object):
    ...
    def get_host_by_id(self, host_id):
        ...
        try:
            session = Session()                 # creating new session object
            hosts = session.query(
                Hosts.host_id, Hosts.host_name, Hosts.host_alias, Hosts.ip_address, Hosts.mac_address,
                ...
                HostOs.os_name, DeviceType.device_name, Hosts.firmware_mapping_id).filter(
    ...
    def add(self, host_name, host_alias, ip_address, mac_address, device_type_id, netmask, gateway, primary_dns,
            ...
            firmware_mapping_id="7.2.20", is_reconciliation=True):
        """
        ...
        try:
            ...
            # if True:
                if self.validate(host_name, host_alias, ip_address, mac_address, device_type_id, netmask, gateway,
                    ...
                    if self.is_duplicate_host_for_add(host_name, host_alias, ip_address, mac_address):
                        ...
                        reconcile_status = 0
                        host = Hosts(
                            host_name, host_alias, ip_address, mac_address, device_type_id, netmask, gateway,
                            ...
                            ssh_password, ssh_port, firmware_mapping_id)
                        session.add(host)
                        session.flush()
    ...
    def edit(self, host_id, host_name, host_alias, ip_address, mac_address, device_type_id, netmask, gateway,
             ...
             ra_mac="", node_type="", master_id="", firmware_mapping_id="7.2.20"):
        """
    ...
    def validate(self, host_name, host_alias, ip_address, mac_address, device_type_id, netmask, gateway, primary_dns,
        ...
        if Validation.is_alpha_numeric(host_name) and Validation.no_space(host_name) and Validation.is_required(
                ...
                Validation.is_required(ip_address) and Validation.is_valid_ip(ip_address) and Validation.is_required(
