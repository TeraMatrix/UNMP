    ...
    def radio_configuration(host_id,selected_device):
        ...
        form_view+="<form id=\"ap_radio_form\" name=\"ap_radio_form\" action=\"ap_radio_form_action.py\" method=\"get\">\
                        ...
                        <div class=\"row-elem\">\
                            ...
                            APForms.country_code_select_list(int(get_radio_data[0].countrycode) if len(get_radio_data)>0 else "","enabled","radioSetup.radioCountryCode",False,"Country"),\
    ...
    def vap_configuration(host_id,selected_device):
        ...
        form_view+="<form id=\"ap_vap_form\" name=\"ap_vap_form\" action=\"ap_vap_form_action.py\" method=\"get\">\
                        ...
                        <div class=\"row-elem\">\
                            ...
                            <input id=\"basicVAPconfigTable.vapHiddenESSIDstate\" type=\"checkbox\" value=\"%s\" name=\"basicVAPsetup.vapHiddenESSIDstate\" %s>\
                        </div>\
                        <div class=\"row-elem\" id=\"vlan_id\">\
                            <label class=\"lbl\">VLAN ID</label>\
                            <input id=\"basicVAPconfigTable.vlanId\" type=\"text\" value=\"%s\" maxlength=\"4\" size=\"8\" name=\"basicVAPconfigTable.vlanId\">\
                        </div>\
                        <div class=\"row-elem\" id=\"vlan_priority\">\
                            <label class=\"lbl\">VLAN Priority</label>\
                            <input id=\"basicVAPconfigTable.vlanPriority\" type=\"text\" value=\"%s\" maxlength=\"1\" size=\"2\" name=\"basicVAPconfigTable.vlanPriority\">\
                        </div>\
                        ...
                        <div class=\"row-elem\" style=\"width:800px\">\
                            ...
                            %s\
                            <input id=\"basicVAPconfigTable.vapFragmentationThresholdValue\" type=\"text\" value=\"%s\" name=\"basicVAPconfigTable.vapFragmentationThresholdValue\" style=\"margin-left:10px\">\
                        </div>\
                        <div class=\"row-elem\" id=\"Beacon\">\
                            <label class=\"lbl\">Beacon Interval</label>\
                            <input id=\"basicVAPconfigTable.vapBeaconInterval\" type=\"text\" style=\"width: 65px;\" value=\"%s\" name=\"basicVAPconfigTable.vapBeaconInterval\">\
                        </div>\
                        \
                        <div class=\"row-elem\" style=\"width:1000px\">\
                            ...
                            <div id=\"wepdiv\" style=\"margin-left:30px;\">\
                                ...
                                <div class=\"row-elem\">\
                                    ...
                                    <input id=\"Wepkey1_chk\" type=\"radio\" value=\"1\" name=\"vapWEPsecurityConfigTable.vapWEPprimaryKey\" maxlength=\"20\" %s>\
                                    Primary Key\
                                </div>\
                                <div class=\"row-elem\">\
                                    ...
                                    <input id=\"Wepkey2_chk\" type=\"radio\" value=\"2\" name=\"vapWEPsecurityConfigTable.vapWEPprimaryKey\" %s >\
                                    Primary Key\
                                </div>\
                                <div class=\"row-elem\">\
                                    ...
                                    <input id=\"Wepkey3_chk\" type=\"radio\" value=\"3\" name=\"vapWEPsecurityConfigTable.vapWEPprimaryKey\" %s >\
                                    Primary Key\
                                </div>\
                                <div class=\"row-elem\">\
                                    ...
                                    <input id=\"Wepkey4_chk\" type=\"radio\" value=\"4\" name=\"vapWEPsecurityConfigTable.vapWEPprimaryKey\" %s >\
                                    Primary Key\
                                </div>\
                            </div><br/>\
                            <div id=\"wparadio\">\
                            ...
                            <div id=\"wpadiv\" style=\"width:900px;margin-left:30px\">\
                                \
                                    ...
                                    <div class=\"row-elem\">\
                                        ...
                                        <input id=\"vapWPAsecurityConfigTable.vapWPAmasterReKey\" type=\"text\" value=\"%s\" maxlength=\"16\" size=\"18\" name=\"vapWPAsecurityConfigTable.vapWPAmasterReKey\">\
                                    </div>\
                                    <div class=\"row-elem\">\
                                        <label class=\"lbl\">WEP Prekey Int:</label>\
                                        <input id=\"vapWPAsecurityConfigTable.vapWEPrekeyInt\" type=\"text\" value=\"%s\" maxlength=\"16\" size=\"18\" name=\"vapWPAsecurityConfigTable.vapWEPrekeyInt\"> \
                                        <span style=\"font-size:9px\">&nbsp;&nbsp;(802.1x mode only)</span>\
                                    </div>\
                                </div>\
                                <div class=\"row-elem\">\
                                ...
                                <div class=\"row-elem\" id=\"personalShared\" style=\"margin-left:30px;\">\
                                    ...
                                    <input id=\"vapWPAsecurityConfigTable.vapWPAconfigPSKPassPhrase\" type=\"password\"  maxlength=\"32\" name=\"vapWPAsecurityConfigTable.vapWPAconfigPSKPassPhrase\" value=\"%s\" />\
                                    <span style=\"font-size:9px\">&nbsp;&nbsp;8 to 32 characters allowed</span>\
                                </div>\
                                <div class=\"row-elem\">\
                    ...
                    int(basic_vap_setup[0].vapHiddenESSIDstate),"checked=checked" if int(basic_vap_setup[0].vapHiddenESSIDstate)==1 else "" if len(basic_vap_setup)>0 else "",\
...
##        form_view +="</fieldset></table></div>"
    ...
    @staticmethod
    def edit_client_form(client_details):
        form_view="\
        <form action=\"edit_ap_client_details.py\" method=\"get\" id=\"edit_client\">\
            <div class=\"row-elem\">\
                <label for=\"client_mac\" class=\"lbl lbl-big\">Client Mac</label>\
                <input type=\"text\" name=\"client_mac\" disabled=\"disabled\" id=\"client_mac\" value=\"%(client_mac)s\">\
                <input type=\"hidden\" id=\"client_id\" name=\"client_id\" value=\"%(client_id)s\" />\
            </div>\
            <div class=\"row-elem\">\
                <label for=\"client_name\" class=\"lbl lbl-big\">Client Name</label>\
                <input type=\"text\" name=\"client_name\" id=\"client_name\" value=\"%(client_name)s\">\
            </div>\
            <div class=\"row-elem\">\
                <label for=\"client_ip\" class=\"lbl lbl-big\">Client IP</label>\
                <input type=\"text\" name=\"client_ip\" id=\"client_ip\" value=\"%(client_ip)s\">\
            </div>\
            <div class=\"row-elem\">\
                <input class=\"yo-small yo-button\" type=\"submit\" value=\"Submit\" />\
            </div>\
        </form>\
        " % client_details
        return form_view
