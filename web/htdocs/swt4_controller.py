...
import time,urllib2,base64, socket
...
def get_device_list_swt_profiling(ip_address,mac_address,selected_device): 
    ...
    try:
        ...
        device_tuple = my.session.query(Hosts.host_id,Hosts.host_alias,Hosts.ip_address,Hosts.mac_address).filter(and_(Hosts.is_deleted == 0,Hosts.ip_address.like('%s%%'%(ip_address)),\
...
def swt4_get_ip(host_id):
    try:
        ...
        swt4_profile_id = []
        swt4_ip_table = []
        swt4_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        if swt4_profile_id == None or swt4_profile_id == []:
            return {"success":1,"result":"","detail":""}
        else: 
            swt4_ip_table = my.session.query(Swt4IpSettings.mode,Swt4IpSettings.ip_address,Swt4IpSettings.subnet_mask,Swt4IpSettings.gateway).filter(Swt4IpSettings.config_profile_id == swt4_profile_id[0]).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_bandwidth_control(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            swt4_bandwidth_table = my.session.query(Swt4BandwidthControl.cpu_protection,Swt4BandwidthControl.port,Swt4BandwidthControl.type,Swt4BandwidthControl.state,Swt4BandwidthControl.rate).filter(Swt4BandwidthControl.config_profile_id == swt4_profile_id[0]).order_by(Swt4BandwidthControl.port).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_storm_control(host_id):
    ...
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            swt4_storm_table = my.session.query(Swt4StormControl.strom_type,Swt4StormControl.state,Swt4StormControl.rate).filter(Swt4StormControl.config_profile_id == swt4_profile_id[0]).order_by(Swt4StormControl.strom_type).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_port_data(host_id):
    ...
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            swt4_port_table = my.session.query(Swt4PortSettings.link_fault_pass_through,Swt4PortSettings.port,Swt4PortSettings.state,Swt4PortSettings.speed,Swt4PortSettings.flow_control).filter(Swt4PortSettings.config_profile_id == swt4_profile_id[0]).order_by(Swt4PortSettings.port).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_vlan_data(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            swt4_vlan_table = my.session.query(Swt4VlanSettings.vlan_ingress_filter,Swt4VlanSettings.vlan_pass_all,Swt4VlanSettings.port,\
...
def swt4_get_port_priority(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            port_priority = my.session.query(Swt4PortBasedPriority.port,Swt4PortBasedPriority.priority).filter(Swt4PortBasedPriority.config_profile_id == swt4_profile_id[0]).order_by(Swt4PortBasedPriority.port).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_dscp_priority(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            dscp_priority = my.session.query(Swt4DscpBasedPriority.dscp,Swt4DscpBasedPriority.priority).filter(Swt4DscpBasedPriority.config_profile_id == swt4_profile_id[0]).order_by(Swt4DscpBasedPriority.dscp).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_801_priority(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            swt4_801_priority = my.session.query(Swt48021pBasedPriority.p802,Swt48021pBasedPriority.priority).filter(Swt48021pBasedPriority.config_profile_id == swt4_profile_id[0]).order_by(Swt48021pBasedPriority.p802).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_ip_base_priority(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            ip_priority = my.session.query(Swt4IpBasePriority.ip_base_priority,Swt4IpBasePriority.ip_type,Swt4IpBasePriority.ip_address,\
...
def swt4_get_queue_prority(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            queue_priority = my.session.query(Swt4QueueBasedPriority.qid_map,Swt4QueueBasedPriority.priority).filter(Swt4QueueBasedPriority.config_profile_id == swt4_profile_id[0]).order_by(Swt4QueueBasedPriority.qid_map).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_qos_abstraction(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            qos_abstraction = my.session.query(Swt4QosArbitration.priority,Swt4QosArbitration.level).filter(Swt4QosArbitration.config_profile_id == swt4_profile_id[0]).order_by(Swt4QosArbitration.priority).all()
        my.sql_alchemy_db_connection_close()
...
def swt4_get_1p_remarking(host_id):
    try:
        ...
        if swt4_profile_id == None or swt4_profile_id == []:
            ...
            swt_1p_remarking = my.session.query(Swt41pRemarking.p_remarking,Swt41pRemarking.p802_remarking).filter(Swt41pRemarking.config_profile_id == swt4_profile_id[0]).order_by(Swt41pRemarking.p_remarking).all()
        my.sql_alchemy_db_connection_close()
...
class MakeSwtSelectListWithDic(object):
    ...
    def ip_mode_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ip_mode_select_dic = {'name':['StaticIp','DHCP'],'value':['static','dhcp']}
    ...
    def link_fault_pass_through_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        link_fault_pass_through_select_list_dic = {'name':['Disabled','Enabled'],'value':['0','1']}
    ...
    def port_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        port_select_list_dic = {'name':['1','2','3','4'],'value':['0','1','2','3']}
    ...
    def state_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        state_select_list_dic = {'name':['Disable','Enable'],'value':['0','1']}
    ...
    def speed_duplex_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        speed_duplex_select_list_dic = {'name':['Auto','10M/half','10M/full','100M/half','100M/full'],'value':['0','1','2','3','4']}
    ...
    def flow_control_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        flow_control_select_list_dic = {'name':['Off','On'],'value':['0','1']}
    ...
    def vlan_ingress_filter_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):        
        vlan_ingress_filter_select_list_dic = {'name':['Disable','Enable'],'value':['0','1']}
    ...
    def vlan_pass_all_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):        
        vlan_pass_all_select_list_dic = {'name':['Disable','Enable'],'value':['0','1']}
    ...
    def vlan_port_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        vlan_port_select_list_dic = {'name':['Port 1','Port 2','Port 3','Port 4','Port 5'],'value':['0','1','2','3','4']}
    ...
    def vlan_mode_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        vlan_mode_select_list_dic = {'name':['Original','keep Format'],'value':['0','1']}
    ...
    def bandwidth_cpu_protect_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):        
        bandwidth_cpu_protect_select_list_dic = {'name':['Disable','Enable'],'value':['0','1']}
    ...
    def bandwidth_port_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):        
        bandwidth_port_select_list_dic ={'name':['Port 1','Port 2','Port 3','Port 4','Port 5'],'value':['0','1','2','3','4']}
    ...
    def bandwidth_type_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        bandwidth_type_select_list_dic = {'name':['Ingress','Egress'],'value':['0','1']}
    ...
    def bandwidth_state_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        bandwidth_state_select_list_dic = {'name':['Disable','Enable'],'value':['0','1']}
    ...
    def storm_type_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):        
        storm_type_select_list_dic = {'name':['Broadcast','Multicast','UDA'],'value':['0','1','2']}
    ...
    def storm_state_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):        
        storm_state_select_list_dic ={'name':['off','on'],'value':['0','1']}
    ...
    def storm_rate_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        storm_rate_select_list_dic = {'name':['10','20','40','80','160','320','640'],'value':['10','20','40','80','160','320','640']}
    ...
    def common_enable_disable_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):        
        common_enable_disable_select_list_dic = {'name':['Disable','Enable'],'value':['0','1']}
    ...
    def common_port_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        common_port_select_list_dic = {'name':['Port 1','Port 2','Port 3','Port 4','Port 5'],'value':['0','1','2','3','4']}
    ...
    def common_priority_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        common_priority_select_list_dic = {'name':['0','1','2','3'],'value':['0','1','2','3']}
    ...
    def dscp_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        dscp_select_list_dic = {'name':["EF","AFL1","AFM1","AFH1","AFL2","AFM2","AFH2","AFL3","AFM3","AFH3","AFL4","AFM4","AFH4","NC","BF"],'value':["ef","afl1","afm1","afh1","afl2","afm2","afh2","afl3","afm3","afh3","afl4","afm4","afh4","nc","bf" ]}
        for i in range(1,63):
    ...
    def select_list_802p(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        select_list_802p_dic = {'name':['0','1','2','3','4','5','6','7'],'value':['0','1','2','3','4','5','6','7']}
    ...
    def ip_type_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ip_type_select_list_dic = {'name':['Group A','Group B'],'value':['0','1']}
    ...
    def queue_weight_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        queue_weight_select_list_dic = {'name':['0','1','2','3','4','5','6','7','8'],'value':['0','1','2','3','4','5','6','7','8']}
    ...
    def qos_abstaction_priority_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        qos_abstaction_priority_select_list_dic = {'name':['DSCP','PORT','DOT1P'],'value':['dscp','port','dot1p']}
    ...
    def qos_abstaction_level_select_list(self,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        qos_abstaction_level_select_list_dic = {'name':['0','1','2','3','4'],'value':['0','1','2','3','4']}
...
def swt4_ip_set(host_id,device_type_id,dic_result):
    ...
    try:
        response = ""
        config_profile_id = my.session.query(Hosts.config_profile_id,Hosts.ip_address,Hosts.http_username,Hosts.http_password).filter(Hosts.host_id == host_id).all()
        if dic_result['result']['swt_ip_mode_selection'] == "static":
            url = "http://%s/ip_settings.cgi?mode=%s&ip=%s&msk=%s&gw=%s&dhcp_var=0&ipsetsubmit=Apply"\
                %(config_profile_id[0][1],dic_result['result']['swt_ip_mode_selection'],\
                  dic_result['result']['swt4_ip_address'],dic_result['result']['swt4_subnet_mask'],\
                  dic_result['result']['swt4_gateway'])
        else:
            url =  "http://" + config_profile_id[0][1] + "ip_settings.cgi"
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        ...
        if len(config_profile_id) > 0:
            ...
            if res > 0:
                ...
                if len(swt4_data) > 0:
                    swt4_data[0].mode = dic_result['result']['swt_ip_mode_selection']
                    swt4_data[0].ip_address = dic_result['result']['swt4_ip_address']
                    swt4_data[0].subnet_mask = dic_result['result']['swt4_subnet_mask']
                    swt4_data[0].gateway = dic_result['result']['swt4_gateway']
            host_data = my.session.query(Hosts).filter(Hosts.host_id == host_id).all()  
            ...
            my.session.commit()
            my.sql_alchemy_db_connection_close()
            url = "http://" + str(dic_result['result']['swt4_ip_address']) + "/configuration.cgi?config_submit=++Config+Save++"
            req = urllib2.Request(url)
            auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
            req.add_header("Authorization", "Basic %s" % auth_string)
...
def swt4_port_setting_controller(host_id,device_type_id,dic_result):
    ...
    try:
        config_profile_id = my.session.query(Hosts.config_profile_id,Hosts.ip_address,Hosts.http_username,Hosts.http_password).filter(Hosts.host_id == host_id).all()
        url = "http://" + config_profile_id[0][1] + "/portsettings.cgi?lfp=%s&lfp_submit=Apply"%(dic_result['result']['swt_link_fault_selection'])
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        req.add_header("Authorization", "Basic %s" % auth_string)
        f = urllib2.urlopen(req)
        ...
        url = "http://%s/portsettings.cgi?portnoid=%s&portstate=%s&speed_duplex=%s&flow=%s&portsetting_submit=Apply"\
            %(config_profile_id[0][1],dic_result['result']['port_select_list_id'],\
              dic_result['result']['state_select_list_id'],dic_result['result']['speed_duplex_list_id'],\
        ...
        if len(config_profile_id) > 0:
            ...
            if len(port_data) > 0:
                port_data[0].link_fault_pass_through = dic_result['result']['swt_link_fault_selection']
                port_data[0].port = dic_result['result']['port_select_list_id']
                port_data[0].state = dic_result['result']['state_select_list_id']
                port_data[0].speed = dic_result['result']['speed_duplex_list_id']
                port_data[0].flow_control = dic_result['result']['flow_control_select_list']
        my.session.commit()
        my.sql_alchemy_db_connection_close()
...
def swt4_vlan_setting_controller(host_id,device_type_id,dic_result):
    ...
    try:
        config_profile_id = my.session.query(Hosts.config_profile_id,Hosts.ip_address,Hosts.http_username,Hosts.http_password).filter(Hosts.host_id == host_id).all()
        url = "http://" + config_profile_id[0][1] + "/vlansettings.cgi?vlanfilter=%s&vlanfilter_submit=Apply"%(dic_result['result']['vlan_ingress_filter_id'])
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        req.add_header("Authorization", "Basic %s" % auth_string)
        f = urllib2.urlopen(req)
        ...
        url = "http://" + config_profile_id[0][1] + "/vlansettings.cgi?vlanpas=%s&vlanpass_submit=Apply"%(dic_result['result']['vlan_pass_all_id'])
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        req.add_header("Authorization", "Basic %s" % auth_string)
        f = urllib2.urlopen(req)
        ...
        if len(config_profile_id) > 0:
            ...
            if len(swt4_data) > 0:
                swt4_data[0].vlan_ingress_filter = dic_result['result']['vlan_ingress_filter_id']
                swt4_data[0].vlan_pass_all = dic_result['result']['vlan_pass_all_id']
...
def swt4_bandwidth_setting_controller(host_id,device_type_id,dic_result):
    ...
    try:
        config_profile_id = my.session.query(Hosts.config_profile_id,Hosts.ip_address,Hosts.http_username,Hosts.http_password).filter(Hosts.host_id == host_id).all()
        url = "http://" + config_profile_id[0][1] + "/bandwidthcontrol.cgi?cpu=%s&cpu_submit=Apply"%(dic_result['result']['bandwidth_cpu_protect_id'])
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        req.add_header("Authorization", "Basic %s" % auth_string)
        f = urllib2.urlopen(req)
        ...
        url = "http://" + config_profile_id[0][1] + "/bandwidthcontrol.cgi?bw_port=%s&bw_type=%s&bw_state=%s&bw_rate=%s&bwsubmit=Apply"\
            %(dic_result['result']['bandwidth_port_select_list_id'],\
              dic_result['result']['bandwidth_type_select_list_id'],dic_result['result']['bandwidth_state_select_list_id'],\
        ...
        if len(config_profile_id) > 0:
            ...
            if len(bandwidth_data) > 0:
                bandwidth_data[0].cpu_protection = dic_result['result']['bandwidth_cpu_protect_id']
                bandwidth_data[0].port = dic_result['result']['bandwidth_port_select_list_id']
                bandwidth_data[0].type = dic_result['result']['bandwidth_type_select_list_id']
                bandwidth_data[0].state = dic_result['result']['bandwidth_state_select_list_id']
                bandwidth_data[0].rate = dic_result['result']['bandwidth_rate_id']
        my.session.commit()
        my.sql_alchemy_db_connection_close()
...
def swt4_storm_cancel(host_id,device_type_id,dic_result):
    try:
        ...
        my.sql_alchemy_db_connection_open()
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4StormControl.strom_type,Swt4StormControl.state,Swt4StormControl.rate).filter(Swt4StormControl.config_profile_id == config_profile_id[0]).order_by(Swt4StormControl.strom_type).first()
...
def swt4_ip_cancel(host_id,device_type_id,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4IpSettings.mode,Swt4IpSettings.ip_address,Swt4IpSettings.subnet_mask,Swt4IpSettings.gateway).filter(Swt4IpSettings.config_profile_id == config_profile_id[0]).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
...
def swt4_port_cancel(host_id,device_type_id,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4PortSettings.link_fault_pass_through,Swt4PortSettings.port,Swt4PortSettings.state,Swt4PortSettings.speed,Swt4PortSettings.flow_control).filter(Swt4PortSettings.config_profile_id == config_profile_id[0]).order_by(Swt4PortSettings.port).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
...
def swt4_bandwidth_cancel(host_id,device_type_id,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4BandwidthControl.cpu_protection,Swt4BandwidthControl.port,Swt4BandwidthControl.type,Swt4BandwidthControl.state,Swt4BandwidthControl.rate).filter(Swt4BandwidthControl.config_profile_id == config_profile_id[0]).order_by(Swt4BandwidthControl.port).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
...
def swt4_port_priority_cancel(host_id,device_type,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4PortBasedPriority.port,Swt4PortBasedPriority.priority).filter(Swt4PortBasedPriority.config_profile_id == config_profile_id[0]).order_by(Swt4PortBasedPriority.port).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
    ...
    try:
        ...
        if len(config_profile_id) > 0:
            ...
            if len(swt4_data) > 0:
                ...
                swt4_data[0].priority = dic_result['result']['dscp_priority_id']
...
def swt4_dscp_priority_cancel(host_id,device_type,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4DscpBasedPriority.dscp,Swt4DscpBasedPriority.priority).filter(Swt4DscpBasedPriority.config_profile_id == config_profile_id[0]).order_by(Swt4DscpBasedPriority.dscp).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
    ...
    try:
        ...
        if len(config_profile_id) > 0:
            ...
            if len(swt4_data) > 0:
                ...
                swt4_data[0].priority = dic_result['result']['802p_priority_id']
...
def swt4_801_priority_cancel(host_id,device_type,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt48021pBasedPriority.p802,Swt48021pBasedPriority.priority).filter(Swt48021pBasedPriority.config_profile_id == config_profile_id[0]).order_by(Swt48021pBasedPriority.p802).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
...
def swt4_ip_priority_controller(host_id,device_type_id,dic_result):
    ...
    try:
        config_profile_id = my.session.query(Hosts.config_profile_id,Hosts.ip_address,Hosts.http_username,Hosts.http_password).filter(Hosts.host_id == host_id).all()
        url = "http://" + config_profile_id[0][1] + "/ipbased.cgi?ipbse=%s&ipbse_submit=Apply"%(dic_result['result']['ip_priority'])
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        req.add_header("Authorization", "Basic %s" % auth_string)
        f = urllib2.urlopen(req)
        ...
        url = "http://" + config_profile_id[0][1] + "/ipbased.cgi?iptype=%s&Ip_ipaddr=%s&Ip_msk=%s&ipbaseprio=%s&ipbased_submit=Apply"\
            %(dic_result['result']['ip_type_id'],\
              dic_result['result']['ip_priority_address'],dic_result['result']['ip_priority_net_mask'],\
        ...
        if len(config_profile_id) > 0:
            ...
            if len(swt4_data) > 0:
                swt4_data[0].ip_base_priority = dic_result['result']['ip_priority']
                swt4_data[0].ip_type = dic_result['result']['ip_type_id']
                swt4_data[0].ip_address = dic_result['result']['ip_priority_address']
                swt4_data[0].network_mask = dic_result['result']['ip_priority_net_mask']
...
def swt4_ip_priority_cancel(host_id,device_type,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4IpBasePriority.ip_base_priority,Swt4IpBasePriority.ip_type,Swt4IpBasePriority.ip_address,\
    ...
    try:
        ...
        if len(config_profile_id) > 0:
            ...
            if len(swt4_data) > 0:
                ...
                swt4_data[0].priority = dic_result['result']['qid_map_priority_id']
...
def swt4_queue_priority_cancel(host_id,device_type,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result =my.session.query(Swt4QueueBasedPriority.qid_map,Swt4QueueBasedPriority.priority).filter(Swt4QueueBasedPriority.config_profile_id == config_profile_id[0]).order_by(Swt4QueueBasedPriority.qid_map).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
...
def swt4_qos_abstraction_cancel(host_id,device_type,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt4QosArbitration.priority,Swt4QosArbitration.level).filter(Swt4QosArbitration.config_profile_id == config_profile_id[0]).order_by(Swt4QosArbitration.priority).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
...
def swt4_1p_remarking_controller(host_id,device_type_id,dic_result):
    ...
    try:
        ...
        if len(config_profile_id) > 0:
            ...
            if len(swt4_data) > 0:
                swt4_data[0].p_remarking = dic_result['result']['1p_remarking_id']
                swt4_data[0].p802_remarking = dic_result['result']['1p_remarking_priority']
...
def swt4_1p_remarking_cancel(host_id,device_type,dic_result):
    try:
        ...
        success_result = {}
        config_profile_id = my.session.query(Hosts.config_profile_id).filter(Hosts.host_id == host_id).one()
        table_result = my.session.query(Swt41pRemarking.p_remarking,Swt41pRemarking.p802_remarking).filter(Swt41pRemarking.config_profile_id == config_profile_id[0]).order_by(Swt41pRemarking.p_remarking).first()
        print len(table_result)
        if dic_result["success"] == 0:
            print len(dic_result['result'])
            print dic['result'][0][1]
...
dic = {'result': [['swt_ip_mode_selection', 'static'], ['swt4_ip_address', '172.22.0.106.'], ['swt4_subnet_mask', '172.22.0.1'], ['swt4_gateway', '255.255.255.0']], 'success': 0}
...
def commit_to_flash(host_id):
    ...
    try:
        config_profile_id = my.session.query(Hosts.config_profile_id,Hosts.ip_address,Hosts.http_username,Hosts.http_password).filter(Hosts.host_id == host_id).all()       
        url = "http://" + config_profile_id[0][1] + "/configuration.cgi?config_submit=++Config+Save++"
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        req.add_header("Authorization", "Basic %s" % auth_string)
        f = urllib2.urlopen(req)
...
def reboot_final_controller(host_id,firmware):
    ...
    try:
        config_profile_id = my.session.query(Hosts.config_profile_id,Hosts.ip_address,Hosts.http_username,Hosts.http_password).filter(Hosts.host_id == host_id).all()       
        url = "http://" + config_profile_id[0][1] + "/reboot.cgi?Firmware_display=%s&reboot_submit=+++Reboot++"%(firmware)
        req = urllib2.Request(url)
        auth_string = base64.encodestring("%s:%s" % (config_profile_id[0][2],config_profile_id[0][3]))
        req.add_header("Authorization", "Basic %s" % auth_string)
        f = urllib2.urlopen(req)
...
def create_default_configprofile_for_swt4(host_id,device_type_id,table_prefix,insert_update):
    ...
    my.session.commit()
    default_config_profile_id = my.session.query(Odu16ConfigProfiles.config_profile_id).filter(and_(Odu16ConfigProfiles.device_type_id == device_type_id,Odu16ConfigProfiles.config_profile_type_id == "Default")).all()
    ## Get Ip Details
    bandwidth_data = my.session.query(Swt4BandwidthControl.cpu_protection,Swt4BandwidthControl.port,Swt4BandwidthControl.type,Swt4BandwidthControl.state,Swt4BandwidthControl.rate).filter(Swt4BandwidthControl.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(bandwidth_data)):
        bandwidth_add_row = Swt4BandwidthControl(config_profile_id,bandwidth_data[i][0],bandwidth_data[i][1],bandwidth_data[i][2],bandwidth_data[i][3],bandwidth_data[i][4])
        my.session.add(bandwidth_add_row)


    storm_data = my.session.query(Swt4StormControl.strom_type,Swt4StormControl.state,Swt4StormControl.rate).filter(Swt4StormControl.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(storm_data)):
        storm_add_row = Swt4StormControl(config_profile_id,storm_data[i][0],storm_data[i][1],storm_data[i][2])
        my.session.add(storm_add_row)


    port_stats = my.session.query(Swt4PortStatistics.port,Swt4PortStatistics.state,Swt4PortStatistics.speed,Swt4PortStatistics.flow_control).filter(Swt4PortStatistics.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(port_stats)):
        port_stats_add = Swt4PortStatistics(config_profile_id,port_stats[i][0],port_stats[i][1],port_stats[i][2],port_stats[i][3])
        my.session.add(port_stats_add)


    port_setting = my.session.query(Swt4PortSettings.link_fault_pass_through,Swt4PortSettings.port,Swt4PortSettings.state,Swt4PortSettings.speed,Swt4PortSettings.flow_control).filter(Swt4PortSettings.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(port_setting)):
        port_settings_add = Swt4PortSettings(config_profile_id,port_setting[i][0],port_setting[i][1],port_setting[i][2],port_setting[i][3],port_setting[i][4])
        my.session.add(port_settings_add)


    ip_details = my.session.query(Swt4IpSettings.mode,Swt4IpSettings.ip_address,Swt4IpSettings.subnet_mask,Swt4IpSettings.gateway).filter(Swt4IpSettings.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(ip_details)):
        ip_add_row = Swt4IpSettings(config_profile_id,ip_details[i][0],ip_details[i][1],ip_details[i][2],ip_details[i][3])
        my.session.add(ip_add_row)


    vlan_settings = my.session.query(Swt4VlanSettings.vlan_ingress_filter,Swt4VlanSettings.vlan_pass_all,Swt4VlanSettings.port,Swt4VlanSettings.pvid,Swt4VlanSettings.mode).filter(Swt4VlanSettings.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(vlan_settings)):
        vlan_add_row = Swt4VlanSettings(config_profile_id,vlan_settings[i][0],vlan_settings[i][1],vlan_settings[i][2],vlan_settings[i][3],vlan_settings[i][4])
        my.session.add(vlan_add_row)

    port_prty = my.session.query(Swt4PortBasedPriority.port,Swt4PortBasedPriority.priority).filter(Swt4PortBasedPriority.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(port_prty)):
        port_prty_add = Swt4PortBasedPriority(config_profile_id,port_prty[i][0],port_prty[i][1])
        my.session.add(port_prty_add)


    dscp_based = my.session.query(Swt4DscpBasedPriority.dscp,Swt4DscpBasedPriority.priority).filter(Swt4DscpBasedPriority.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(dscp_based)):
        dscp_based_add = Swt4DscpBasedPriority(config_profile_id,dscp_based[i][0],dscp_based[i][1])
        my.session.add(dscp_based_add)


    swt802_data = my.session.query(Swt48021pBasedPriority.p802,Swt48021pBasedPriority.priority).filter(Swt48021pBasedPriority.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(swt802_data)):
        swt802_data_add = Swt48021pBasedPriority(config_profile_id,swt802_data[i][0],swt802_data[i][1])
        my.session.add(swt802_data_add)


    ip_prty = my.session.query(Swt4IpBasePriority.ip_base_priority,Swt4IpBasePriority.ip_type,Swt4IpBasePriority.ip_address,Swt4IpBasePriority.network_mask,Swt4IpBasePriority.priority).filter(Swt4IpBasePriority.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(ip_prty)):
        ip_prty_add = Swt4IpBasePriority(config_profile_id,ip_prty[i][0],ip_prty[i][1],ip_prty[i][2],ip_prty[i][3],ip_prty[i][4])
        my.session.add(ip_prty_add)


    queue_base_prty = my.session.query(Swt4QueueBasedPriority.qid_map,Swt4QueueBasedPriority.priority).filter(Swt4QueueBasedPriority.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(queue_base_prty)):
        queue_base_prty_add = Swt4QueueBasedPriority(config_profile_id,queue_base_prty[i][0],queue_base_prty[i][1])
        my.session.add(queue_base_prty_add)


    queue_weight = my.session.query(Swt4QueueWeightBased.queue,Swt4QueueWeightBased.weight).filter(Swt4QueueWeightBased.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(queue_weight)):
        queue_weight_add = Swt4QueueWeightBased(config_profile_id,queue_weight[i][0],queue_weight[i][1])
        my.session.add(queue_weight_add)

    qos_prty = my.session.query(Swt4QosArbitration.priority,Swt4QosArbitration.level).filter(Swt4QosArbitration.config_profile_id == default_config_profile_id[0][0]).all()
    for i in range(0,len(qos_prty)):
        qos_prty_add = Swt4QosArbitration(config_profile_id,qos_prty[i][0],qos_prty[i][1])
...
#print create_default_configprofile_for_swt4('f60538bc-0ed7-11e1-aea8-e069956899a4','swt4','swt4_',False)