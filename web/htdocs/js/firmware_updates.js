...
$.blueJSON.firmware = function(options){
	...
	options.drawSite = function(){
		...
		var firmwareRequest = function(req,dt){
			...
			setTimeout(function(){abortFirmwareRequest()},10000);
		};
		...
		var resetFirmwareSite = function(){
			...
			$.ajax({
				...
				complete:function(){
				        options.getFirmwareStatusCallObj = setTimeout(function(){options.getFirmwareStatusCall()},options.getFirmwareStatusCallTime);
				}
			});
		};
