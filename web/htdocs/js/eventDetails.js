...
$(function(){
	...
	formValidation();
        ...
        $("#alarm_info_form").submit();
        $("input[id='btn_filter']").toggle(function(){$("#alarm_info_form").show();$(this).val("Hide Search");},function(){$("#alarm_info_form").hide();$(this).val("Advanced Search");});
...
function updateDatatable(last_execution_time){
	...
	setTimeout(function (){updateDatatable(last_execution_time);},60000);
}
