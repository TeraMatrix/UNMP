...
$(function(){
	...
	$("#addhosttable").click(function(){
		$(this).fadeOut(1000);$("#gridviewDiv").fadeOut(1000,function(){$("#formDiv").fadeIn(1000,function(){$("#hostName").focus()});});
	})
			...
			url: "form_for_host.py?action=" + action + "&hostName=" + hostName,
                        success: function(result) { 
							...
							if(action == "edit")
							{
								...
								$("#gridviewDiv").fadeOut(1000,function(){$("#formDiv").fadeIn(1000,function(){$("#alias").focus();});});
...
{
	$("label.error").hide();
	$("#formDiv").fadeOut(1000,function(){ $("#addhosttable").fadeIn(1000);$("#gridviewDiv").fadeIn(1000); });
}
...
function reloadParentList()
{
	$.ajax({
		...
		url: "parent_multiple_select_list.py",
                ...
                error: function() { alert("Problem in loading of new Parent list, please reload page again.");}
	});
}
