				...
				result.find("table").find("#update_btn").click(function(){
					...
					else
					{
						...
						else
						{
							...
							setTimeout(function(){$("#update_btn").hide();$("#active_btn").show();},10000);
						}
					}
				});
					...
					else
					{
						...
						else
						{
							...
							$("input[name='host']:checked").each(function(i,btn_obj){
								...
								setTimeout(function(){$("#loading_"+$(btn_obj).attr("id")).loading_div(3000,"Activating..",0,"green");},5500);
							});
							setTimeout(function(){$("#active_btn").hide();$("#update_btn").show();$("#firmware").val("");$("#image_load").html("");},(9000));
						}
					}
				});
