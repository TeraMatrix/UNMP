...
function changeVapAclSelect()
{
        for(var i in selectVap)
        {
            if(parseInt($("#ap_acl_form").find('select[id="vapSelection.selectVap"]').val())==i)
            {
                ...
                {        
                    $('input[name="vapWPAsecuritySetup.aclState"]').filter("[value='0']").attr('checked', true);
                }
                else
                {
                    $('input[name="vapWPAsecuritySetup.aclState"]').filter("[value='1']").attr('checked', true);
                }
                if(parseInt(selectVap[i][1])==0)
                {
                   $('input[name="vapWPAsecuritySetup.aclMode"]').filter("[value='0']").attr('checked', true);
                }
                else
                {
                    $('input[name="vapWPAsecuritySetup.aclMode"]').filter("[value='1']").attr('checked', true);
                }
...
function vapVapForm()
{
    ...
    for(i in selectVapVap)
    {
          if(parseInt($("#ap_vap_form").find('select[id="vapselectionid"]').val())==i)  
          {
            ...
            $("input[name='basicVAPsetup.vapESSID']").val(selectVapVap[i][1]);
            $("input[name='basicVAPsetup.vapHiddenESSIDstate']").val(selectVapVap[i][2]);
            $("input[name='basicVAPsetup.vapRTSthresholdValue']").val(selectVapVap[i][3]);
            $("input[name='basicVAPsetup.vapFragmentationThresholdValue']").val(selectVapVap[i][4]);
            $("input[name='basicVAPsetup.vapBeaconInterval']").val(selectVapVap[i][5]);
            if(parseInt(selectVapVap[i][6])==0)
            {
                $('input[name="vapWEPsecuritySetup.vapWEPmode"]').filter("[value='0']").attr('checked', true);
            }
            else if(parseInt(selectVapVap[i][6])==1)
            {
                $('input[name="vapWEPsecuritySetup.vapWEPmode"]').filter("[value='1']").attr('checked', true);
            }
            else
            {
                $('input[name="vapWEPsecuritySetup.vapWEPmode"]').filter("[value='2']").attr('checked', true);
            }
            if(parseInt(selectVapVap[i][7])==1)
            {
                $('input[name="vapWEPsecuritySetup.vapWEPprimaryKey"]').filter("[value='1']").attr('checked', true);
            }
            else if(parseInt(selectVapVap[i][7])==2)
            {
                $('input[name="vapWEPsecuritySetup.vapWEPprimaryKey"]').filter("[value='2']").attr('checked', true);
            }
            else if(parseInt(selectVapVap[i][7])==3)
            {
                $('input[name="vapWEPsecuritySetup.vapWEPprimaryKey"]').filter("[value='3']").attr('checked', true);
            }
            else
            {
                $('input[name="vapWEPsecuritySetup.vapWEPprimaryKey"]').filter("[value='4']").attr('checked', true);
            }
             $("input[name='vapWEPsecuritySetup.vapWEPkey1']").val(selectVapVap[i][8]);
             $("input[name='vapWEPsecuritySetup.vapWEPkey2']").val(selectVapVap[i][9]);
             $("input[name='vapWEPsecuritySetup.vapWEPkey3']").val(selectVapVap[i][10]);
             $("input[name='vapWEPsecuritySetup.vapWEPkey4']").val(selectVapVap[i][11]);

            if(parseInt(selectVapVap[i][12])==0)
            {
                $('input[name="vapWPAsecuritySetup.vapWPAmode"]').filter("[value='0']").attr('checked', true);
            }
            else if(parseInt(selectVapVap[i][12])==1)
            {
                $('input[name="vapWPAsecuritySetup.vapWPAmode"]').filter("[value='1']").attr('checked', true);
            }
            else if(parseInt(selectVapVap[i][12])==2)
            {
                $('input[name="vapWPAsecuritySetup.vapWPAmode"]').filter("[value='2']").attr('checked', true);
            }
            else
            {
                $('input[name="vapWPAsecuritySetup.vapWPAmode"]').filter("[value='3']").attr('checked', true);
            }  
            if(parseInt(selectVapVap[i][13])==0)
            {
                $('input[name="vapWPAsecuritySetup.vapWPAcypher"]').filter("[value='0']").attr('checked', true);
            }
            $("input[name='vapWPAsecuritySetup.vapWPArekeyInterval']").val(selectVapVap[i][14]);
            $("input[name='vapWPAsecuritySetup.vapWPAmasterReKey']").val(selectVapVap[i][15]);
            $("input[name='vapWPAsecuritySetup.vapWEPrekeyInt']").val(selectVapVap[i][16]);     
            
            if(parseInt(selectVapVap[i][17])==0)
            {
                $('input[name="vapWPAsecuritySetup.vapWPAkeyMode"]').filter("[value='0']").attr('checked', true);
            }
            else
            {
                $('input[name="vapWPAsecuritySetup.vapWPAkeyMode"]').filter("[value='1']").attr('checked', true);
            } 
            $('input[name="vapWPAsecuritySetup.vapWPAconfigPSKPassPhrase"]').val(selectVapVap[i][18]);
            if(parseInt(selectVapVap[i][19])==0)
            {
                $('input[name="vapWPAsecuritySetup.vapWPArsnPreAuth"]').filter("[value='0']").attr('checked', true);
            }
            else
            {
                $('input[name="vapWPAsecuritySetup.vapWPArsnPreAuth"]').filter("[value='1']").attr('checked', true);
            }       
            $("input[name='vapWPAsecuritySetup.vapWPArsnPreAuthInterface']").val(selectVapVap[i][20]);
            $("input[name='vapWPAsecuritySetup.vapWPAeapReAuthPeriod']").val(selectVapVap[i][21]);
            $("input[name='vapWPAsecuritySetup.vapWPAserverIP']").val(selectVapVap[i][22]);
            $("input[name='vapWPAsecuritySetup.vapWPAserverPort']").val(selectVapVap[i][23]);
            $("input[name='vapWPAsecuritySetup.vapWPAsharedSecret']").val(selectVapVap[i][24]);
            if(i==1)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][25]+"']").attr('checked', true);
            }
            else if(i==2)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][26]+"']").attr('checked', true);
            }
            else if(i==3)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][27]+"']").attr('checked', true);
            }
            else if(i==4)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][28]+']').attr('checked', true);
            }
            else if(i==5)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][29]+"']").attr('checked', true);
            }
            else if(i==6)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][30]+']').attr('checked', true);
            }
            else if(i==7)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][31]+"']").attr('checked', true);
            }
            else if(i==8)
            {
                $('input[name="basicVAPsecurity.vapSecurityMode"]').filter("[value='"+selectVapVap[i][32]+"']").attr('checked', true);
            }
...
function Thresholdchange()
{
	if($("#rts_mode").val()=="1")
	{
		$("input[id='basicVAPsetup.vapRTSthresholdValue']").show();
	}
	else
	{
		$("input[id='basicVAPsetup.vapRTSthresholdValue']").hide();
	}
	if($("#frag_mode").val()=="1")
	{
		$("input[id='basicVAPsetup.vapFragmentationThresholdValue']").show();
	}
	else
	{
		$("input[id='basicVAPsetup.vapFragmentationThresholdValue']").hide();
	}
}
...
function CommonSetRequest(formObj,btn)
{
    ...
    if(myForm.find("input[name='basicVAPsetup.vapHiddenESSIDstate']").attr("checked"))
    {
        essid = 1
    }
    else
