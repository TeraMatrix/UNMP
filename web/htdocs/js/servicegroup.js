...
$(document).ready(function(){
	...
	$("#addservicetable").click(function(){
		$(this).slideUp(1000);$("#formDiv").slideDown(1000,function(){$("#serviceGroupName").focus();});
	})
			...
			url: "form_for_servicegroup.py?action=" + action + "&serviceGroupName=" + serviceGroupName,
                        success: function(result) { 
							...
							if(action == "edit")
							{
								...
								$("#formDiv").slideDown(1000,function(){$("#serviceGroupName").focus();});
							}
							else
							{
...
{
	$("label.error").hide();
	$("#formDiv").slideUp(1000);$("#addservicetable").slideDown(1000);
}
