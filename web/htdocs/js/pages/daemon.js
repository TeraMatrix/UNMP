...
$(document).ready(function(){ 
		...
		$.ajax({
			...
			success:function(result){  
				if(result=='0')
				{
					...
					setTimeout(function() { $("#"+type+"_label").html(info_stop); }, 3000);	
				}
				else if(result=='2')
				{ 		
	...
	$(".refresh").click(function(){ 
		...
		setTimeout(function() { $("#"+type+"_label").html("Refreshing"); }, 1000);
		setTimeout(function() { $("#"+type+"_label").html(info_refresh); }, 3000);
		$.ajax({ 
			type:"post",
