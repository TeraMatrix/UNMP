...
//				alert(html_string);
				...
				all_options = $.map($("#dependent_host_name").multiselect("widget").find(":checkbox"),function( input ){return input.value;});
				all_indexes = $.map($("#dependent_host_name").multiselect("widget").find(":checkbox"),function( input ){return input.title;});
				originally_selected = $("#dependent_host_name").multiselect("getChecked").map(function(){return this.value;}).get();
				
				all_options_values = $.map($("#dependent_host_name").multiselect("widget").find(":checkbox"),function( input ){return input.value;});
				$("#host_name").bind("multiselectclick", function(event, ui){
					...
					var checkedValues = $.map($(this).multiselect("getChecked"), function( input ){return input.title;});
