	                        ...
	                        success:function(result){
	                                if(parseInt(result.success)==0)
	                                {
	                                        if(attrValue==1)
	                                        {
	                                                ...
	                                                {
        	                                                $(singleObj).attr("original-title","RU State Unlock");
	                                                }
	                                                else if(singleAdminStateName=="ru.ra.raConfTable.raAdminState")
	                                                {
	                                                     $(singleObj).attr("original-title","RA State Unlock");   
	                                                }
	                                                else
	                                                {
	                                                        $(singleObj).attr("original-title","SYNC State Unlock");
	                                                }
	                                        ...
	                                        else
	                                        {
	                                                ...
	                                                if(singleAdminStateName=="ru.ruConfTable.adminstate")
	                                                {
        	                                                $(singleObj).attr("original-title","RU State Lock");
	                                                }
	                                                else if(singleAdminStateName=="ru.ra.raConfTable.raAdminState")
	                                                {
	                                                     $(singleObj).attr("original-title","RA State Lock");   
	                                                }
	                                                else
	                                                {
	                                                        $(singleObj).attr("original-title","SYNC State Lock");
	                                                }
	                                        }
	                                }
	                                else
