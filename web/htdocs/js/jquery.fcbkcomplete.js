...
(function( $, undefined ) {
  $.fn.fcbkcomplete = function(opt) {
    return this.queue( function() {
      ...
      function createFCBK() {
         holder = $('<ul class="holder"></ul>').attr('id',options.isID).width(options.width);
        if (options.attachto) {
        ...
        complete = $('<div class="facebook-auto">').width('310px');
        ...
        feed = $('<ul id="'+elemid+'_feed"></ul>').width('300px');
      ...
      function addItem(title, value, preadded, locked, focusme) {
        ...
        var li = $('<li class="'+liclass+' hideName" rel="'+value+'" id="pt_'+id+'"></li>').prepend(txt).append(aclose);
      ...
      function addInput(focusme) {
        var li = $('<li class="bit-input" id="'+elemid + '_annoninput" style="width:310px">');
