...
$(function(){
	...
	$("#addservicetable").click(function(){
		cancelChooseService();
		$(this).fadeOut(1000);$("#gridviewDiv").fadeOut(500,function(){$("#formDiv").fadeIn(1000);});
	})
			...
			url: "form_for_service.py?action=" + action + "&checkCommand=" + checkCommand + "&host=" + host,
                        success: function(result) { 
							...
							if(action == "edit")
							{
								...
								$("#addservicetable").fadeOut(1000);$("#gridviewDiv").fadeOut(1000,function(){$("#formDiv").fadeIn(1000);});
...
{
	$("#formDiv").fadeOut(1000,function(){$("#gridviewDiv").fadeIn(1000);$("#addservicetable").fadeIn(1000);});
}
...
function cancelAddService()
{
	...
	$("#formDiv").fadeOut(1000,function(){$("#addservicetable,#gridviewDiv").fadeIn(1000)});
}
