...
// network bandwidth reporting function start
    $("#excel_rpt_nw").click(function () {
        ...
        var start_time = $("#start_time").val();
        var end_time = $("#end_time").val();
        var url = "ubre_nw_bandwidth_excel_reporting.py?no_of_devices=" + no_of_devices + "&start_date=" + start_date + "&end_date=" + end_date + "&start_time=" + start_time + "&end_time=" + end_time + '&all_host=' + filterHoststring() + '&all_group=' + filterGroupstring();
        $.ajax({
            type: method,
            url: url,
            cache: false,
...
//	$("#page_tip").colorbox(
//	    {
//		href:"ubre_help_network_usage.py",
//		title: "Page Tip",
//		opacity: 0.4,
//		maxWidth: "80%",
//		width:"650x",
