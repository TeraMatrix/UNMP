...
// reporting function start
    $("#excel_rpt_rssi").click(function () {
        ...
        var start_time = $("#start_time").val();
        var end_time = $("#end_time").val();
        var url = "rssi_excel_reporting.py?no_of_devices=" + no_of_devices + "&start_date=" + start_date + "&end_date=" + end_date + "&start_time=" + start_time + "&end_time=" + end_time + '&all_host=' + filterHoststring() + '&all_group=' + filterGroupstring();
        $.ajax({
            type: method,
            url: url,
            cache: false,
