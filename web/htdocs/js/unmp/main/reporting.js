        ...
        $.ajax({
            ...
            success: function (result) {
                try {
                    ...
                    result = [];
                    $().toastmessage('showErrorToast', String(err));
                }
                ...
                //////
                submitClicked = true;
                spinStop($spinLoading, $spinMainLoading);// stop the loading
            }
        });
        return false;
    });
...
// reporting function start
    $("#excel_rpt_crc").click(function () {
        ...
        var url = "odu_excel_reporting.py?no_of_devices=" + no_of_devices + "&start_date=" + start_date + "&end_date=" + end_date + "&start_time=" + start_time + "&end_time=" + end_time + '&all_host=' + filterHoststring() + '&all_group=' + filterGroupstring();
        $.ajax({
            type: method,
            url: url,
            cache: false,
            success: function (result) {
                if (result == 0 || result == '0') {
                    ...
                    window.location = "download/error_excel.xls";
                }
...
//	create data table object
    oTableAvg = $('#average_report_table').dataTable({
        ...
        "aoColumns": [
            { "sTitle": "TIME", "sClass": "center", "sWidth": "20%" },
            { "sTitle": "HOST NAME", "sClass": "center", "sWidth": "15%"},
            { "sTitle": "IP Address", "sClass": "center", "sWidth": "15%"},
            { "sTitle": "Number of PHY Errors", "sClass": "center", "sWidth": "15%" },
            { "sTitle": "Number of CRC Errors", "sClass": "center", "sWidth": "15%" },
            { "sTitle": "Group Name", "sClass": "center", "sWidth": "15%" }
        ]
    });
    $("#avg_header").show();
...
//	create data table object
    oTableTotal = $('#total_report_table').dataTable({
        ...
        "aoColumns": [
            ...
            { "sTitle": "Number of PHY Errors", "sClass": "center", "sWidth": "15%" },
            { "sTitle": "Number of CRC Errors", "sClass": "center", "sWidth": "15%" },
            { "sTitle": "Delta of PHY Errors", "sClass": "center", "sWidth": "15%" },
            { "sTitle": "Delta of CRC Errors", "sClass": "center", "sWidth": "15%" },
            { "sTitle": "Group Name", "sClass": "center", "sWidth": "15%" }
        ]
    });
    $("#total_header").show();
...
function hostGroupSearch() {
    $("#group_search").fcbkcomplete({
        ...
        onselect: function () {
            ...
            $.ajax({
                type: "post",
                url: "show_host_data_of_group.py?select_value=" + selected,
                cache: false,
                success: function (result) {
                    for (var h in result) {
