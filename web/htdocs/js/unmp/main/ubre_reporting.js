...
// reporting function start
    $("#excel_rpt_crc").click(function () {
        ...
        var url = "ubre_odu_excel_reporting.py?no_of_devices=" + no_of_devices + "&start_date=" + start_date + "&end_date=" + end_date + "&start_time=" + start_time + "&end_time=" + end_time + '&all_host=' + filterHoststring() + '&all_group=' + filterGroupstring();
        $.ajax({
            type: method,
            url: url,
            cache: false,
        ...
        onselect: function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    //$("#host_search").trigger("addItem",[{"title": "localhost", "value": "localhost"},{"title": "localhost1", "value": "localhost1"}]);
...
// Neha mam function regarding to panel
