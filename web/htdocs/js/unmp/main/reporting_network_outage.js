...
// reporting function start
    $("#excel_rpt_outage").click(function () {
        spinStart($spinLoading, $spinMainLoading);
        var cur_date = new Date();
        var d = cur_date.getDate();
        var y = cur_date.getFullYear();
        ...
        var start_time = $("#start_time").val();
        var end_time = $("#end_time").val();
        var url = "outage_excel_reporting.py?no_of_devices=" + no_of_devices + "&start_date=" + start_date + "&end_date=" + end_date + "&start_time=" + start_time + "&end_time=" + end_time + '&all_host=' + filterHoststring() + '&all_group=' + filterGroupstring();
        $.ajax({
            type: method,
            url: url,
            cache: false,
            success: function (result) {
                if (result == 0 || result == '0') {
                    ...
                    window.location = "download/outage_excel.xls";
                }
...
//	create data table object
    oTableTotal = $('#total_report_table').dataTable({
        ...
        "aoColumns": [
            { "sTitle": "DATE", "sWidth": "16%" },
            { "sTitle": "HOST NAME", "sClass": "center", "sWidth": "16%"},
            { "sTitle": "IP ADDRESS", "sClass": "center", "sWidth": "16%" },
            { "sTitle": "UPTIME %", "sClass": "center", "sWidth": "16%" },
            { "sTitle": "DOWNTIME   %", "sClass": "center", "sWidth": "16%" },
            { "sTitle": "Group Name", "sClass": "center", "sWidth": "16%" }
        ]
    });
    $("#total_header").show();
