...
try:
    ...
    device_param_list = session.query(Hosts.snmp_version_id,Hosts.snmp_write_community,Hosts.ip_address,Hosts.snmp_port,Hosts.config_profile_id).all()
    add_device = DeviceType('idu','idu port','idu8','','','','','','','','2',0,11)
