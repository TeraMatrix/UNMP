...
def get_hardware_detail(h):
    ...
    if ip_address is not None:
        ...
        if device_type == "odu100":
            oid_dic = {'hardware_version':'1.3.6.1.4.1.26149.2.2.10.1.3.1','serial_number':'1.3.6.1.4.1.26149.2.2.10.1.2.1'}
        elif device_type == "idu4":
            oid_dic = {'hardware_version':'1.3.6.1.4.1.26149.2.2.6.1.2.1','serial_number':'1.3.6.1.4.1.26149.2.1.1.2.1.2.1'}
        else:
            oid_dic = {'hardware_version':'1.3.6.1.4.1.26149.2.2.6.1.2.1','serial_number':'1.3.6.1.4.1.26149.2.1.1.2.1.2.1'}
        ...
        if pysnmp_result["success"]==0:
            ...
            result = {"success":0,"hardware_version":hardware_version.split('_')[0],'serial_number':serial_number.split('_')[0]}
        else:
            result = {"success":1,"result":pysnmp_result['result'].values()[0]}
    else:
