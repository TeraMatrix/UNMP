...
def get_ap_advanced_graph_value(h):
    global html 
    html=h
    device_type_dict={'ap25':'AP25','odu16':'UBR','odu100':'UBRe','idu4':'IDU'}
    ...
    html.new_header('%s %s Historical Graphs'%(device_type_dict[device_type_id],ip_address.replace("'","")),"","",css_list,javascript_list)    
