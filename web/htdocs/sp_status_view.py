...
class SPStatusView(object):
    ...
    def header_buttons():
        ...
        cancel_btn = "<div class=\"header-icon\"><img onclick=\"backListing();\" class=\"n-tip-image\" src=\"images/back.png\" id=\"del_host\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Back To Lising\"></div>"
