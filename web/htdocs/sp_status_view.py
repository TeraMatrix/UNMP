...
#        <input type=\"button\" class=\"yo-small  yo-button\" name=\"sp_graph_show\" value=\"graph\" id=\"sp_graph_show\" style=\"width:50px;\"/>\
    ...
    def device_information_view(result, ip_address):
        # this is common list
        last_reboot_time = ''
        column_list = {'odu16': ['Frequency', 'Slave', 'Active Version', 'Hardware Version', 'Last Reboot Reason', 'Channel', 'Operation state', 'Node Type', 'MAC Address', 'Last Reboot Time'], 'odu100': ['Frequency', 'Slave', 'Active Version',
                                                                                                                                                                                                             'Hardware Version', 'Last Reboot Reason', 'Channel', 'Operation state', 'Node Type', 'MAC Address', 'Last Reboot Time']}
...
#        channel={0:'raBW5Mhz',1:'raBW10Mhz',2:'raBW20Mhz'}
    ...
    def sp_event_alarm_table_view(result, ip_address):
        ...
        image_dic = {
            0: "images/status-7.png", 1: "images/status-0.png", 2: "images/status-7.png",
            3: "images/status-4.png", 4: "images/minor.png", 5: "images/critical.png"}
        length = 5
        history_trap_detail = {}
        ...
        for i in range(length):
            if i < 5:
                ...
                history_trap += '<td>%s</td>' % all_traps[i][2]
                history_trap += '<td>%s</td>' % all_traps[i][3]
                history_trap += '<td style="text-align:left;">%s&nbsp&nbsp&nbsp&nbsp%s</td></tr>' % (
