...
def odu_profiling(h):
    ...
    if device_list_param == [] or device_list_param == None:
        ...
        html.write(page_header_search(device_list_param[0][0],device_list_param[0][1],"RM18,RM,IDU",device_type,device_list_state,"device_type"))
    ...
    def odu100_ru_configuration(self,host_id,selected_device):
        ...
        if len(ru_configuration) > 0:
            odu100_ru_config_form = "\
                                ...
                                self.odu100_select_list_object.poe_state_select_list_cpu(str("" if ru_configuration[0][3]== None else ru_configuration[0][3]),"enabled","ru.ruConfTable.poeState","false","Poe State") if int(cpuid)==1 or int(cpuid)==5 else self.odu100_select_list_object.poe_state_select_list(str("" if ru_configuration[0][3]== None else ru_configuration[0][3]),"enabled","ru.ruConfTable.poeState","false","Poe State"),\
        ...
        str_form+="<form action=\"llc_configuration.py\" method=\"get\" id=\"llc_config_form\" name=\"llc_config_form\">\
                        <div id=\"llc_config_form_parmeters_container\" name=\"llc_config_form_parmeters_container\">\
                            ...
                            <div class=\"row-elem\">\
                                ...
                                <span style=\"font-size:9px\">&nbsp;&nbsp;0 to 429497295</span>\
                            </div>\
                            <div class=\"row-elem\">\
                                <label class=\"lbl\">Leaky Bucket Timer</label>\
