...
class Odu100RaStatusTable(Base):
    ...
    def __init__(self,host_id,raIndex,currentTimeSlot,raMacAddress,raoperationalState,unusedTxTimeUL,unusedTxTimeDL,timestamp):
    ...
    def __repr__(self):
        return "<Odu100RaStatusTable('%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_raStatusTable_id,self.host_id,self.raIndex,self.currentTimeSlot,self.raMacAddress,self.raoperationalState,self.unusedTxTimeUL,self.unusedTxTimeDL,self.timestamp)
...
class Ap25BasicVAPconfigTable(Base):
    ...
    def __init__(self,config_profile_id,vapselection_id,vapESSID,vapHiddenESSIDstate,vapRTSthresholdValue,vapFragmentationThresholdValue,vapBeaconInterval,vlanid=0,vlanpriority=0,vapmode=0,vapSecurityMode=0):
        ...
        self.vapSecurityMode = vapSecurityMode
    def __repr__(self):
        return "<Ap25BasicVAPsetup('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')>"\
     %(self.ap25_basicVAPconfigTable_id,self.config_profile_id,self.vapselection_id,self.vapESSID,self.vapHiddenESSIDstate,\
    self.vapRTSthresholdValue,self.vapFragmentationThresholdValue,self.vapBeaconInterval,self.vlanid,self.vlanpriority,self.vapmode,self.vapSecurityMode)
...
'ccu_softwareinformationtable':relationship(CcuSoftwareInformationTable,backref="hosts",cascade="all,delete,delete-orphan")})
