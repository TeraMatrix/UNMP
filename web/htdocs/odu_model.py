...
class SetOdu16SysOmcRegistrationTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16Misc<'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s'>" % (self.set_odu16_sys_omc_registration_table_id, self.config_profile_id, self.sys_omc_register_contact_addr, self.sys_omc_register_contact_person, self.sys_omc_register_contact_mobile, self.sys_omc_register_alternate_contact, self.sys_omc_register_contact_email,
...
class Odu100SynchStatusTable(Base):
    ...
    def __init__(self, host_id, syncConfigIndex, syncoperationalState, syncrasterTime, timerAdjust, syncpercentageDownlinkTransmitTime):
    ...
    def __repr__(self):
        return "<Odu100SynchStatusTable('%s','%s','%s','%s','%s','%s','%s')>" % (self.odu100_synchStatusTable_id, self.host_id, self.syncConfigIndex, self.syncoperationalState, self.syncrasterTime, self.timerAdjust, self.syncpercentageDownlinkTransmitTime)
...
mapper(
    DeviceType, device_type_table, properties={'hosts': relationship(Hosts, backref='device_type', cascade="all, delete, delete-orphan"),
