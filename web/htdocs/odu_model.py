...
class DeviceType(Base):
    ...
    def __init__(self,device_type_id,device_name,sdm_discovery_id,sdm_discovery_value,vnl_discovery_value,ping_discovery_value,snmp_discovery_value,upnp_discovery_value,mib_name,mib_path,table_prefix,is_generic,is_deleted,sequence):
    ...
    self.snmp_discovery_value,self.upnp_discovery_value,self.mib_name,self.mib_path,self.table_prefix,self.is_generic,self.is_deleted,sequence)
...
class Odu16ConfigProfiles(Base):
    ...
    def __repr__(self):
        return "<ODU16ConfigProfiles('%s','%s','%s','%s','%s')>" % (self.config_profile_id,self.device_type_id,self.profile_name,self.config_profile_type_id,self.parent_id)
...
class Hosts(Base):
	...
	host_vendor_id = Column(VARCHAR(64),ForeignKey('host_vendor.host_vendor_id'))
	host_os_id = Column(VARCHAR(16),ForeignKey('host_os.host_os_id'))
	host_asset_id = Column(VARCHAR(64),ForeignKey('host_assets.host_asset_id'))
	...
	def __repr__(self):
		return "<Hosts('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.host_id,self.host_name,self.host_alias,self.ip_address,self.mac_address,self.device_type_id,self.netmask,self.gateway,self.primary_dns,self.secondary_dns,self.dns_state,self.config_profile_id,self.timestamp,self.created_by,self.creation_time,self.is_deleted,self.updated_by,self.ne_id,self.site_id,self.host_state_id,self.priority_id,self.host_vendor_id,self.host_os_id,self.host_asset_id,self.http_username,self.http_password,self.http_port,self.snmp_read_community,self.snmp_write_community,self.snmp_port,self.snmp_trap_port,self.snmp_version_id,self.comment,self.nms_id,self.parent_name,self.lock_status,self.is_localhost)
...
class HostAssets(Base):
	...
	def __init__(self,host_asset_id,longitude,latitude,serial_number,hardware_version,software_update_state,software_update_msg,software_update_time):
	...
	def __repr__(self):
		return "<HostAssets('%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.host_asset_id,self.longitude,self.latitude,self.serial_number,self.hardware_version,self.software_update_state,self.software_update_msg,self.software_update_time)
...
class SetOdu16IPConfigTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16IPConfigTable<'%s','%s','%d','%d'>" %(self.set_odu16_ip_config_table_id ,self.config_profile_id, self.admin_state,self.auto_ip_config)
...
class SetOdu16NetworkInterfaceConfig(Base):
    ...
    set_odu16_network_interface_config_entry_id = Column(VARCHAR(64),primary_key=True)	
    config_profile_id =	Column(VARCHAR(64),ForeignKey('config_profiles.config_profile_id')) 	
    ...
    def __repr__(self):
        return "SetOdu16NetworkInterfaceConfigTable<'%s','%s','%s','%d'>" %(self.set_odu16_network_interface_config_entry_id ,self.config_profile_id,self.ssid,self.index)
...
class SetOdu16OmcConfTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16OmcConfTable<'%s','%s','%s','%d'>" %(self.set_odu16_omc_conf_table_id,self.config_profile_id,self.omc_ip_address,self.periodic_stats_timer)        
...
class SetOdu16PeerConfigTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16PeerConfig<'%s','%s','%s','%d'>" %(self.set_odu16_peer_config_table_id,self.config_profile_id,self.peer_mac_address,self.index)        
...
class SetOdu16RAAclConfigTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16RAAclConfig<'%s','%s','%s','%d'>" %(self.set_odu16_ra_acl_config_table_id ,self.config_profile_id,self.mac_address,self.index)        
...
class SetOdu16OmOperationsTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16OmOperationsTable<'%s','%s','%d','%s','%s','%s','%s','%d'>" %(self.set_odu16_om_operations_table_id,self.config_profile_id ,self.om_operation_req,self.user_name,self.password,self.ftp_server_address,self.path_name,self.enable_swam)        
...
class SetOdu16RAConfTable(Base):	
    ...
    def __init__(self,config_profile_id,ra_admin_state,acl_mode,ssid):
        ...
        self.ssid=ssid
    def __repr__(self):
        return "SetOdu16OmOperationsTable<'%s','%s','%d','%s','%s','%s','%s','%d'>" %(self.set_odu16_ra_conf_table_id,self.config_profile_id,self.ra_admin_state,self.acl_mode,self.ssid)        
...
class SetOdu16RALlcConfTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16RALlcConfTable<'%s','%s','%d','%d','%d','%d','%d'>" %(self.set_odu16_ra_llc_conf_table_id,self.config_profile_id,self.llc_arq_enable,self.arq_win,self.frame_loss_threshold,self.leaky_bucket_timer_val,self.frame_loss_timeout)
...
class SetOdu16RATddMacConfig(Base):
    ...
    set_odu16_ra_tdd_mac_config_table_id = Column(VARCHAR(64),primary_key=True) 
    config_profile_id =	Column(VARCHAR(64),ForeignKey('config_profiles.config_profile_id')) 
    ...
    def __repr__(self):
        return "SetOdu16RATddMacConfig<'%s','%s','%d','%s','%d','%d','%d','%d','%d'>" %(self.set_odu16_ra_tdd_mac_config_table_id,self.config_profile_id,self.rf_channel_frequency,self.pass_phrase,self.rfcoding,self.tx_power,self.max_crc_errors,self.leaky_bucket_timer_value,self.max_power)
...
class SetOdu16RUConfTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16RUConfTable<'%s','%s','%d','%d','%d','%s'>" %(self.set_odu16_ru_conf_table_id,self.config_profile_id,self.adminstate,self.channel_bandwidth,self.sysnch_source,self.country_code)
...
class SetOdu16RUDateTimeTable(Base):
    ...
    def __repr__(self):
        return "SetOdu16RUConfTable<'%s','%s','%d','%d','%d','%d','%d','%d'>" %(self.set_odu16_ru_date_time_table_id,self.config_profile_id,self.year,self.month,self.day,self.hour,self.min,self.sec)
...
class SetOdu16SyncConfigTable(Base):
    ...
    def __init__(self,config_profile_id,admin_status,raster_time,num_slaves,sync_loss_threshold,leaky_bucket_timer,sync_lost_timeout,sync_config_time_adjust):
    ...
    def __repr__(self):
        return "SetOdu16SyncConfigTable<'%s','%s','%d','%d','%d','%d','%d','%d','%d','%d'>" %(self.set_odu16_sync_config_table_id,self.config_profile_id,self.admin_status,self.raster_time,self.num_slaves,self.sync_loss_threshold,self.leaky_bucket_timer,self.sync_lost_timeout,self.sync_config_time_adjust,self.sync_config_broadcast_enable)
...
class SetOdu16Misc(Base):
    ...
    def __repr__(self):
        return "SetOdu16Misc<'%s','%s','%s','%s','%s','%d'>" % (self.set_odu16_misc_id,self.config_profile_id,self.sys_contact,self.sys_name,self.sys_location,self.snmp_enable_authen_traps)
...
class SetOdu16SysOmcRegistrationTable(Base):
    ...
    set_odu16_sys_omc_registration_table_id =Column(VARCHAR(64),primary_key=True) 
    config_profile_id =	Column(VARCHAR(64),ForeignKey('config_profiles.config_profile_id')) 
    ...
    def __repr__(self):
        return "SetOdu16Misc<'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s'>" % (self.set_odu16_sys_omc_registration_table_id,self.config_profile_id,self.sys_omc_register_contact_addr,self.sys_omc_register_contact_person,self.sys_omc_register_contact_mobile\
...
class Odu100EswGoodFramesTable(Base):
	...
	def __init__(self,host_id,eswGoodFramesPortNum,eswGoodFramesInUnicast,eswGoodFramesOutUnicast,eswGoodFramesInBCast,eswGoodFramesOurBCast,eswGoodFramesInMCast,eswGoodFramesOutMcast):
	...
	def __repr__(self):
		return "<Odu100EswGOOdFramesTable('%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_eswGoodFramesTable_id,self.host_id,self.eswGoodFramesPortNum,self.eswGoodFramesInUnicast,self.eswGoodFramesOutUnicast,self.eswGoodFramesInBCast,self.eswGoodFramesOurBCast,self.eswGoodFramesInMCast,self.eswGoodFramesOutMcast)
...
class Odu100IpConfigTable(Base):
	...
	def __init__(self,config_profile_id,ipConfigIndex,adminState,ipAddress,ipNetworkMask,ipDefaultGateway,autoIpConfig):
	...
	def __repr__(self):
		return "<Odu100IpCOnfigTable('%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_ipConfigTable_id,self.config_profile_id,self.ipConfigIndex,self.adminState,self.ipAddress,self.ipNetworkMask,self.ipDefaultGateway,self.autoIpConfig)

class Odu100NwInterfaceStatisticsTable(Base):
	__tablename__= "odu100_nwInterfaceStatisticsTable"
	odu100_nwInterfaceStatisticsTable_id = Column(VARCHAR(64),primary_key=True)
	host_id = Column(VARCHAR(64),ForeignKey('hosts.host_id'))
...
class Odu100PeerConfigTable(Base):
	...
	def __init__(self,config_profile_id,raIndex,timeslotIndex,peerMacAddress,guaranteedUplinkBW,guaranteedDownlinkBW,basicrateMCSIndex):
	...
	def __repr__(self):
		return "<Odu100PeerCOnfigTable('%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_peerConfigTable_id,self.config_profile_id,self.raIndex,self.timeslotIndex,self.peerMacAddress,self.guaranteedUplinkBW,self.guaranteedDownlinkBW,self.basicRateMCSIndex)
...
class Odu100RaConfTable(Base):
	...
	def __init__(self,config_profile_id,raIndex,raAdminState,aclMode,ssID,guaranteedBroadcastBW,dba,acm,acs,dfs,numSlaves,antennaPort):
	...
	def __repr__(self):
		return "<Odu100RaCOnfTable('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_raConfTable_id,self.config_profile_id,self.raIndex,self.raAdminState,self.aclMode,self.ssID,self.guaranteedBroadcastBW,self.dba,self.acm,self.acs,self.dfs,self.numSlaves,self.antennaPort)
...
class Odu100RaPreferredRFChannelTable(Base):
	...
	def __repr__(self):
		return "<Odu100RaPreferredRFChannelTable('%s','%s','%s','%s','%s')>" %(self.odu100_raPreferredRFChannelTable_id,self.config_profile_id,self.raIndex,self.preindex,self.rafrequency)
...
class Odu100RaSiteSurveyResultTable(Base):
	...
	def __init__(self,host_id,raIndex,scanIndex,rfChannelFrequency,numCrcErrors,maxRslCrcError,numPhyErrors,maxRslPhyError,maxRslValidFrames,channelnumber,noiseFloor):
	...
	def __repr__(self):
		return "<Odu100RaSiteSurveyResultTable('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_raSiteSurveyResultTable_id,self.host_id,self.raIndex,self.scanIndex,self.rfChannelFrequency,self.numCrcErrors,self.maxRslCrcError,self.numPhyErrors,self.maxRslPhyError,self.maxRslValidFrames,self.channelnumber,self.noiseFloor)
...
class Odu100RaStatusTable(Base):
	...
	def __init__(self,host_id,raIndex,currentTimeSlot,raMacAddress,raoperationalState,unusedTxTimeUL,unusedTxTimeDL):
	...
	def __repr__(self):
		return "<Odu100RaStatusTable('%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_raStatusTable_id,self.host_id,self.raIndex,self.currentTimeSlot,self.raMacAddress,self.raoperationalState,self.unusedTxTimeUL,self.unusedTxTimeDL)
...
class Odu100RaTddMacStatisticsTable(Base):
	...
	def __init__(self,host_id,raIndex,rxpackets,txpackets,rxerrors,txerrors,rxdropped,txdropped,rxCrcErrors,rxPhyError):
...
class Odu100RaTddMacStatusTable(Base):
	...
	def __repr__(self):
		return "<Odu100RaTddMacStatusTable('%s','%s','%s','%s')>" %(self.odu100_raTddMacStatusTable_id,self.host_id,self.raIndex,self.rfChanFreq)
...
class Odu100RuConfTable(Base):
	...
	def __init__(self,config_profile_id,confIndex,adminstate,defaultNodeType,channelBandwidth,synchSource,countryCode,poeState,alignmentControl):
	...
	def __repr__(self):
		return "<Odu100RuCOnfTable('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_ruConfTable_id,self.config_profile_id,self.confIndex,self.adminstate,self.defaultNodeType,self.channelBandwidth,self.synchSource,self.countryCode,self.poeState,self.alignmentControl)
...
class Odu100RuStatusTable(Base):
	...
	def __init__(self,host_id,statusIndex,lastRebootReason,isConfigCommitedToFlash,upTime,poeStatus,cpuId,ruoperationalState):
	...
	def __repr__(self):
		return "<Odu100RuStatusTable('%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_ruStatusTable_id,self.host_id,self.statusIndex,self.lastRebootReason,self.isConfigCommitedToFlash,self.upTime,self.poeStatus,self.cpuId,self.ruoperationalState)
...
class Odu100SynchStatusTable(Base):
	...
	def __init__(self,host_id,synchStatsIndex,syncoperationalState,syncrasterTime,timerAdjust,syncpercentageDownlinkTransmitTime):
	...
	def __repr__(self):
		return "<Odu100SynchStatusTable('%s','%s','%s','%s','%s','%s','%s')>" %(self.odu100_synchStatusTable_id,self.host_id,self.synchStatsIndex,self.syncoperationalState,self.syncrasterTime,self.timerAdjust,self.syncpercentageDownlinkTransmitTime)
...
class Oids(Base):
	...
	def __init__(self,oid_id,device_type_id,oid,oid_name,oid_type,access,default_value,min_value,max_value,indexes,dependent_id,multivalue,table_name,coloumn_name):
		self.oid_id = oid_id
		self.device_type_id = device_type_id
		self.oid = oid
	...
	def __repr__(self):
		return "<Oids('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')>" %(self.oid_id,self.device_type_id,self.oid,self.oid_name,self.oid_type,self.access,self.default_value,self.min_value,self.max_value,self.indexes,self.dependent_id,self.multivalue,self.table_name,self.coloumn_name)
...
class TrapAlarms(Base):
	...
	def __init__(self,trap_alarm_id,event_id,trap_id,agent_id,trap_date,trap_receive_date,serevity,trap_event_id,trap_event_type,manage_obj_id,manage_obj_name,component_id,trap_ip,description,timestamp):
...
mapper(DeviceType,device_type_table,properties={'hosts':relationship(Hosts,backref='device_type',cascade="all, delete, delete-orphan"),\
...
mapper(ConfigProfileType,config_profile_type_table,properties={'config_profiles':relationship(Odu16ConfigProfiles,backref='config_profile',cascade="all, delete, delete-orphan")})
...
mapper(Oids,Oids.__table__,properties={'oids_multivalues':relationship(OidsMultivalues,backref="oids",cascade="all,delete,delete-orphan")})
