                                            ...
                                            if result['success']==1:
                                                ...
                                                if len(result['result'])==0:
                                                    ...
                                                    if "timestamp" in column_list:
                                                        ...
                                                        timestamp = 0
                                                    if j=="basicACLconfigTable" or j=="aclMacTable":
                                                        sqlalche_obj.db.execute("delete from %s where config_profile_id = '%s' "%(tablename,host_data[0].config_profile_id))
                                                        time.sleep(1)
...
#obj = Reconciliation()
#print obj.default_configuration_added(55,"ap25","ap25_",datetime.now(),"",True)
            ...
            if host_id==None or host_id == "" or host_id=="undefined":
                ...
                for i in range(0,len(host_id_list)):
                    ...
                    if len(host_data_list)>0:
                        ...
                        radio_status.update({host_id_list[i]:[radio_state[0].radioState if len(radio_state)>0 else "",radio_state[0].radioAPmode if len(radio_state)>0 else ""]})
