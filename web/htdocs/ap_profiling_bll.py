...
logging.basicConfig(filename='/omd/daemon/log/recon_log.log',format='%(levelname)s: %(asctime)s >> %(message)s', level=logging.DEBUG)
if debug_start>0:
                        ...
                        if len(host_data)>0:
                            ...
                            if int(ping_chk)==0:
                                ...
                                # mac address updation in table
                                    ...
                                    print table_result
                                    if debug_start > 0:
                                        logging.info(" table_result: "+str(table_result))
                                if len(table_result)>0:
                                    ...
                                    if len(rec_table_dic)>0:
                                        ...
                                        for j in rec_table_dic:
                                            ...
                                            if debug_start > 0:
                                                logging.info(" column_list: "+str(column_list))
                                            if debug_start > 0:
                                                logging.info(" database_name: "+str(database_name))
                                            time.sleep(5)
                                            ...
                                            if result['success']==1:
                                                ...
                                                if len(result['result'])==0:
                                                    ...
                                                    rec = rec+1
                                                    if debug_start > 0:
                                                        logging.info(" sqlalchetablename \n\n",str(sqlalche_tablename))

                                                    if "config_profile_id" in column_list:
                                                        if debug_start > 0:
                                                            logging.info(" debug isi mein : ")
                                                        table_form = "123"
                                                        ...
                                                        if debug_start > 0:
                                                            logging.info(" sqlalche_table_result : "+str(sqlalche_table_result))
