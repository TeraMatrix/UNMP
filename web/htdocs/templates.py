...
import config, htmllib, pprint, sidebar, views, time, defaults, os, cgi, xml.dom.minidom
from lib import *
...
def page_manage_service_template(h):
    ...
    html.write("</div>")
    html.write("<div class=\"main-title\" id=\"addTemplateDiv\"><img alt=\"\" src=\"images/add16.png\"><span>Add Template</span></div>")
    html.write("<div class=\"template-div\" id=\"addTemplateForm\">")
    html.write(add_template())
    html.write("</div>")
    html.write("<div class=\"main-title\" id=\"editTemplateDiv\"><img alt=\"\" src=\"images/edit16.png\"><span>Edit Template</span></div>")
...
def template_services_list():
    ...
    for host in dom.getElementsByTagName("host"):
        ...
        srvList = "<div class=\"service-list-div\" id=\"serviceListDiv" + hostId + "\">"
        srvCount = 0;
        for srv in host.getElementsByTagName("service"):
            srvCount += 1
            if srvCount % 2 == 0:
                srvList += "<div class=\"row-even\">" + srv.getAttribute("name") + "</div>"
            else:
                srvList += "<div class=\"row-even\">" + srv.getAttribute("name") + "</div>"
        srvList += "</div>"
        htmlString += "<div class=\"sub-title\"><span class=\"span-button\" onclick=\"hostServiceShowHide(this,'" + hostId + "')\">" + hostName + "</span>"
        htmlString += "<img onclick=\"editTemplate('"+ hostId +"')\" class=\"delete-button\" title=\"Delete Template\" alt=\"delete\" src=\"images/delete16.png\"/>"
        htmlString += "<img onclick=\"deleteTemplate('"+ hostId +"')\" class=\"edit-button\" title=\"Edit Template\" alt=\"edit\" src=\"images/edit16.png\"/>"
        htmlString += "</div>"
        htmlString += srvList
