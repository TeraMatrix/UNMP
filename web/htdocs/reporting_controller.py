...
def manage_crc_phy_report(h):
    global html
    html = h
    css_list = ["css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/calendrical.css","css/fcbkcomplete.css","css/style12.css"]
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/reporting.js","js/jquery.fcbkcomplete.js"]
    html.new_header("UBR CRC-PHY Error Report","#ubr_sub_menu","",css_list,js_list)
...
def average_data_crc_phy(h):
    ...
    r=Report_bll()
    average_list=r.get_avg_data_for_two_dates(no_of_devices,date_start,date_end,all_group,all_host)
    return average_list
...
def total_data_crc_phy(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.get_total_data_for_two_dates(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
...
def manage_rssi_report(h):
    ...
    html = h
    css_list = ["css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/calendrical.css","css/fcbkcomplete.css","css/style12.css"]
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/reporting_rssi.js","js/jquery.fcbkcomplete.js"]
...
def average_data_rssi(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    average_list=r.get_avg_data_for_two_dates_rssi(no_of_devices,date_start,date_end,all_group,all_host)
    return average_list
...
def total_data_rssi(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.get_total_data_for_two_dates_rssi(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
...
def manage_network_usage_report(h):
    ...
    html = h
    css_list = ["css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/calendrical.css","css/fcbkcomplete.css","css/style12.css"]
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/reporting_network_usage.js","js/jquery.fcbkcomplete.js"]
    html.new_header("UBR Network Usage Report","#ubr_sub_menu","",css_list,js_list)
...
def total_data_network_usage(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.get_total_data_network_usage(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
...
def manage_network_outage_report(h):
    ...
    html = h
    css_list = ["css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/calendrical.css","css/fcbkcomplete.css","css/style12.css"]
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/reporting_network_outage.js","js/jquery.fcbkcomplete.js"]
    html.new_header("Network Outage Report","manage_network_outage_report.py","",css_list,js_list)
...
def total_data_network_outage(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.get_total_data_network_outage(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
...
def manage_trap_report(h):
    ...
    html = h
    css_list = ["css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/calendrical.css","css/fcbkcomplete.css","css/style12.css"]
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/reporting_traps.js","js/jquery.fcbkcomplete.js"]
    html.new_header("Event Report","manage_trap_report.py","",css_list,js_list)
...
def total_data_trap(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.get_total_data_trap(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
...
def total_data_trap_excel(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result,alarm_result=r.get_total_trap_data_excel(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
...
def show_host_data_of_group(h):
    ...
    if status==0:
        for i in range(0,len(output)):
            temp_dic={'title':str(output[i][1])+' ('+str(output[i][2])+', '+str(output[i][3])+')','value':str(output[i][0])}
            output_list.append(temp_dic)
    else:
        output_list.append(str(output))
    h.req.content_type = 'application/json'
...
def inventory_report(h):
    ...
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/inventory_report.js"]
    html.new_header("Inventory Report","inventory_report.py","",css_list,js_list)
