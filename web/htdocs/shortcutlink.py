...
import config, htmllib, pprint, sidebar, views, time, defaults, os, cgi, xml.dom.minidom, subprocess, datetime, MySQLdb
from lib import *
...
def page_auto_discovery(h):
    ...
    html.write("<a id=\"pingButton\" href=\"#pingDiv\" class=\"tab-active\">Ping")
    html.write("<span class=\"\"></span>")
    html.write("</a>")
    html.write("<a id=\"snmpButton\" href=\"#snmpDiv\" class=\"tab-button\">Snmp")
    html.write("<span class=\"\"></span>")
    html.write("</a>")
    html.write("<a id=\"upnpButton\" href=\"#upnpDiv\" class=\"tab-button\">UPnP")
    html.write("<span class=\"\"></span>")
    html.write("</a>")
    html.write("<a id=\"sdmcButton\" href=\"#sdmcDiv\" class=\"tab-button\">SDM")
    html.write("<span class=\"\"></span>")
    html.write("</a>")
    ...
    html.write("<form id=\"autoDiscovery1\" action=\"ajaxcall_autodiscovery_ping.py\">")
    html.write("<table width=\"100%\">")
    html.write("<colgroup><col width='20%'/><col width='40%'/><col width=\"40%\"/></colgroup>")
    ...
    html.write("<tr><td>IP Range Start</td><td><input type='text' name='ipRangeStart1' id='ipRangeStart1' value=''/></td><td class=\"desc\">Enter the IP octet of the Class C Network specified above from which NMS shall <b>start</b> discovering new devices.</td></tr>")
    html.write("<tr><td>IP Range End</td><td><input type='text' name='ipRangeEnd1' id='ipRangeEnd1' value=''/></td><td class=\"desc\">Enter the IP octet of the Class C Network specified above at which NMS shall <b>stop</b> discovering new devices.</td></tr>")
    html.write("<tr><td>Time Out</td><td><input type='text' name='timeOut1' id='timeOut1' value=''/></td><td class=\"desc\">Enter a timeout in seconds for the PING request.</td></tr>")
    html.write("<tr><td>Discovery Schedule</td><td>")
    html.write("<select name=\"discoverySchedule1\" id=\"discoverySchedule1\" style=\"width:155px;\">")
    ...
    html.write("</select>")
    html.write("</td><td class=\"desc\">You can set the auto-discovery to run periodically.</td></tr>")
    html.write("<tr><td>Service Management</td><td>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" checked=\"checked\" value=\"1\" name=\"serviceManagement1\" id=\"serviceAutoScan1\">")
    ...
    html.write("</div>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" value=\"0\" name=\"serviceManagement1\" id=\"serviceNot1\">")
    html.write("<label style=\"cursor: pointer;\" for=\"serviceNot1\">Do not create Services</label>")
    html.write("</div>")
    html.write("</td><td class=\"desc\">Choose \"Do not create services\" if you want to create and manage services manually. All other settings will scan your network and create the corresponding services. \"Automatic service creation\" is mainly based on Port Scanning, PING, SNMP and UPnP.</td></tr>")
    html.write("<tr><td>Host Group</td><td>" + hostgroup_multiple_select_list("","HostGroup1") + "</td><td class=\"desc\"> Choose Host Group(s) to add new discovered host to</td></tr>")
    html.write("<tr><td class='button' colspan='3'>")
    html.write("<input type=\"submit\" value=\"Discover\" />")
    html.write("<input type='button' value='Cancel' onclick=\"javascript:parent.main.location='main.py';\"/>")
    html.write("</td></tr>")
    html.write("</table>")
    html.write("</form>")
    html.write("</div>")
    ...
    html.write("<div style=\"margin: 20px;\">")
    html.write("<form id=\"autoDiscovery2\" action=\"ajaxcall_autodiscovery_snmp.py\">")
    html.write("<table width=\"100%\">")
    html.write("<colgroup><col width='20%'/><col width='40%'/><col width=\"40%\"/></colgroup>")
    ...
    html.write("<tr><td>IP Range Start</td><td><input type='text' name='ipRangeStart2' id='ipRangeStart2' value=''/></td><td class=\"desc\">Enter the IP octet of the Class C Network specified above from which NMS shall <b>start</b> discovering new devices.</td></tr>")
    html.write("<tr><td>IP Range End</td><td><input type='text' name='ipRangeEnd2' id='ipRangeEnd2' value=''/></td><td class=\"desc\">Enter the IP octet of the Class C Network specified above at which NMS shall <b>stop</b> discovering new devices.</td></tr>")
    html.write("<tr><td>Time Out</td><td><input type='text' name='timeOut2' id='timeOut2' value=''/></td><td class=\"desc\">Enter a timeout in seconds for the SNMP request.</td></tr>")
    html.write("<tr><td>Community</td><td><input type='text' name='community2' id='community2' value='public'/></td><td class=\"desc\">Enter community for the SNMP request.</td></tr>")
    ...
    html.write("<select name=\"version2\" id=\"version2\" style=\"width:155px;\">")
    ...
    html.write("<tr class=\"snmpv3Tr\" style=\"display:none;\"><td>User Name</td><td><input type='text' name='userName2' id='userName2' value=''/></td><td class=\"desc\">Enter User name for secure authentication.</td></tr>")
    ...
    html.write("<tr class=\"snmpv3Tr\" style=\"display:none;\"><td>Authentication Key</td><td><input type='text' name='authKey2' id='authKey2' value=''/></td><td class=\"desc\">Enter Password for secure authentication.</td></tr>")
    html.write("<tr class=\"snmpv3Tr\" style=\"display:none;\"><td>Authentication Protocol</td><td><input type='text' name='authProtocol2' id='authProtocol2' value=''/></td><td class=\"desc\">Enter Authentication Protocol for secure authentication.</td></tr>")
    ...
    html.write("<tr class=\"snmpv3Tr\" style=\"display:none;\"><td>Private Key</td><td><input type='text' name='privKey2' id='privKey2' value=''/></td><td class=\"desc\">Enter Private Key for secure authentication.</td></tr>")
    ...
    # display if snmp version is v3
    html.write("<tr><td>Discovery Schedule</td><td>")
    html.write("<select name=\"discoverySchedule2\" id=\"discoverySchedule2\" style=\"width:155px;\">")
    html.write("<option value=\"once\">Once</option>")
    html.write("<option value=\"daily\">Daily</option>")
    html.write("<option value=\"weekly\">Weekly</option>")
    html.write("<option value=\"monthly\">Monthly</option>")
    ...
    html.write("<tr><td>Service Management</td><td>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" checked=\"checked\" value=\"1\" name=\"serviceManagement2\" id=\"serviceAutoScan2\">")
    ...
    html.write("</div>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" value=\"0\" name=\"serviceManagement2\" id=\"serviceNot2\">")
    html.write("<label style=\"cursor: pointer;\" for=\"serviceNot2\">Do not create Services</label>")
    html.write("</div>")
    html.write("</td><td class=\"desc\">Choose \"Do not create services\" if you want to create and manage services manually. All other settings will scan your network and create the corresponding services. \"Automatic service creation\" is mainly based on Port Scanning, PING, SNMP and UPnP.</td></tr>")
    html.write("<tr><td>Host Group</td><td>" + hostgroup_multiple_select_list("","HostGroup2") + "</td><td class=\"desc\"> Choose Host Group(s) to add new discovered host to</td></tr>")
    html.write("<tr><td class='button' colspan='3'>")
    html.write("<input type=\"submit\" value=\"Discover\" />")
    html.write("<input type='button' value='Cancel' onclick=\"javascript:parent.main.location='main.py';\"/>")
    html.write("</td></tr>")
    ...
    html.write("<div style=\"margin:20px;\">")
    html.write("<form id=\"autoDiscovery3\" action=\"ajaxcall_autodiscovery_upnp.py\">")
    html.write("<table width=\"100%\">")
    html.write("<colgroup><col width='20%'/><col width='40%'/><col width=\"40%\"></colgroup>")
    html.write("<tr><td>Time Out</td><td><input type='text' name='timeOut3' id='timeOut3' value=''/></td><td class=\"desc\">Enter a timeout in seconds for the UPnP request.</td></tr>")
    html.write("<tr><td>Discovery Schedule</td><td>")
    html.write("<select name=\"discoverySchedule3\" id=\"discoverySchedule3\" style=\"width:155px;\">")
    html.write("<option value=\"once\">Once</option>")
    html.write("<option value=\"daily\">Daily</option>")
    html.write("<option value=\"weekly\">Weekly</option>")
    html.write("<option value=\"monthly\">Monthly</option>")
    ...
    html.write("<tr><td>Service Management</td><td>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" checked=\"checked\" value=\"1\" name=\"serviceManagement3\" id=\"serviceAutoScan3\">")
    ...
    html.write("</div>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" value=\"0\" name=\"serviceManagement3\" id=\"serviceNot3\">")
    html.write("<label style=\"cursor: pointer;\" for=\"serviceNot3\">Do not create Services</label>")
    html.write("</div>")
    html.write("</td><td class=\"desc\">Choose \"Do not create services\" if you want to create and manage services manually. All other settings will scan your network and create the corresponding services. \"Automatic service creation\" is mainly based on Port Scanning, PING, SNMP and UPnP.</td></tr>")
    html.write("<tr><td>Host Group</td><td>" + hostgroup_multiple_select_list("","HostGroup3") + "</td><td class=\"desc\"> Choose Host Group(s) to add new discovered host to</td></tr>")
    html.write("<tr><td class='button' colspan='3'>")
    html.write("<input type=\"submit\" value=\"Discover\"/>")
    html.write("<input type='button' value='Cancel' onclick=\"javascript:parent.main.location='main.py';\"/>")
    html.write("</td></tr>")
    ...
    html.write("<div style=\"margin:20px;\">")
    html.write("<form id=\"autoDiscovery4\" action=\"ajaxcall_autodiscovery_sdmc.py\">")
    html.write("<table width=\"100%\">")
    html.write("<colgroup><col width='20%'/><col width='40%'/><col width=\"40%\"></colgroup>")
    html.write("<tr><td>Time Out</td><td><input type='text' name='timeOut4' id='timeOut4' value=''/></td><td class=\"desc\">Enter a timeout in seconds for the Shyam device manager (sdm) request.</td></tr>")
    html.write("<tr><td>Discovery Schedule</td><td>")
    html.write("<select name=\"discoverySchedule4\" id=\"discoverySchedule4\" style=\"width:155px;\">")
    html.write("<option value=\"once\">Once</option>")
    html.write("<option value=\"daily\">Daily</option>")
    html.write("<option value=\"weekly\">Weekly</option>")
    html.write("<option value=\"monthly\">Monthly</option>")
    ...
    html.write("<tr><td>Service Management</td><td>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" checked=\"checked\" value=\"1\" name=\"serviceManagement4\" id=\"serviceAutoScan4\">")
    html.write("<label style=\"cursor: pointer;\" for=\"serviceAutoScan4\">Automatic Service creation</label>")
    html.write("</div>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" value=\"2\" name=\"serviceManagement4\" id=\"serviceTemplate4\">")
    html.write("<label style=\"cursor: pointer;\" for=\"serviceTemplate4\">Automatic Service creation using template(s)</label>")
    html.write("</div>")
    html.write("<div class=\"option-bar\">")
    html.write("<input type=\"radio\" value=\"0\" name=\"serviceManagement4\" id=\"serviceNot4\">")
    html.write("<label style=\"cursor: pointer;\" for=\"serviceNot4\">Do not create Services</label>")
    html.write("</div>")
    html.write("</td><td class=\"desc\">Choose \"Do not create services\" if you want to create and manage services manually. All other settings will scan your network and create the corresponding services. \"Automatic service creation\" is mainly based on Port Scanning, PING, SNMP and UPnP.</td></tr>")
    # choose device type to be search
    html.write("<tr><td>Choose device</td><td>" + shyamDevicesList(sitename) + "</td><td class=\"desc\">Choose devices to be search.<br/><br/><label class=\"error\" for=\"deviceList\" style=\"display: none;\">Please select at least one device.</label></td></tr>")
    # end choose device type to be search
    html.write("<tr><td>Host Group</td><td>" + hostgroup_multiple_select_list("","HostGroup4") + "</td><td class=\"desc\"> Choose Host Group(s) to add new discovered host to</td></tr>")
    html.write("<tr><td class='button' colspan='3'>")
    html.write("<input type=\"submit\" value=\"Discover\"/>")
    html.write("<input type='button' value='Cancel' onclick=\"javascript:parent.main.location='main.py';\"/>")
    html.write("</td></tr>")
    ...
    #html.write("<input type='button' value='Cancel' onclick=\"javascript:parent.main.location='main.py';\" class=\"sexybutton sexysimple sexysmall\" style=\"width:100px;margin-right:10px;\"/>")
...
def shyamDevicesList(sitename):
    ...
    shyamDeviceFile =  "/omd/sites/%s/share/check_mk/web/htdocs/xml/shyamdevices.xml" %(sitename)
    ...
    for dev in deviceListXml:
        if dev.getAttribute("hide") == "false":
            i += 1
            deviceList += "<li><div style=\"width: 7%; float: left; height: 20px;\"><input type=\"checkbox\" id=\"" + dev.getAttribute("id") + "\" name=\"deviceList\" value=\"" + dev.getAttribute("sdmcDiscoveryId") + "\"/></div>"
            deviceList += "<div style=\"width: 92%; float: left; overflow: hidden; height: 20px;\"><label for=\"" + dev.getAttribute("id") + "\">" + dev.getAttribute("name") + "</label></div></li>"
    deviceList += "<input type=\"hidden\" id=\"totalShyamDevice\" name=\"totalShyamDevice\" value=\"" + str(i) + "\"/>"
...
def autodiscovery_ping(h):
    ...
    nmsXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/pingDiscovery.xml" %(sitename)
    nmsSchedulingXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/nmsScheduling.xml" %(sitename)
    checkAutoDiscovery = checkAutoDiscoveryActive(hostGroup, ipBase, ipRangeStart, ipRangeEnd, serviceManagement, timeOut, userName, nmsXmlFile, "ping", "", "", "", "", "", "", "", "", "", "")
    if checkAutoDiscovery == "1":
        if discoverySchedule != "once":
            # save host configuration page details
            dom = xml.dom.minidom.parseString("<nmsDB><autoDiscoveryScheduling/></nmsDB>")
            if(os.path.isfile(nmsSchedulingXmlFile)):
                dom = xml.dom.minidom.parse(nmsSchedulingXmlFile)

            # Check auto discovery Active or not
            autoDiscoverySchedulingTag = dom.getElementsByTagName("autoDiscoveryScheduling")[0]
            ...
            discoverySchedulingDom.setAttribute("scheduling",discoverySchedule)
            ...
            if discoverySchedule == "daily":
                discoverySchedulingDom.setAttribute("schedulingDateTime",str(datetime.datetime.now() + datetime.timedelta(days=1)))
            if discoverySchedule == "weekly":
                discoverySchedulingDom.setAttribute("schedulingDateTime",str(datetime.datetime.now() + datetime.timedelta(days=7)))
            if discoverySchedule == "monthly":
                discoverySchedulingDom.setAttribute("schedulingDateTime",str(datetime.datetime.now() + datetime.timedelta(days=30)))
            if discoverySchedule == "yearly":
                discoverySchedulingDom.setAttribute("schedulingDateTime",str(datetime.datetime.now() + datetime.timedelta(days=365)))
            i = 0
            for discoverySchedulingTag in autoDiscoverySchedulingTag.getElementsByTagName("schedule"):
                if discoverySchedulingTag.getAttribute("type") == "ping" and discoverySchedulingTag.getAttribute("username") == userName and discoverySchedulingTag.getAttribute("ip") == ipBase:
                    i += 1
                    dom.getElementsByTagName("autoDiscoveryScheduling")[0].replaceChild(discoverySchedulingDom,discoverySchedulingTag)
                    fwxml = open(nmsSchedulingXmlFile, "w")
                    fwxml.write(dom.toxml())
                    fwxml.close()
                    html.write("2")	# return 2 to start autodiscovery and schudling replaced by existing scheduling.
                    break;
            if i == 0:
                dom.getElementsByTagName("autoDiscoveryScheduling")[0].appendChild(discoverySchedulingDom)
                fwxml = open(nmsSchedulingXmlFile, "w")
                fwxml.write(dom.toxml())
                fwxml.close()
                html.write("3")		# return 3 to start autodiscovery and add new scheduling details.
        else:
            html.write(checkAutoDiscovery)	# return 1 to start autodiscovery and no scheduling saved.
    else:
...
def autodiscovery_snmp(h):
    ...
    nmsXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/snmpDiscovery.xml" %(sitename)
    nmsSchedulingXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/nmsScheduling.xml" %(sitename)
    checkAutoDiscovery = checkAutoDiscoveryActive(hostGroup, ipBase, ipRangeStart, ipRangeEnd, serviceManagement, timeOut, userName, nmsXmlFile, "snmp", community, port, version, snmpUserName, snmpPassword, authKey, authProtocol, privPassword, privKey, privProtocol)
    if checkAutoDiscovery == "1":
        if discoverySchedule != "once":
            # save host configuration page details
            dom = xml.dom.minidom.parseString("<nmsDB><autoDiscoveryScheduling/></nmsDB>")
...
def autodiscovery_upnp(h):
    ...
    userName = config.user
    nmsXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/upnpDiscovery.xml" %(sitename)
    nmsSchedulingXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/nmsScheduling.xml" %(sitename)
    checkAutoDiscovery = checkAutoDiscoveryActive(hostGroup,"","1","100",serviceManagement,timeOut,userName,nmsXmlFile,"upnp","","","","","","","","","","")
    if checkAutoDiscovery == "1":
        if discoverySchedule != "once":
            # save host configuration page details
            dom = xml.dom.minidom.parseString("<nmsDB><autoDiscoveryScheduling/></nmsDB>")
        ...
        html.write(checkAutoDiscovery)	# return user name, who is already execute this dicovery
...
def autodiscovery_sdmc(h):
    ...
    userName = config.user
    nmsXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/sdmcDiscovery.xml" %(sitename)
    nmsSchedulingXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/nmsScheduling.xml" %(sitename)
    checkAutoDiscovery = checkAutoDiscoveryActive(hostGroup, selectedDeviceList, "1", "100", serviceManagement, timeOut, userName, nmsXmlFile, "sdmc", "", "", "", "", "", "", "", "", "", "")
    if checkAutoDiscovery == "1":
        if discoverySchedule != "once":
            # save host configuration page details
            dom = xml.dom.minidom.parseString("<nmsDB><autoDiscoveryScheduling/></nmsDB>")
...
# if this autodiscovery parameter doesnot exist in xml then it will add it automatically and return 1.
def checkAutoDiscoveryActive(hostGroup, ipBase, start, end, service, timeout, userName, nmsXmlFile, discoveryType, snmpCommunity, snmpPort, snmpVersion, snmpUserName, snmpPasswrod, authKey, authProtocol, privPassword, privKey, privProtocol):
    # save host configuration page details
    dom = xml.dom.minidom.parseString("<nmsDB><autoDiscovery/><discoveredHosts/></nmsDB>")
    dom2 = xml.dom.minidom.parseString("<nmsDB><autoDiscovery/><discoveredHosts/></nmsDB>")
...
def start_autodiscovery_ping(h):
    ...
    hostCheckCommand = ""
    nmsXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/pingDiscovery.xml" %(sitename)
    perlFile = "/omd/sites/%s/share/check_mk/web/htdocs/pingdiscoverycreatexml.pl" %(sitename) 
    #nagiosFile = "/omd/sites/%s/share/check_mk/web/htdocs/nagiosfile.pl" %(sitename) 
    #portscanFile = "/omd/sites/%s/share/check_mk/web/htdocs/portscan.pl" %(sitename) 
    args = [ipBase + "." + ipRangeStart, ipBase + "." + ipRangeEnd, timeOut, nmsXmlFile]
    command = [perlFile]
    command.extend(args)
...
def start_autodiscovery_snmp(h):
    ...
    privProtocol = html.var("privProtocol2")
    nmsXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/snmpDiscovery.xml" %(sitename)
    perlFile = "/omd/sites/%s/share/check_mk/web/htdocs/snmpdiscoverycreatexml.pl" %(sitename)
    args = [ipBase + "." + ipRangeStart, ipBase + "." + ipRangeEnd, community, timeOut, version, port, snmpUserName, authKey, snmpPassword, authProtocol, privKey, privPassword, privProtocol,nmsXmlFile ]
    command = [perlFile]
    command.extend(args)
    pipe = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0]
    html.write(pipe)
...
def start_autodiscovery_upnp(h):
    ...
    timeOut = html.var("timeOut3")
    nmsXmlFile = "/omd/sites/%s/share/check_mk/web/htdocs/xml/upnpDiscovery.xml" %(sitename)
    perlFile = "/omd/sites/%s/share/check_mk/web/htdocs/upnpdiscoverycreatexml.pl" %(sitename) 
...
def start_autodiscovery_sdmc(h):
    ...
    args = [ "--discovery", "-l", selectedDeviceList ,"-o ", timeOut, "-P","54321" ]
    command = [sdmcFile]
    command.extend(args)
    pipe = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0]
        ...
        for outputString in outputStringArray:
            if outputString.find("DeviceType") >= 0:
                ...
                if i == 1:
                    ...
                    # Device type: AP Value: 0,192.168.5.31,00:50:c2:bc:c8:02,VVDN_AP,11nAP,1.1.1.0-347,0.0.4
                    ...
                    dom2.getElementsByTagName("discoveredHosts")[0].appendChild(hostDom)
...
# function to choose option for manage host group, host, service group and service manually
...
def page_manage_hostgroup(h):
    ...
    html.write("<div id=\"formDiv\"></div><table class='addform' id='addhosttable' style='margin-bottom:0px;cursor:pointer;'><colgroup><col width='1%'/><col width='99%'/></colgroup><tr><th><img src='images/add16.png' alt='add'/></th><th>Add Host Group</th></tr></table></div>")
    html.write("<div id=\"gridviewDiv\">")
    grid_view_hostgroup(h)
    html.write("</div>")    
    html.footer()
    # message and options before delete host group
    html.write("<div style=\"position:fixed;width:400px;left:21%; right:auto; bottom:35%; direction:ltr;z-index:200;display:none;\" id=\"DeleteHostGroupMsg\" >")
    ...
    html.write("<div class=\"sub-title\"><input type=\"radio\" id=\"command1\" name=\"command\" value=\"donot delete host\" checked=\"checked\"/><label style=\"vertical-align: bottom;margin-left:3px;\" for=\"command1\">Delete only Host group</label></div>")
    html.write("<div class=\"sub-title\"><input type=\"radio\" id=\"command2\" name=\"command\" value=\"delete host\"/><label style=\"vertical-align: bottom;margin-left:3px;\" for=\"command2\">Delete Host group and Hosts both.</label></div>")
    html.write("<div class=\"row-odd\" style=\"margin: 10px;\">")
    html.write("<input type=\"button\" value=\"Ok\" style=\"width:80px;\" onclick=\"okDelete()\">")
    html.write("<input type=\"button\" value=\"Cancel\" style=\"width:80px;\" onclick=\"cancelDelete()\">")
    html.write("</div>")
    html.write("</div>")
    html.write("</div>")
    html.new_footer()
...
"""
        for site, hostgroup, alias in hosts:
            ...
            tabledata +="<td>" + hostgroup + "</td><td><a class=\"newlink\" href=\"view.py?view_name=hostgroup&hostgroup=" + hostgroup + "\" target=\"main\">" + alias + "</a></td><td><img src='images/edit16.png' alt='edit' title='Edit Host Group' class='imgbutton' onclick='editHostGroup(\"" + hostgroup + "\")'/></td><td><img src='images/delete16.png' alt='delete' title='Delete Host Group' class='imgbutton' onclick='deleteHostGroup(\"" + hostgroup + "\")'/></td></tr>"

        tabledata += "</table><input type=\"hidden\" id=\"totalHostGroup\" name=\"totalHostGroup\" value=\"" + str(i) + "\" />"
...
def form_for_hostgroup(h):
    ...
    if html.var("action").strip() == "edit":
        query = "GET hostgroups\nColumns: hostgroup_name alias\nFilter: hostgroup_name = " + html.var("hostGroupName").strip()
...
def ajax_add_hostgroup(h):
    ...
    if( html.var("hostGroupName").strip() == "" or html.var("alias").strip() == "" ):
        html.write("2")	# retuen 2 if hostgroup name and alias both are null or empty
    else:
        sitename = __file__.split("/")[3]
        countHostGroup = 0
        checkfile = 0
        ...
        if(checkfile == 1 or countHostGroup == 0):
            fw = open("/omd/sites/%s/etc/nagios/conf.d/hostgroups.cfg" % sitename,"a")
...
def ajax_delete_hostgroup(h):
    ...
    if(os.path.isfile("/omd/sites/%s/etc/nagios/conf.d/hostgroups.cfg" % sitename)):
        fr = open("/omd/sites/%s/etc/nagios/conf.d/hostgroups.cfg" % sitename,"r")
        ...
        fw = open("/omd/sites/%s/etc/nagios/conf.d/hostgroups.cfg" % sitename,"w")
        for line in ftr:
            fw.write(line)
        ftr.close()
        fw.close()
        if html.var("command").strip() == "delete host":
            countHost = 0
            html.live.set_prepend_site(True)
            query = "GET hosts\nColumns: host_name\nFilter: host_groups < " + html.var("hostGroupName").strip()
            hosts = html.live.query(query)
            html.live.set_prepend_site(False)
            hosts.sort()
...
def change_hostgroup_from_hosts(oldhostgroup, newhostgroup):
    ...
    if oldhostgroup != newhostgroup:
        html.live.set_prepend_site(True)
        query = "GET hosts\nColumns: host_name\nFilter: host_groups >= " + oldhostgroup
        hosts = html.live.query(query)
        html.live.set_prepend_site(False)
        hosts.sort()
        ...
        for site, hostname in hosts:
            ...
            fw = open("/omd/sites/%s/etc/nagios/conf.d/hosts.cfg" % sitename,"a")
            fw.write("\n#host-" + hostname)
            fw.write("\ndefine host {")
            fw.write("\n\tuse\t\t\tgeneric-host")
            fw.write("\n\thost_name\t\t" + hostname)
...
def ajax_update_hostgroup(h):
    ...
    if( html.var("hostGroupName").strip() == "" or html.var("alias").strip() == "" ):
        ...
        if(checkfile == 1 and countHostGroup > 0):
            ...
            # delete host group
            sitename = __file__.split("/")[3]
            startCheckLine = "#hostgroup-"+html.var("oldHostGroupName").strip()
            endCheckLine = "#endhostgroup-"+html.var("oldHostGroupName").strip()
            checkfile = 0
...
def page_manage_servicegroup(h):
    ...
    html.write("<div class=\"loading\"><img src='images/loading.gif' alt=''/></div>")
    html.write("<div id=\"formDiv\"></div><table class='addform' id='addservicetable' style='margin-bottom:0px;cursor:pointer;'><colgroup><col width='1%'/><col width='99%'/></colgroup><tr><th><img src='images/add16.png' alt='add'/></th><th>Add Service Group</th></tr></table></div>")
    html.write("<div id=\"gridviewDiv\">")
    grid_view_servicegroup(h)
    html.write("</div>")    
    html.footer()
    # message and options before delete service group
    html.write("<div style=\"position:fixed;width:400px;left:21%; right:auto; bottom:35%; direction:ltr;z-index:200;display:none;\" id=\"DeleteServiceGroupMsg\" >")
    html.write("<div class=\"main-title\" style=\"cursor: pointer;\"><span id=\"boxTitle\">Delete Service Group</span></div>")
    html.write("<div class=\"template-div\">")
    html.write("<div class=\"sub-title\"><input type=\"radio\" id=\"command1\" name=\"command\" value=\"donot delete service\" checked=\"checked\"/><label style=\"vertical-align: bottom;margin-left:3px;\" for=\"command1\">Delete only Service group</label></div>")
    html.write("<div class=\"sub-title\"><input type=\"radio\" id=\"command2\" name=\"command\" value=\"delete service\"/><label style=\"vertical-align: bottom;margin-left:3px;\" for=\"command2\">Delete Service group and Services both.</label></div>")
    html.write("<div class=\"row-odd\" style=\"margin: 10px;\">")
    html.write("<input type=\"button\" value=\"Ok\" style=\"width:80px;\" onclick=\"okDelete()\">")
    html.write("<input type=\"button\" value=\"Cancel\" style=\"width:80px;\" onclick=\"cancelDelete()\">")
    html.write("</div>")
...
"""
        for site, servicegroup, alias in services:
            ...
            tabledata +="<td>" + servicegroup + "</td><td><a class=\"newlink\" href=\"view.py?view_name=servicegroup&servicegroup=" + servicegroup + "\" target=\"main\">" + alias + "</a></td><td><img src='images/edit16.png'\ alt='edit' title='Edit Service Group' class='imgbutton' onclick='editServiceGroup(\"" + servicegroup + "\")'/></td><td><img src='images/delete16.png' alt='delete' title='Delete Service Group' class='imgbutton' onclick='deleteServiceGroup(\"" + servicegroup + "\")'/></td></tr>"

        tabledata += "</table><input type=\"hidden\" id=\"totalServiceGroup\" name=\"totalServiceGroup\" value=\"" + str(i) + "\" />"
    except Exception as e:
        html.write("0") #Some error occur, please Refresh the page
    else:
        html.write(tabledata)
...
def form_for_servicegroup(h):
    ...
    _alias = ""
    if html.var("action").strip() == "edit":
        query = "GET servicegroups\nColumns: servicegroup_name alias\nFilter: servicegroup_name = " + html.var("serviceGroupName").strip()
        ...
        for site, servicegroup, alias in services:
            ...
            _alias = alias
        formdata += "<form id=\"addServiceGroupForm\" action=\"ajaxcall_update_servicegroup.py\"><table class='addform'><colgroup><col width='20%'/><col width='40%'/><col width='40%'/></colgroup><tr><th colspan='3'>Edit Service Group</th></tr><tr><td>Service Group Name</td><td><input type='text' name='serviceGroupName' id='serviceGroupName' value='" + _serviceGroupName + "' class='required' readonly = \"readonly\" maxlength='50'/><input type='hidden' name='oldServiceGroupName' id='oldServiceGroupName' value='" + _serviceGroupName + "' /></td><td class=\"desc\">The name of the Service Group.</td></tr><tr><td>Alias</td><td><input type='text' name='alias' id='alias' value='" + _alias + "' class='required' maxlength='100'/></td><td class=\"desc\">Alias is a keyword or descriptive term associated with an object as means of classification.</td></tr><tr><td class='button' colspan='3'><input type='submit' value='Update Service Group' /><input type='button' value='Cancel' onclick=\"cancelEditServiceGroup()\"/></td></tr></table></form>"
...
def ajax_add_servicegroup(h):
    ...
    if( html.var("serviceGroupName").strip() == "" or html.var("alias").strip() == "" ):
        html.write("2")	# retuen 2 if servicegroup name and alias both are null or empty
    else:
        sitename = __file__.split("/")[3]
        countServiceGroup = 0
        checkfile = 0
        ...
        if(checkfile == 1 or countServiceGroup == 0):
            fw = open("/omd/sites/%s/etc/nagios/conf.d/servicegroups.cfg" % sitename,"a")
...
def ajax_delete_servicegroup(h):
    ...
    if(os.path.isfile("/omd/sites/%s/etc/nagios/conf.d/servicegroups.cfg" % sitename)):
        fr = open("/omd/sites/%s/etc/nagios/conf.d/servicegroups.cfg" % sitename,"r")
        ftw = open("/omd/sites/%s/tmp/temp.cfg" % sitename,"w")
        for line in fr:
            if(line.strip() != startCheckLine.strip() and checkfile == 0):
                ftw.write(line)
        ...
        ftw.close()
        ftr = open("/omd/sites/%s/tmp/temp.cfg" % sitename,"r")
        fw = open("/omd/sites/%s/etc/nagios/conf.d/servicegroups.cfg" % sitename,"w")
        for line in ftr:
            fw.write(line)
        ftr.close()
        fw.close()
        if html.var("command").strip() == "delete service":
            countService = 0
            html.live.set_prepend_site(True)
            query= "GET services\nColumns: host_name\nFilter: service_groups < " + html.var("serviceGroupName").strip()
            services = html.live.query(query)
            html.live.set_prepend_site(False)
            services.sort()
            for site, hostname in services:
                countService += 1
            if countService == 0:
                change_servicegroup_from_services(html.var("serviceGroupName").strip(), "")
            else:
                delete_services_of_servicegroup(html.var("serviceGroupName").strip())
        os.system('kill -HUP `cat /omd/sites/%s/tmp/lock/nagios.lock`' % sitename)
        html.write("1")
    else:
        html.write("0")
def change_servicegroup_from_services(oldservicegroup, newservicegroup):
    ...
    if oldservicegroup != newservicegroup:
        html.live.set_prepend_site(True)
        query= "GET services\nColumns: check_command host_name\nFilter: service_groups >= " + oldservicegroup
        services = html.live.query(query)
        html.live.set_prepend_site(False)
        services.sort()
        if(os.path.isfile("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename)):
            for site, command, hostname in services:
                ...
                fr = open("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename,"r")
                ftw = open("/omd/sites/%s/tmp/temp.cfg" % sitename,"w")
                for line in fr:
                    if(line.strip() != startCheckLine.strip() and checkfile == 0):
                        ftw.write(line)
                ...
                ftw.close()
                ftr = open("/omd/sites/%s/tmp/temp.cfg" % sitename,"r")
                fw = open("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename,"w")
                for line in ftr:
                    fw.write(line)
                ftr.close()
                fw.close()
            for site, command, hostname in services:
                ...
                fw = open("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename,"a")
                fw.write("#service-" + hostname.strip() + "-" + command.strip())
                fw.write("\ndefine service {")
                fw.write("\n\tuse\t\t\t" + _useTemplate)
                ...
                if (str(_notificationInverval) != ""):
                    fw.write("\n\tnotification_interval\t\t" + str(_notificationInverval))
                ...
                fw.write("\n}")
                fw.write("\n#endservice-" + hostname.strip() + "-" + command.strip() + "\n")
                fw.close()

#query_service = "GET services\nColumns: description state check_command action_url\nFilter: host_name = " + host
def delete_services_of_servicegroup(servicegroup):
    global html
    html.live.set_prepend_site(True)
    query= "GET services\nColumns: check_command host_name\nFilter: service_groups >= " + servicegroup
    services = html.live.query(query)
    html.live.set_prepend_site(False)
    services.sort()
    sitename = __file__.split("/")[3]
...
def ajax_update_servicegroup(h):
    ...
    if( html.var("serviceGroupName").strip() == "" or html.var("alias").strip() == "" ):
        ...
        if(checkfile == 1 and countServiceGroup > 0):
            ...
            sitename = __file__.split("/")[3]
            startCheckLine = "#servicegroup-"+html.var("oldServiceGroupName").strip()
            endCheckLine = "#endservicegroup-"+html.var("oldServiceGroupName").strip()
            checkfile = 0
...
def page_manage_host(h):
    ...
    html.write("<div id=\"formDiv\"></div><table class='addform' id='addhosttable' style='margin-bottom:0px;cursor:pointer;'><colgroup><col width='1%'/><col width='99%'/></colgroup><tr><th><img src='images/add16.png' alt='add'/></th><th>Add Host</th></tr></table></div>")
    html.write("<div id=\"gridviewDiv\">")
    grid_view_host(h)
    html.write("</div>")
    html.footer()
...
"""
        ...
        for site, host, alias, address, host_groups, parents in hosts:
            ...
            if sql_i > 0:
                ...
                tabledata +="<td>" + host + "</td><td><a class=\"newlink\" href=\"view.py?view_name=host&host=" + host + "\" target=\"main\">" + alias + "</a></td><td><a class=\"newlink\" href=\"http://" + address2 + "\" target=\"main\">" + address + "</td><td>" + (", ".join(host_groups)) + "</td><td>" + (", ".join(parents)) + "</td><td><img src='images/edit16.png' alt='edit' title='Edit Host' class='imgbutton' onclick='editHost(\"" + host + "\")'/></td><td><img src='images/delete16.png' alt='delete' title='Delete Host' class='imgbutton' onclick='deleteHost(\"" + host + "\",\"" + address + "\")'/></td></tr>"
        if all_i == 0:
            tabledata += "<tr><td colspan=\"7\"> No Host Exist </td></tr>"
        tabledata += "</table><input type=\"hidden\" id=\"totalHost\" name=\"totalHost\" value=\"" + str(i) + "\" />"
    except Exception as e:
...
def form_for_host(h):
    ...
    deviceType = ""
    if html.var("action").strip() == "edit":
        query = "GET hosts\nColumns: name alias address host_groups parents\nFilter: name = " + html.var("hostName").strip()
...
def service_template_form():
    ...
    if(os.path.isfile("/omd/sites/%s/share/check_mk/web/htdocs/xml/service_template.xml" % site)):
        dom = xml.dom.minidom.parse("/omd/sites/%s/share/check_mk/web/htdocs/xml/service_template.xml" % site)
    liList = templateform = ""
    for host in dom.getElementsByTagName("host"):
        ...
        for srv in host.getElementsByTagName("service"):
            ...
            for arg in srv.getElementsByTagName("ARG"):
                argCount += 1
                argList += "<div class=\"argInnerDiv\" style=\"width:70px;\">" + arg.getAttribute("name") + "</div><div class=\"argInnerDiv\" style=\"padding: 5px 3px 1px 3px;width:110px;\"><input type=\"text\" id=\"arg" + hostId + srv.getAttribute("id") + str(argCount) + "\" name=\"arg" + hostId + srv.getAttribute("id") + str(argCount) + "\" value=\"\" /></div><div class=\"argInnerDiv\" style=\"color:#CD5728;width:130px;\">" + getText(arg.childNodes).strip() + "</div>"
            argList += "</div>"

            srvList += "<div style=\"width:10%;float:left;overflow:hidden;height:20px;padding-left:30px;\"><input type=\"checkbox\" id=\"srv" + hostId + str(srvCount) + "\" name=\"srv" + hostId + str(srvCount) + "\" value=\"" + srv.getAttribute("id") + "\" checked=\"checked\" /><input type=\"hidden\" id=\"totalArgument" + srv.getAttribute("id") + "\" name=\"totalArgument" + srv.getAttribute("id") + "\" value=\"" + str(argCount) + "\" /></div><div style=\"width:80%;float:left;overflow:hidden;height:20px;padding-top:4px;\"><label style='cursor:pointer;' for=\"srv" + hostId + str(srvCount) + "\">" + srv.getAttribute("name") + "</label></div>"
            if argCount != 0:
                srvList += argList

        liList += "<li class=\"liHost\" style=\"cursor:pointer;\"><div style=\"width:10%;float:left;overflow:hidden;height:20px;\"><input type=\"radio\" name=\"rdServiceTemplate\" id=\"template" + hostId + "\" value=\"" + hostId + "\" /></div><div style=\"width:85%;float:left;overflow:hidden;height:20px;\"><label style=\"font-weight:bold;cursor:pointer;\" for=\"template" + hostId + "\">" + hostName + "</label><input type=\"hidden\" id=\"totalService" + hostId + "\" name=\"totalService" + hostId + "\" value=\"" + str(srvCount) + "\" /></div></li><div class=\"hostTemplateDiv\" style=\"width:100%;height:auto;display:none;background-color:#FFA35D;overflow:auto;\" id=\"template" + hostId + "Div\">"+srvList+"</div>"
...
def ajax_add_host(h):
    ...
    if( html.var("hostName").strip() == "" or html.var("alias").strip() == "" or html.var("ipAddress").strip() == "" ):
        html.write("2")	# retuen 2 if host name and alias both are null or empty
    else:
        sitename = __file__.split("/")[3]
        countHost = 0
        checkfile = 0
        ...
        if(checkfile == 1 or countHost == 0):
            ...
            if(html.var("serviceManagement") == "template"):
                if html.var("rdServiceTemplate") is not None:
                    ...
                    if(os.path.isfile("/omd/sites/%s/share/check_mk/web/htdocs/xml/service_template.xml" % sitename)):
                        templateDom = xml.dom.minidom.parse("/omd/sites/%s/share/check_mk/web/htdocs/xml/service_template.xml" % sitename)
                        ...
                        if hostTemplate.getAttribute("id").strip() == hostTemplateId:
                            for x in range(1, int(totalServices) + 1):
                                if html.var("srv" + hostTemplateId + str(x)) is not None:
                                    serviceTemplateId = html.var("srv" + hostTemplateId + str(x)).strip()
                                    for serviceTemplate in hostTemplate.getElementsByTagName("service"):
                                        if serviceTemplate.getAttribute("id").strip() == serviceTemplateId:
                                            new_check_command = getText(serviceTemplate.getElementsByTagName("check_command")[0].childNodes).strip().replace("$IPADDRESS$",html.var("ipAddress").strip())
                                            serviceConfig += "#service-" + html.var("hostName").strip() + "-" + new_check_command + "\n"
                                            serviceConfig += "define service {\n"
                                            serviceConfig += "\tuse\t\t\t" + getText(serviceTemplate.getElementsByTagName("use")[0].childNodes).strip() + "\n"
                                            serviceConfig += "\thost_name\t\t" + html.var("hostName").strip() + "\n"
                                            serviceConfig += "\tservice_description\t" + getText(serviceTemplate.getElementsByTagName("service_description")[0].childNodes).strip() + "\n"
                                            serviceConfig += "\tmax_check_attempts\t\t\t" + getText(serviceTemplate.getElementsByTagName("max_check_attempts")[0].childNodes).strip() + "\n"
                                            serviceConfig += "\tnormal_check_interval\t\t\t" + getText(serviceTemplate.getElementsByTagName("normal_check_interval")[0].childNodes).strip() + "\n"
                                            serviceConfig += "\tretry_check_interval\t\t\t" + getText(serviceTemplate.getElementsByTagName("retry_check_interval")[0].childNodes).strip() + "\n"
                                            serviceConfig += "\tnotification_interval\t\t\t" + getText(serviceTemplate.getElementsByTagName("notification_interval")[0].childNodes).strip() + "\n"
                                            serviceConfig += "\tcheck_command\t\t\t" + new_check_command + "\n"
                                            serviceConfig += "}\n"
                                            serviceConfig += "#endservice-" + html.var("hostName").strip() + "-" + new_check_command + "\n"
                    fsw = open("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename,"a")
                    fsw.write(serviceConfig)
                    fsw.close()

            # End Add Service Using Selected Template
            if html.var("deviceType") == "AP":
                create_service_for_graph(html.var("hostName").strip(),"check_ap_bandwidth")
                create_service_for_graph(html.var("hostName").strip(),"check_ap_no_of_user")
            os.system('kill -HUP `cat /omd/sites/%s/tmp/lock/nagios.lock`' % sitename)
            ...
            try:
                ...
                for col in result:
                    totalRow = col[0]
                if totalRow == 0:
                    sql = "INSERT INTO nms_devices (devicetype,ipaddress,username,password,port,hostname,created_by) VALUES ('%s','%s','%s','%s','%s','%s','%s')" % (html.var("deviceType"),html.var("ipAddress"),html.var("confUsername"),html.var("confPassword"),html.var("confPort"),html.var("hostName"),config.user)
                    cursor.execute(sql)
                db.commit()
            except:
        ...
        if(checkfile == 1 or countHost == 0):
            ...
            if html.var("hdDeviceType") != html.var("deviceType"):
                if html.var("hdDeviceType") == "AP":
                    delete_service_for_graph(html.var("hostName"),"check_ap_bandwidth")
                    delete_service_for_graph(html.var("hostName"),"check_ap_no_of_user")
                if html.var("deviceType") == "AP":
                    create_service_for_graph(html.var("hostName"),"check_ap_bandwidth")
                    create_service_for_graph(html.var("hostName"),"check_ap_no_of_user")
            ...
            try:
                ...
                if totalRow == 0:
                    ...
                    for col in result:
                        totalRow = col[0]
                    if totalRow == 0:
                        sql = "INSERT INTO nms_devices (devicetype,ipaddress,username,password,port,hostname) VALUES ('%s','%s','%s','%s','%s','%s')" % (html.var("deviceType"),html.var("ipAddress"),html.var("confUsername"),html.var("confPassword"),html.var("confPort"),html.var("hostName"))
                        cursor.execute(sql)
                else:
...
def hostgroup_multiple_select_list(hostGroups, selectListId):
    ...
    for site, hostgroup_name, alias in hostgs:
        liList += "<li>" + hostgroup_name + "<img src=\"images/add16.png\" class=\"plus plus" + selectListId + "\" alt=\"+\" title=\"Add\" id=\"" + hostgroup_name + "\" /></li>"

    selectList += "<div class=\"multiSelectList\" id=\"multiSelectList" + selectListId + "\">"
    selectList += "<input type=\"hidden\" id=\"hd" + selectListId + "\" name=\"hd" + selectListId + "\" value=\"\" />"
    selectList += "<input type=\"hidden\" id=\"hdTemp" + selectListId + "\" name=\"hdTemp" + selectListId + "\" value=\"" + hostGroups + "\" />"
    selectList += "<div class=\"selected\">"
    selectList += "<div class=\"shead\"><span id=\"count\">0</span><span> Host Group(s)</span><a href=\"#\" id=\"rm" + selectListId + "\">Remove all</a>"
    selectList += "</div>"
...
def _parent_multiple_select_list(hostParents, selectListId):
    ...
    for site, name, alias in hosts:
        liList += "<li>" + name + "<img src=\"images/add16.png\" class=\"plus plus" + selectListId + "\" alt=\"+\" title=\"Add\" id=\"" + name + "\" /></li>"

    selectList += "<div class=\"multiSelectList\" id=\"multiSelectList" + selectListId + "\">"
    selectList += "<input type=\"hidden\" id=\"hd" + selectListId + "\" name=\"hd" + selectListId + "\" value=\"\" />"
    selectList += "<input type=\"hidden\" id=\"hdTemp" + selectListId + "\" name=\"hdTemp" + selectListId + "\" value=\"" + hostParents + "\" />"
    selectList += "<div class=\"selected\">"
    selectList += "<div class=\"shead\"><span id=\"count\">0</span><span> Parent(s)</span><a href=\"#\" id=\"rm" + selectListId + "\">Remove all</a>"
    selectList += "</div>"
    selectList += "<ul>" #<li>asdf<img src=\"images/minus16.png\" class=\"minus\" alt=\"-\" title=\"Remove\" /></li>
    selectList += "</ul>"
    selectList += "</div>"
...
def page_manage_service(h):
    ...
    html.write("<div class=\"loading\"><img src='images/loading.gif' alt=''/></div>")
    html.write("<div id=\"formDiv\"></div><table class='addform' id='addservicetable' style='margin-bottom:0px;cursor:pointer;'><colgroup><col width='1%'/><col width='99%'/></colgroup><tr><th><img src='images/add16.png' alt='add'/></th><th>Add Service</th></tr></table></div>")
    html.write("<div id=\"gridviewDiv\">")
    ...
    try:
        ...
        for site, host, alias in hosts:
            ...
            if count_host > 0:
                ...
                if indx != -1:
                    alias = alias[:indx]
                tabledata += "<tr><th colspan='2'><a class=\"newlink\" style=\"color:white;\" href=\"view.py?view_name=host&host=" + host + "\" target=\"main\">" + host +" ("+ alias + ")" + "</a></th><th></th><th colspan=\"2\"></th></tr>"
                ...
                for service_site, description, state, command in services:
                    if description != "check_ap_bandwidth" and description != "check_ap_no_of_user":
                        ...
                        if i % 2 == 0:
                            ...
                            tabledata += "<tr>"
                        tabledata +="<td style=\"padding:5px 0px 5px 10px;\"><img src=\"images/status-" + str(state) + ".png\" alt=\"" + str(state) + "\" width=\"10px\" /></td><td><a class=\"newlink\" href=\"view.py?view_name=service&service=" + description + "&host=" + host + "\" target=\"main\">" + description + "</a><td></td><td><img src='images/edit16.png' alt='edit' title='Edit Service' class='imgbutton' onclick='editService(\"" + command + "\",\"" + host + "\")'/></td><td><img src='images/delete16.png' alt='delete' title='Delete Service' class='imgbutton' onclick='deleteService(\"" + command + "\",\"" + host + "\")'/></td></tr>"

        if all_i == 0:
            tabledata += "<tr><td colspan=\"5\">No Service Exist</td></tr>"
        tabledata += "</table><input type=\"hidden\" id=\"totalService\" name=\"totalService\" value=\"" + str(totalService) + "\" />"
        db.close()
    except Exception as e:
        html.write("0") #Some error occur, please Refresh the page
    else:
    ...
    if html.var("action").strip() == "edit":
        ...
        for site, name, alias in hosts:
            ...
            if count_host > 0:
                ...
                if indx != -1:
                    alias = alias[:indx]
                liList += "<li class=\"liHost\" id=\"" + name + "\" style=\"cursor:pointer;\"><div style=\"width:30%;float:left;overflow:hidden;height:20px;\"><b>" + name + "</b></div><div style=\"width:66%;float:left;overflow:hidden;height:20px;\">" + alias + "</div></li>"
...
def create_service_choose_option(act):
    site = __file__.split("/")[3]
    dom = xml.dom.minidom.parse("/omd/sites/%s/share/check_mk/web/htdocs/xml/service.xml" % site)
...
def create_service_buttons(services):
    ...
    for service in services:
        ...
        liList += "<li class=\"liService\" id=\"" + service_name + "\" style=\"cursor:pointer;\"><div style=\"width:30%;float:left;overflow:hidden;height:20px;\"><b>" + service_name + "</b></div><div style=\"width:66%;float:left;overflow:hidden;height:20px;\">" + getText(service_description.childNodes) + "</div></li>"
    return liList
...
def form_for_service_setting(h):
    ...
    for service in services:
        if(service.getAttribute('name').strip() == html.var("serviceName").strip()):
            create_form_for_basic_service_setting(service.getElementsByTagName("arg"),service.getAttribute('graph').strip(),service.getAttribute('name').strip(),html.var("action").strip())
            break;
    ...
    for arg in argument:
        if(getText(arg.getElementsByTagName("name")[0].childNodes).strip() == "@#$"):
            for aoarg in arg.getElementsByTagName("aoarg"):
                paraAdvance += 1
                tableStringAdvance += "<tr><td>" + getText(aoarg.getElementsByTagName("name")[0].childNodes).strip() + "</td>"
                tableStringAdvance += "<td><input type='text' id='aoarg" + str(paraAdvance) + "' name='aoarg" + str(paraAdvance) + "' para='" + aoarg.getAttribute('id').strip() + "' value=''/></td>"
                tableStringAdvance += "<td class='desc'>" + getText(aoarg.getElementsByTagName("description")[0].childNodes).strip() + "</td></tr>"
        else:
            paraBasic += 1
            tableStringBasic += "<tr><td>" + getText(arg.getElementsByTagName("name")[0].childNodes).strip() + "</td>"
            tableStringBasic += "<td><input type='text' id='arg" + str(paraBasic) + "' name='arg" + str(paraBasic) + "' para='$ARG" + arg.getAttribute('id').strip() + "$' value=''/><label generated=\"false\" for=\"arg" + str(paraBasic) + "\" style=\"display:none;color:red;\" id=\"error_arg" + str(paraBasic) + "\"> *</label></td>"
            tableStringBasic += "<td class='desc'>" + getText(arg.getElementsByTagName("description")[0].childNodes).strip() + "</td></tr>"
    if paraBasic > 0:
        serviceOptionTable += tableStringBasic
    if paraAdvance > 0:
        serviceOptionTable += tableStringAdvance
    if action == "edit":
        serviceOptionTable += "<tr><td class=\"button\" colspan='3'><input type='submit' value='Update Service' /><input type='button' value='Cancel' onclick=\"cancelEditService()\"/><input type='hidden' id='advanceArgument' name='advanceArgument' value='" + str(paraAdvance) + "'/><input type='hidden' id='basicArgument' name='basicArgument' value='" + str(paraBasic) + "'/><input type='hidden' id='hdGraph' name='hdGraph' value='" + graph + "'/><input type='hidden' id='hdCommand' name='hdCommand' value='" + name + "' /></td></tr></table>"
    else:
        serviceOptionTable += "<tr><td class=\"button\" colspan='3'><input type='submit' value='Add New Service' /><input type='button' value='Back' onclick=\"backToChooseService()\"/><input type='button' value='Cancel' onclick=\"cancelAddService()\"/><input type='hidden' id='advanceArgument' name='advanceArgument' value='" + str(paraAdvance) + "'/><input type='hidden' id='basicArgument' name='basicArgument' value='" + str(paraBasic) + "'/><input type='hidden' id='hdGraph' name='hdGraph' value='" + graph + "'/><input type='hidden' id='hdCommand' name='hdCommand' value='" + name + "' /></td></tr></table>"
...
def servicegroup_multiple_select_list(serviceGroups, selectListId):
    ...
    for site, servicegroup_name, alias in servicegs:
        liList += "<li>" + servicegroup_name + "<img src=\"images/add16.png\" class=\"plus plus" + selectListId + "\" alt=\"+\" title=\"Add\" id=\"" + servicegroup_name + "\" /></li>"

    selectList += "<div class=\"multiSelectList\" id=\"multiSelectList" + selectListId + "\">"
    selectList += "<input type=\"hidden\" id=\"hd" + selectListId + "\" name=\"hd" + selectListId + "\" value=\"\" />"
    selectList += "<input type=\"hidden\" id=\"hdTemp" + selectListId + "\" name=\"hdTemp" + selectListId + "\" value=\"" + serviceGroups + "\" />"
    selectList += "<div class=\"selected\">"
    selectList += "<div class=\"shead\"><span id=\"count\">0</span><span> Service Group(s)</span><a href=\"#\" id=\"rm" + selectListId + "\">Remove all</a>"
    selectList += "</div>"
    selectList += "<ul>" #<li>asdf<img src=\"images/minus16.png\" class=\"minus\" alt=\"-\" title=\"Remove\" /></li>
    selectList += "</ul>"
    selectList += "</div>"
...
def ajax_add_service(h):
    ...
    if( html.var("serviceName").strip() == "" or html.var("hostName").strip() == "" or html.var("serviceDescription").strip() == "" or checkPara == 0):
        html.write("2")	# retuen 2 if service name and alias both are null or empty
    else:
        sitename = __file__.split("/")[3]
        countService = 0
        checkfile = 0
        ...
        html.live.set_prepend_site(True)
        #query = "GET services\nColumns: host_name description check_command max_check_attempts  service_groups\nFilter: host_name = " + html.var("hostName").strip()
        query = "GET services\nColumns: check_command\nFilter: host_name = " + html.var("hostName").strip()
        ...
        if(checkfile == 1 or countService == 0):
            ...
            if countDescription == 0:
                fw = open("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename,"a")
                fw.write("#service-" + html.var("hostName").strip()+ "-" + html.var("hdCommand").strip())
                fw.write("\ndefine service {")
                fw.write("\n\tuse\t\t\tgeneric-service-perf,generic-service")
                fw.write("\n\thost_name\t\t" + html.var("hostName").strip())
                fw.write("\n\tservice_description\t\t\t" + html.var("serviceDescription").strip())
                if (html.var("maxCheckAttempts").strip() != ""):
                    fw.write("\n\tmax_check_attempts\t\t" + html.var("maxCheckAttempts").strip())
                if (html.var("normalCheckInterval").strip() != ""):
                    fw.write("\n\tnormal_check_interval\t\t" + html.var("normalCheckInterval").strip())
                if (html.var("retryCheckInterval").strip() != ""):
                    fw.write("\n\tretry_check_interval\t\t" + html.var("retryCheckInterval").strip())
                if (html.var("notificationInterval").strip() != ""):
                    fw.write("\n\tnotification_interval\t\t" + html.var("notificationInterval").strip())
                ...
                fw.write("\n}")
                fw.write("\n#endservice-" + html.var("hostName").strip()+ "-" + html.var("hdCommand") + "\n")
                fw.close()
                os.system('kill -HUP `cat /omd/sites/%s/tmp/lock/nagios.lock`' % sitename)
                html.write("1") # return 1 if service added successfully.
            else:
                html.write("2")  # return 2 if service description is already exist.
        else:
...
def ajax_delete_service(h):
    ...
    html = h
    sitename = __file__.split("/")[3]
    startCheckLine = "#service-"+html.var("hostName").strip() + "-" + html.var("checkCommand")
    endCheckLine = "#endservice-"+html.var("hostName").strip() + "-" + html.var("checkCommand")
    checkfile = 0
    if(os.path.isfile("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename)):
        fr = open("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename,"r")
        ftw = open("/omd/sites/%s/tmp/temp.cfg" % sitename,"w")
...
def ajax_update_service(h):
    ...
    if( html.var("serviceName").strip() == "" or html.var("hostName").strip() == "" or html.var("serviceDescription").strip() == "" or checkPara == 0):
        ...
        if(checkfile == 1 or countService == 0):
            ...
            if countDescription == 0:
                # delete service
                startCheckLine = "#service-"+html.var("oldHostName").strip() + "-" + html.var("oldCheckCommand")
                endCheckLine = "#endservice-"+html.var("oldHostName").strip() + "-" + html.var("oldCheckCommand")
                checkfile = 0
                if(os.path.isfile("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename)):
                    fr = open("/omd/sites/%s/etc/nagios/conf.d/services.cfg" % sitename,"r")
                    ftw = open("/omd/sites/%s/tmp/temp.cfg" % sitename,"w")
...
def problem_host_list():
    ...
    for site, host, state, worstsvc in hosts:
        ...
        for service_site, description, state, command, servicedetail, age, checked in services:
            ...
            if i % 2 == 0:
                ...
                tabledata += "<tr>"
            tabledata +="<td style=\"padding:5px 0px 5px 10px;\"><img src=\"images/status-" + str(state) + ".png\" alt=\"" + str(state) + "\" width=\"10px\" /></td><td><a class=\"newlink\" href=\"view.py?view_name=service&service=" + description + "&host=" + host + "\" target=\"main\">" + description + "</a><td>" + host + "</td><td>" + servicedetail + "</td><td>" + paint_age(age, checked == 1, 60 * 10) + "</td></tr>"
    ...
    tableHead = "<table class='addform' id='iconmeaningtable' style='margin-bottom:0px;'><colgroup><col width='auto'/><col width='1%'/><col width='6%'/><col width='1%'/><col width='6%'/><col width='1%'/><col width='6%'/><col width='1%'/><col width='6%'/></colgroup><tr><th> Alerts (" + str(countAlerts) + ") </th><th style=\"padding:5px 0px 5px 10px;\"><img src=\"images/status-0.png\" alt=\"0\" width=\"10px\"/></th><th>ok</th><th style=\"padding:5px 0px 5px 10px;\"><img src=\"images/status-1.png\" alt=\"1\" width=\"10px\"/></th><th>warning</th><th style=\"padding:5px 0px 5px 10px;\"><img src=\"images/status-2.png\" alt=\"2\" width=\"10px\"/></th><th>critical</th><th style=\"padding:5px 0px 5px 10px;\"><img src=\"images/status-3.png\" alt=\"3\" width=\"10px\"/></th><th>unknown</th></tr></table>"
