...
class IduForms(object):
    ...
    def port_mirroring_select_list(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        port_mirroring_name_value_dic = {'name':['ODU','LAN1','LAN2'],'value':[0,2,3]}
    ...
    def select_entry_type(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        entry_type_name_value_dic = {'name':['Static','Mgmt','Priority Override'],'value':['0','1','2']}
    ...
    def select_priority(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        select_priority_name_value_dic = {'name':['0','1','2','3'],'value':['0','1','2','3']}
    ...
    def select_clock_source(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        select_priority_name_value_dic = {}
        select_priority_name_value_dic = {'name':['RCLK','Adaptive'],'value':[0,1]}
        return MakeSelectListUsingDictionary.make_select_list_using_dictionary(select_priority_name_value_dic ,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg)
    
    @staticmethod
    def select_line_type(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        select_priority_name_value_dic = {}
        select_priority_name_value_dic = {'name':['Framed Without CRC','Framed With CRC','UnFramed'],'value':[1,2,0]}
        return MakeSelectListUsingDictionary.make_select_list_using_dictionary(select_priority_name_value_dic ,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg)
    ...
    def select_admin_state(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        select_priority_name_value_dic = {}
        select_priority_name_value_dic = {'name':['Locked','Unlocked'],'value':[0,1]}
        return MakeSelectListUsingDictionary.make_select_list_using_dictionary(select_priority_name_value_dic ,selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg)
    ...
    def select_link_mode(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        select_link_mode_name_value_dic = {'name':['Auto','100 Mbps','10 Mbps'],'value':[0,2,3]}
    ...
    def select_mac_auth(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        select_mac_auth_name_value_dic = {'name':['Disable','Accept Specific MAC'],'value':[0,1]}
    ...
    def select_mirror_direction(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        select_mirror_name_value_dic = {'name':['Disable','Tx','Tx and Rx'],'value':[0,1,2]}
    ...
    def select_dotq_mode(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        select_dotq_name_value_dic = {'name':['Disable','Fallback','Check'],'value':[0,1,2]}
    ...
    def select_mac_flow(selected_field,selected_list_state,selected_list_id,is_readonly,select_list_initial_msg):
        ...
        select_mac_flow_name_value_dic = {'name':['Disable','Enable'],'value':[0,1]}
...
################################  ADVANCED CONFIGURATION ###########################################################################
    ...
    def temperature(host_id,selected_device):
        obj_bll = IduGetData()
        temperature_data = obj_bll.common_get_data("IduTemperatureSensorConfigurationTable",host_id)
        form_str = ""
    ...
    def datetime(host_id,selected_device):
        obj_bll = IduGetData()
        date_time_data = obj_bll.common_get_data("IduRtcConfigurationTable",host_id)
        form_str = ""
        form_str +="<form id=\"date_time_form\" name=\"date_time_form\" action=\"date_time_action.py\" method =\"get\">\
                        ...
                        <div class=\"row-elem\">\
                            ...
                            date_time_data[0].day if len(date_time_data)>0 else "",date_time_data[0].hour if len(date_time_data)>0 else "",\
                            date_time_data[0].min if len(date_time_data)>0 else "",date_time_data[0].sec if len(date_time_data)>0 else "",\
                            host_id,selected_device)
        return form_str
...
################################  PORT CONFIGURATION ###############################################################################
    ...
    def table_port_configuration(host_id,selected_device):
        ...
        port_configuration_data = obj_bll.common_get_data("IduSwitchPortconfigTable",host_id)
            ...
            for i in range(0,len(port_configuration_data)):
                port_table_str += " <tr>\
                                        ...
                                        <td><img src='images/edit16.png' title=\"Edit Port\" class=\"n-reconcile\" style=\"cursor:pointer\"  onclick=\"portConfigurationFormEdit('%s','%s','idu_switchPortconfigTable_id','IduSwitchPortconfigTable','%s')\" /></td>\
                                            ...
                                            link_mode_dic[port_configuration_data[i].swlinkMode],port_configuration_data[i].portvid,\
                                            mac_auth_state_dic[port_configuration_data[i].macauthState],\
                                            mirro_direction_dic[port_configuration_data[i].mirroringdirection],\
                                            vlan_dotq_mode_dic[port_configuration_data[i].portdotqmode],\
                                            mac_flow_control_dic[port_configuration_data[i].macflowcontrol],i+1,admin_dic[port_configuration_data[i].swadminState],\
    ...
    def port_configuration_show_table(host_id,selected_device):
        form_str = ""
        form_str += "%s"%(IduForms.table_port_configuration(host_id,selected_device))
        return form_str
    @staticmethod
    def port_configuration_form(port_configuration_list,host_id,selected_device,index):
        ...
        form_str += "<form id=\"swt_port_config_form\" name=\"swt_port_config_form\" action=\"swt_port_config_action.py\" method =\"get\" style=\"overflow:hidden;\">\
                    ...
                    IduForms.select_admin_state(port_configuration_list[0].swadminState if len(port_configuration_list)>0 else "","enabled","switch.switchPortconfigTable.swadminState",False,"Admin State"),\
                    IduForms.select_link_mode(port_configuration_list[0].swlinkMode if len(port_configuration_list)>0 else "","enabled","switch.switchPortconfigTable.swlinkMode",False,"Link Mode"),\
                    port_configuration_list[0].portvid if len(port_configuration_list)>0 else "",\
                    IduForms.select_mac_auth(port_configuration_list[0].macauthState if len(port_configuration_list)>0 else "","enabled","switch.switchPortconfigTable.macauthState",False,"Mac Auth State"),\
                    IduForms.select_mirror_direction(port_configuration_list[0].mirroringdirection if len(port_configuration_list)>0 else "","enabled","switch.switchPortconfigTable.mirroringdirection",False,"Mirror Direction"),\
                    IduForms.select_mac_flow(port_configuration_list[0].macflowcontrol if len(port_configuration_list)>0 else "","enabled","switch.switchPortconfigTable.macflowcontrol",False,"Mac Flow Control"),\
                    IduForms.select_dotq_mode(port_configuration_list[0].portdotqmode if len(port_configuration_list)>0 else "","enabled","switch.switchPortconfigTable.portdotqmode",False,"Dotq Mode"),\
    ...
    def port_bandwidth_show_table(host_id,selected_device):
        form_str = ""
        form_str += "%s"%(IduForms.table_port_bandwidth(host_id,selected_device))
        return form_str
        ...
        if len(port_bw_list)>0:     
            ...
            form_str += "<form id=\"swt_port_bandwidth_form\" name=\"swt_port_bandwidth_form\" action=\"swt_bw_action.py\" method =\"get\" style=\"overflow:hidden;\">\
                        ...
                        "%(port_bw_list[0].switchportnum,IduForms.select_list_ingress(port_bw_list[0].ingressbwvalue,'enabled','switch.portBwTable.ingressbwvalue','false','Select Ingress'),\
                           IduForms.select_list_egress(port_bw_list[0].egressbwvalue,'enabled','switch.portBwTable.egressbwvalue','false','Select Egress')\
                        ,host_id,selected_device,index)
            return form_str
    ...
    def table_e1_port(host_id,selected_device):
        try:
            ...
            line_type_dic={1:"Framed Without CRC",2:"Framed With CRC",0:"Unframed"}
            port_e1_data = obj_bll.common_get_data("IduE1PortConfigurationTable",host_id) 
            #dss=[]
            ...
            if len(port_e1_data)>0:
                for i in range(0,len(port_e1_data)):
                    port_e1_str += "<tr>\
                                            ...
                                            clock_source_dic[port_e1_data[i].clockSource],line_type_dic[port_e1_data[i].lineType],\
        ...
        if len(e1_port_list)>0:     
            ...
            form_str += "<form id=\"e1_port_form\" name=\"e1_port_form\" action=\"e1_port_form_action.py\" method =\"get\" style=\"overflow:hidden;\">\
                        ...
                        "%(e1_port_list[0].portNumber,IduForms.select_clock_source(e1_port_list[0].clockSource,"enabled","iduConfiguration.e1PortConfigurationTable.clockSource","false","Clock Source"),\
                            IduForms.select_line_type(e1_port_list[0].lineType,"enabled","iduConfiguration.e1PortConfigurationTable.lineType","false","Line Type"),\
                            IduForms.select_line_code(e1_port_list[0].lineCode,"enabled","iduConfiguration.e1PortConfigurationTable.lineCode","false","Line Code"),\
                            IduForms.select_admin_state(e1_port_list[0].adminState,"disabled","iduConfiguration.e1PortConfigurationTable.adminState","false","Admin State"),\
    ...
    def table_port_QinQ(host_id,selected_device):
        try:
            global dict
            obj_bll = IduGetData()
            port_qinq_data = obj_bll.common_get_data("IduPortqinqTable",host_id)
            port_QinQ_str = ""
            ...
            if len(port_qinq_data)>0:
                for i in range(0,len(port_qinq_data)):
                    if dict.has_key(port_qinq_data[i].switchportnumber):
                        if dict[port_qinq_data[i].switchportnumber]=="LAN2": 
                            ...
                            port_QinQ_str += "<tr>\
                                                  ...
                                                  </tr>"%(dict.has_key(port_qinq_data[i].switchportnumber) and dict[port_qinq_data[i].switchportnumber] or "",\
                                                        "Disable" if port_qinq_data[i].portqinqstate==0 or port_qinq_data[i].portqinqstate=='0' else "Enable",\
    ...
    def port_QinQ_form(port_QinQ_list,host_id,selected_device,index):
        ...
        form_str += "<form id=\"qinq_form\" name=\"qinq_form\" action=\"qinq_form_action.py\" method =\"get\" style=\"overflow:hidden;\">\
                    ...
                    IduForms.enable_disable_select_list(port_QinQ_list[0].portqinqstate if len(port_QinQ_list)>0 else "",'enabled','switch.portqinqTable.portqinqstate','false','Select QinQ State'),\
    ...
    def port_mirroring(host_id,selected_device):
        obj_bll = IduGetData()
        mirroring_data = obj_bll.common_get_data("IduMirroringportTable",host_id)
        form_str = ""
        form_str += "<form id=\"mirror_port_form\" name=\"mirror_port_form\" action=\"mirror_port_form_action.py\" method=\"get\">\
                    ...
                    </form>"%(IduForms.port_mirroring_select_list(mirroring_data[0].mirroringport if len(mirroring_data)>0 else "",'enabled','switch.mirroringportTable.mirroringport','false','Select Monitoring Port State'),\
    ...
    def table_port_Vlan(host_id,selected_device):
        ...
        if len(port_vlan_data)>0:
            for j in range(0,len(port_vlan_data)):
                ...
                vlan_dic[port_vlan_data[j].vlanid] = [port_vlan_data[j].vlanname,member_ports,port_vlan_data[j].vlantag,\
    ...
    def port_vlan_form(port_vlan_list,host_id,selected_device,port_vlan_id,addEdit,vlanid):
        ...
        form_str += "<form id=\"vlan_add_form\" name=\"vlan_add_form\" action=\"vlan_form_action.py\" method =\"get\" style=\"overflow:hidden;\">\
                    ...
                    "%(vlanid,port_vlan_list[0].vlanname if len(port_vlan_list)>0 else "" if int(addEdit)==1 else "",port0,port2,port3,port4,port5,\
                       port_vlan_list[0].vlantag if len(port_vlan_list)>0 else "" if int(addEdit)==1 else "",\
    ...
    def table_link_port(host_id,selected_device):
        obj_bll = IduGetData()
        port_link_data = obj_bll.common_get_data("IduLinkConfigurationTable",host_id)
        flag = 0
        admin_dic = {0:"Locked",1:"Unlocked"}
        link_dic = {}
        port_link_str = ""
            ...
            for i in range(0,len(port_link_data)):
                ...
                port_link_str += "<tr>\
                                    ...
                                    <img title=\"Delete Link\" class=\"n-reconcile\" src='images/delete16.png' style=\"cursor:pointer\"  onclick=\"portlinkformdelete(%s,%s,%s)\" /></td>\
                                        ...
                                        port_link_data[i].srcBundleID,port_link_data[i].dstBundleID,port_link_data[i].portNumber,\
                                        pos,port_link_data[i].bundleSize,port_link_data[i].bufferSize,"Enable" if int(port_link_data[i].clockRecovery)==1 else "Disable",\
                                        "green" if int(port_link_data[i].adminStatus)==1 else "red",\
            port_link_data[i].portNumber,port_link_data[i].portNumber,\
            1 if int(port_link_data[i].adminStatus)==1 else 0,\
            port_link_data[i].bundleNumber,\
            host_id,port_link_data[i].idu_linkConfigurationTable_id,port_link_data[i].portNumber,"Unlocked" if int(port_link_data[i].adminStatus)==1 else "Locked"\
            ,port_link_data[i].portNumber,port_link_data[i].bundleNumber,port_link_data[i].idu_linkConfigurationTable_id,1,port_link_data[i].idu_linkConfigurationTable_id,port_link_data[i].portNumber,port_link_data[i].bundleNumber)
        else:
            port_link_str += "<tr>\
    ...
    def port_link_form(port_link_list,host_id,selected_device,port_link_id,port_num,link_num,addEdit):
        ...
        form_str +="<form id=\"link_form\" name=\"link_form\" method=\"get\" action=\"link_form_action.py\" style=\"overflow:hidden;\">\
                       ...
                       port_link_list[0].dstIPAddr if int(addEdit)==1 else "",\
                       port_link_list[0].srcBundleID if int(addEdit)==1 else "",port_link_list[0].dstBundleID if int(addEdit)==1 else "",\
                       "disabled=disabled" if int(addEdit)==1 else "",IduForms.select_e1_port(port_num if int(addEdit)==1 else ""),\
                       "disabled=disabled" if int(addEdit)==1 else ""\
                      ,IduForms.select_timeslot(port_link_list[0].tsaAssign if int(addEdit)==1 else ""),\
                       port_link_list[0].bundleSize if int(addEdit)==1 else "" ,\
                       port_link_list[0].bufferSize if int(addEdit)==1 else ""\
                      ,IduForms.select_disable_enable_list(port_link_list[0].clockRecovery if int(addEdit)==1 else ""),\
...
class IduProfiling(object):
    ...
    def page_tip_idu_listing():
        try:
            ...
            The Reconiliation Images turns Green when Reconciliation Percentage Greater Than 90% and Equal To 100%\
            </div>"\
            "</div>"
    ...
    def idu_profiling_form(host_id,selected_device,device_list_parameter):
        ...
        if device_list_parameter == "" or device_list_parameter ==[]:
            ...
            tab_str += "<div class=\"yo-tabs\" id=\"config_tabs\" style=\"display:block\">\
                        ...
                        IduForms.table_link_port(host_id,selected_device),\
                        IduForms.POE(host_id,selected_device),IduForms.header_type(),\
                        IduForms.clock(),IduForms.temperature(host_id,selected_device),IduForms.datetime(host_id,selected_device),\
                        ...
                        IduForms.port_QinQ_show_table(host_id,selected_device),\
                        #"",\
                        IduForms.port_mirroring(host_id,selected_device),IduForms.port_ATU_show_table(),IduForms.table_port_Vlan(host_id,selected_device),\
    ...
    def idu_div(ip_address,mac_address,host_id):
        ...
        e1_port_list = obj_get_data.common_get_data('IduE1PortConfigurationTable',host_id)
        main_admin_state_list = obj_get_data.common_get_data('IduIduAdminStateTable',host_id)
        ...
        for j in range(0,len(e1_port_list)):
            ...
            %("green" if int(e1_port_list[j].adminState)==1 else "red",\
    ...
    def idu_profile_call(host_id,device_type,device_list_parameter):
        ...
        if host_id == "" or host_id == "None":
            ...
            if device_type == UNMPDeviceType.idu4:
                tab_str += IduProfiling.idu_profiling_form(host_id,device_type,device_list_parameter)# function call , it is used to make a form of selected profiling  
        return tab_str
