...
def ubre_manage_crc_phy_report(h):
    ...
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/ubre_reporting.js","js/jquery.fcbkcomplete.js"]
    html.new_header("UBRe CRC-PHY Error Report","#ubre_sub_menu","",css_list,js_list)
...
def ubre_average_data_crc_phy(h):
    ...
    r=Report_bll()
    average_list=r.ubre_get_avg_data_for_two_dates(no_of_devices,date_start,date_end,all_group,all_host)
    return average_list
...
def ubre_total_data_crc_phy(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.ubre_get_total_data_for_two_dates(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
...
def ubre_manage_rssi_report(h):
    ...
    html = h
    css_list = ["css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/calendrical.css","css/fcbkcomplete.css","css/style12.css"]
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/ubre_reporting_rssi.js","js/jquery.fcbkcomplete.js"]
    html.new_header("UBRe RSSI Report","#ubre_sub_menu","",css_list,js_list)
...
def ubre_average_data_rssi(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    average_list=r.ubre_get_avg_data_for_two_dates_rssi(no_of_devices,date_start,date_end,all_group,all_host)
    return average_list
...
def ubre_total_data_rssi(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.ubre_get_total_data_for_two_dates_rssi(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
...
def ubre_manage_network_usage_report(h):
    ...
    html = h
    css_list = ["css/demo_table_jui.css","css/jquery-ui-1.8.4.custom.css","css/calendrical.css","css/fcbkcomplete.css","css/style12.css"]
    js_list = ["js/calendrical.js","js/jquery.dataTables.min.js","js/pages/ubre_reporting_network_usage.js","js/jquery.fcbkcomplete.js"]
    html.new_header("UBRe Network Usage Report","#ubre_sub_menu","",css_list,js_list)
...
def ubre_total_data_network_usage(h):
    ...
    all_group=str(html.var("all_group"))
    r=Report_bll()
    total_result=r.ubre_get_total_data_network_usage(no_of_devices,date_start,date_end,time_start,time_end,all_group,all_host)
    return total_result
