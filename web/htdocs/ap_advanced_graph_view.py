...
from ap_advanced_graph_bll import get_master_slave_value

class APAdvancedView(object):
    @staticmethod
    def ap_set_variable(ip_address,device_type_id,user_id):
        ...
        html_data="<div class=\"form-div\"><div id='timeDiv' style=\"margin-left:10px;margin-top:10px;\"><input type=\"text\" name=\"odu_start_date\" value=\"%s\" id=\"odu_start_date\" style=\"width:100px;\"/>\
                    ...
                    <div class=\"header-icon\" style=\"float:right\"><a href=\"sp_dashboard_profiling.py?host_id=%s&device_type=%s&device_list_state=enabled\"><img id=\"back_to_dashboard\" class=\"n-tip-image\" original-title=\"Back To Dashboard\" style=\"width: 21px; height: 21px; margin: 6px 20px 6px 10px;\" name=\"Back\" src=\"images/back.jpeg\"/></a></div></div>\
...
<img class=\"n-tip-image image-link\" src=\"images/new_icons/round_minus.png\" id=\"device_statistics\" style=\"float:right;margin-right:5px;width:22px;cursor: pointer;\" original-title=\"Show Statistics\"></th>\
                        </tr>'
