...
<img class=\"n-tip-image image-link\" src=\"images/%s/round_minus.png\" id=\"device_statistics\" style=\"float:right;margin-right:5px;width:22px;cursor: pointer;\" original-title=\"Show Statistics\"></th>\
                        </tr>' % theme
