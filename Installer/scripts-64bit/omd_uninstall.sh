...
echo ""
echo "The UNMP installer is uninstalling the UNMP server and Database.."
echo ""
...
chkconfig --del unmp-nbi-naming
chkconfig --del unmp-nbi-notify
chkconfig --del unmp-nbi-supplier

chkconfig --del unmp-alarm
chkconfig --del unmp-clearAlarm
