...
DROP TABLE IF EXISTS `ap25_basicACLsetup`;
CREATE TABLE IF NOT EXISTS `ap25_basicACLsetup` (
  `ap25_basicACLsetup_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `config_profile_id` int(10) unsigned NOT NULL,
  `vapselection_id` int(10) unsigned DEFAULT NULL,
  `aclState` smallint(6) DEFAULT NULL,
  `aclMode` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`ap25_basicACLsetup_id`),
  KEY `FK_ap25_basicACLsetup` (`vapselection_id`),
  KEY `FK_ap25_vapWEPsecuritySetup_config_id` (`config_profile_id`),
  KEY `ap25_basicACLsetup_ibfk_1` (`vapselection_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
DROP TABLE IF EXISTS `ap25_basicVAPsetup`;
CREATE TABLE IF NOT EXISTS `ap25_basicVAPsetup` (
  `ap25_basicVAPsetup_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `config_profile_id` int(10) unsigned NOT NULL,
  `vapselection_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY (`ap25_basicVAPsetup_id`),
...
CREATE TABLE IF NOT EXISTS `ap25_oid_table` (
  ...
  `isVap` tinyint(10) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ap25_vapClientStatisticsTable` (
  ...
  `timestamp` datetime NOT NULL,
  PRIMARY KEY (`ap25_vapClientStatisticsTable_id`),
...
DROP TABLE IF EXISTS `ap25_vapWEPsecuritySetup`;
CREATE TABLE IF NOT EXISTS `ap25_vapWEPsecuritySetup` (
  `ap25_vapWEPsecuritySetup_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `config_profile_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY (`ap25_vapWEPsecuritySetup_id`),
  KEY `FK_ap25_vapWEPsecuritySetup_id` (`config_profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

DROP TABLE IF EXISTS `ap25_vapWPAsecuritySetup`;
CREATE TABLE IF NOT EXISTS `ap25_vapWPAsecuritySetup` (
  `ap25_vapWPAsecuritySetup_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `config_profile_id` int(10) unsigned NOT NULL,
  `vapselection_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY (`ap25_vapWPAsecuritySetup_id`),
...
CREATE TABLE IF NOT EXISTS `idu_linkStatisticsTable` (
  ...
  `timestamp` datetime NOT NULL,
  PRIMARY KEY (`idu_linkStatisticsTable_id`,`timestamp`),
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current and historical host and service acknowledgements' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Command definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical host and service comments' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Configuration files' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Configuration file variables' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='NDO2DB daemon connection information' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Contactgroup definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Contactgroup members' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical record of contact notification methods' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical record of contact notifications' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Contact definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Contact status' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Contact addresses' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Contact host and service notification commands' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_customvariables` (
  ...
  KEY `varname` (`varname`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Custom variables' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_customvariablestatus` (
  ...
  KEY `varname` (`varname`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Custom variable status information' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical scheduled host and service downtime' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical host and service event handlers' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical record of processed external commands' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current and historical record of host and service flapping' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical host checks' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Host dependency definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Host escalation definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Host escalation contact groups' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Hostgroup definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Hostgroup members' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Host definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current host status information' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Host contact groups' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Parent hosts' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Location names of various Nagios installations' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical record of log entries' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_notifications` (
  ...
  UNIQUE KEY `instance_id` (`instance_id`,`object_id`,`start_time`,`start_time_usec`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical record of host and service notifications' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current and historical objects of all kinds' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical Nagios process events' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current program status information' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Runtime variables from the Nagios daemon' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_scheduleddowntime` (
  ...
  UNIQUE KEY `instance_id` (`instance_id`,`object_id`,`entry_time`,`internal_downtime_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current scheduled host and service downtime' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical service checks' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Service dependency definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Service escalation definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Service escalation contact groups' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Servicegroup definitions' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Servicegroup members' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_services` (
  ...
  KEY `service_object_id` (`service_object_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Service definitions' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_servicestatus` (
  ...
  KEY `execution_time` (`execution_time`),
  KEY `scheduled_downtime_depth` (`scheduled_downtime_depth`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current service status information' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Service contact groups' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical host and service state changes' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_systemcommands` (
  ...
  KEY `instance_id` (`instance_id`),
  KEY `start_time` (`start_time`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical system commands that are executed' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Current Nagios event queue' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `nagios_timedevents` (
  ...
  KEY `scheduled_time` (`scheduled_time`),
  KEY `object_id` (`object_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Historical events from the Nagios event queue' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Timeperiod definitions' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `odu100_peerNodeStatusTable` (
  ...
  `negotiatedMaxUplinkBW` int(32) NOT NULL,
  `negotiatedMaxDownlinkBW` int(32) NOT NULL,
  `peerNodeStatuslinkDistance` tinyint(2) NOT NULL,
  `timestamp` datetime NOT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1667 ;
...
CREATE TABLE IF NOT EXISTS `trap_id_mapping` (
  ...
  `trap_severity` int(2) NOT NULL DEFAULT '4',
  `clear_severity` int(2) NOT NULL DEFAULT '2',
  `priority_id` varchar(16) DEFAULT NULL,
  `timestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
ALTER TABLE `ap25_aclMacTable`
  ADD CONSTRAINT `ap25_aclMacTable_ibfk_1` FOREIGN KEY (`vapselection_id`) REFERENCES `ap25_basicVAPsetup` (`vapselection_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `ap25_basicACLsetup`
  ADD CONSTRAINT `ap25_basicACLsetup_ibfk_1` FOREIGN KEY (`vapselection_id`) REFERENCES `ap25_vapSelection` (`ap25_vapSelection_id`),
  ADD CONSTRAINT `ap25_basicACLsetup_ibfk_3` FOREIGN KEY (`config_profile_id`) REFERENCES `config_profiles` (`config_profile_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ap25_basicACLsetup_ibfk_4` FOREIGN KEY (`vapselection_id`) REFERENCES `ap25_vapSelection` (`ap25_vapSelection_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `ap25_basicVAPsetup`
  ADD CONSTRAINT `ap25_basicVAPsetup_ibfk_2` FOREIGN KEY (`vapselection_id`) REFERENCES `ap25_vapSelection` (`ap25_vapSelection_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ap25_basicVAPsetup_ibfk_4` FOREIGN KEY (`config_profile_id`) REFERENCES `config_profiles` (`config_profile_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ap25_basicVAPsetup_ibfk_5` FOREIGN KEY (`vapselection_id`) REFERENCES `ap25_vapSelection` (`ap25_vapSelection_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `ap25_vapClientStatisticsTable`
  ADD CONSTRAINT `ap25_vapClientStatisticsTable_ibfk_1` FOREIGN KEY (`host_id`) REFERENCES `hosts` (`host_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `ap25_vapWEPsecuritySetup`
  ADD CONSTRAINT `ap25_vapWEPsecuritySetup_ibfk_1` FOREIGN KEY (`config_profile_id`) REFERENCES `config_profiles` (`config_profile_id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `ap25_vapWPAsecuritySetup`
  ADD CONSTRAINT `ap25_vapWPAsecuritySetup_ibfk_2` FOREIGN KEY (`config_profile_id`) REFERENCES `config_profiles` (`config_profile_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ap25_vapWPAsecuritySetup_ibfk_3` FOREIGN KEY (`vapselection_id`) REFERENCES `ap25_vapSelection` (`ap25_vapSelection_id`) ON DELETE CASCADE ON UPDATE CASCADE;
