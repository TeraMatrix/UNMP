...
import logging
import os
logging.basicConfig(filename='/omd/daemon/log/DS_nagiosPlugin.log',format='%(levelname)s: %(asctime)s >> %(message)s', level=logging.DEBUG)
...
def db_connect():
    ...
    try:
        ...
        logging.error("/*/*/* MYSQLdb Exception (db connect) : "+str(e)) #print str(e)
    except Exception as e:
        logging.error("/*/*/* Database Exception (db connect) : "+str(e)) #print "Exception in database connection "+str(e)
    ...
    try:
        ...
        while 1:
            ...
            if data:
                ...
                #
                #print ' >>>>>>>>>>>>> cmd_id is ',cmd_id,' and cmd_status is ',cmd_status,' & Transaction id is ',tx_id,' ne_id is ',ne_id        
                if cmd_id == 2002:
                    if cmd_status == 0:
                        NOT_UP = 0
                        some_problem = 0
