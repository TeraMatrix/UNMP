    ...
    def engine(self):
        ...
        try:
            ...
            config.addTargetAddr(
                ...
                (self.ip_address, port), 'myParams', 20, 3
                )
...
# rx_phy_err, sig_strength, sync_lost = 987654321, 987654321, 987654321,
# 987654321, 987654321, 987654321, 987654321, 987654321, 987654321,
# 987654321, 987654321, 987654321, 987654321, -111, 987654321
        global db, host_id
        if db == 1:
    ...
    try:
        ...
        if arg.count('-i') and arg.count('-p') and arg.count('-d'):
            ...
            if host_state == 0:
                if is_db_connect:
                    ...
                    if db == 1:
                        ...
                        if cursor.execute(sql) == 0 or cursor.execute(sql) == None:
                            ...
                            # print host_id
                        cursor.close()
                bulk_obj = Bulk(ip_address, port_no, snmp_read)
                ...
                hstatus_dict = {
                    0: 'No operation', 1: 'Firmware download', 2: 'Firmware upgrade', 3: 'Restore default config', 4: 'Flash commit', 5: 'Reboot', 6: 'Site survey', 7: 'Calculate BW', 8: 'Uptime service', 9: 'Statistics gathering', 10: 'Reconciliation',
                    11: 'Table reconciliation', 12: 'Set operation', 13: 'Live monitoring', 14: 'Status capturing', 15: 'Refreshing Site Survey'}
                schedule_round = 3
