        ...
        if arg.count('-i') and arg.count('-p') and arg.count('-d'):
            ...
            if host_state == 0:
                ...
                for table_name in table_dict:
                    ...
                    snmp_result_dict = pysnmp_get_table(str(table_dict[table_name]).strip(
