...
import subprocess
def main():
	msg_dict = {"ndo2db":"ndo2db (pid","snmptt":"snmptt (pid"}#,"snmpd":"snmpd (pid","snmptrapd":"snmptrapd (pid","MySQL":"MySQL running"}
	result_dict = {"ndo2db":0,"snmptt":0}#,"snmpd":0,"snmptrapd":0,"MySQL":0}
	result_str = "" 
	try:
		NOT_UP = 0
		some_problem = 0
