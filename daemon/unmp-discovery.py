...
def db_get_neid(dip):
    ...
    try:
        ...
        pass #logging.error("/*/*/* Database Exception (get ne_id) : "+str(e))
...
class DsThread(threading.Thread):
    ...
    def recieve_send(self):
        ...
        """
        global sock_list,rule_variable,sock_dict,thread_list,status_dict,config_responce,db_events_dict 
                        ...
                        if cmd_status == 0:
                            ...
                            for i in param_list:                    
                                if count == 6:
                                    ...
                                    rparam_name = i
                                    rparam_value = config_responce[rparam_name] 
